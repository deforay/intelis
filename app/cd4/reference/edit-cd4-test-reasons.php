		...
		<div class="box box-default">
			...
			<div class="box-body">
				...
				<form class="form-horizontal" method='post' name='editTstForm' id='editTstForm' autocomplete="off"
					enctype="multipart/form-data" action="save-cd4-test-reasons-helper.php">
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="testReasonName"
											...
											onblur="checkNameValidation('r_cd4_test_reasons','test_reason_name',this,'<?php echo "test_reason_id##" . $id; ?>','The Test Reason name that you entered already exists.Enter another name',null)" />
