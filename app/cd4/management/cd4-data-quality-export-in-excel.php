...
if (isset($_SESSION['vlIncompleteForm']) && trim((string) $_SESSION['vlIncompleteForm']) != "") {
     ...
     if (isset($_SESSION['vlIncompleteFormCount']) && $_SESSION['vlIncompleteFormCount'] > 50000) {
          $fileName = TEMP_PATH . DIRECTORY_SEPARATOR . 'InteLIS-CD4-Data-Quality-report' . date('d-M-Y-H-i-s') . '.csv';
          ...
          $fileName = TEMP_PATH . DIRECTORY_SEPARATOR . 'InteLIS-CD4-Data-Quality-report' . date('d-M-Y-H-i-s') . '.xlsx';
