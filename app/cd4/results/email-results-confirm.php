                  ...
                  <div class="col-lg-12" style="text-align:center !important;">
                     <table aria-describedby="table" class="table table-bordered table-striped" aria-hidden="true"
                        ...
                        <tbody>
                           ...
                           for ($s = 0; $s < $counter; $s++) {
                              $sampleQuery = "SELECT cd4_id,sample_code FROM form_cd4 as vl LEFT JOIN facility_details as f ON vl.facility_id=f.facility_id where vl.cd4_id = '" . $db->escape((string) $selectedSamplesArray[$s]) . "' AND vl.cd4_result IS NOT NULL AND vl.cd4_result!= '' ORDER BY f.facility_name ASC";
