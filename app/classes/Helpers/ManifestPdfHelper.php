...
class ManifestPdfHelper extends TCPDF
{
    ...
    {
        return '<p></p><span style="font-size:1.7em;"> ' . htmlspecialchars((string) $code) .
    ...
    public function renderSignatureSection(?string $generatedBy, ?string $labName): string
    {
        ...
        $html .= '<tr>';
        $html .= '<td align="left" style="vertical-align:middle;font-size:11px;width:33.33%;"><strong>' . _translate('Generated By') . ' : </strong><br>' . htmlspecialchars((string) $generatedBy) . '</td>';
        $html .= '<td align="left" style="vertical-align:middle;font-size:11px;width:33.33%;"><strong>' . _translate('Verified By') . ' :  </strong></td>';
        $html .= '<td align="left" style="vertical-align:middle;font-size:11px;width:33.33%;"><strong>' . _translate('Received By') . ' : </strong><br>(at ' . htmlspecialchars((string) $labName) . ')</td>';
        $html .= '</tr>';
        $html .= '</table><br><br>';
        return $html;
    }
    ...
    {
        $html = '<p></p><strong>' . htmlspecialchars((string) $title) . '</strong>';
        $html .= '<br><table border="1">
        <tr>
            <td colspan="2">' . htmlspecialchars((string) $fromLabel) . '</td>
            <td colspan="2">' . htmlspecialchars((string) $toLabel) . '</td>
        </tr>
        <tr>
