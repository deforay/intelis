...
class TBResultPDFHelper extends Fpdi
{
    ...
    //Page header
    public function setHeading(?string $logo, ?string $text, ?string $lab, ?string $title = null, ?string $labFacilityId = null, ?string $formId = null, array $facilityInfo = [], $pdfTemplatePath = null): void
    {
        $this->logo = $logo;
        $this->text = $text;
        $this->lab = $lab;
