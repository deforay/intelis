...
/**
 * Vendored into this repository from thingengineer/mysqli-database-class
 * (dev-master, upstream unmaintained). Only DatabaseService may extend or
 * reference this class; everything else goes through DatabaseService.
 * The original copyright and license header below is retained (GPL-3.0,
...
class MysqliDb
{
     ...
     * atomic operations sane. Reached only as the shutdown callback registered
     * by startTransaction(), never by a direct call.
     *
