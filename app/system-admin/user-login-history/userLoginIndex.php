        ...
        <div class="box">
          <table aria-describedby="table" class="table" aria-hidden="true"
            ...
            <tr>
              ...
              <td>
                <input type="text" id="userDate" name="userDate" class="form-control daterangefield"
              ...
              <td>
                <select style="width:220px;" class="form-control select2" id="loginId" name="loginId"
                  title="<?php echo _translate('Please select login id'); ?>">
            ...
            <tr>
              <td colspan="6">
                &nbsp;<button onclick="searchVlRequestData();" value="Search"
                  class="btn btn-primary btn-sm"><span><?php echo _translate("Search"); ?></span></button>

                &nbsp;<button class="btn btn-danger btn-sm"
                  onclick="document.location.href = document.location"><span><?php echo _translate("Clear Search"); ?></span></button>
              </td>
            </tr>
          ...
          <!-- /.box-header -->
          <div class="box-body">
            <table aria-describedby="table" id="userLoginHistoryDataTable" class="table table-bordered table-striped"
              aria-hidden="true">
              <thead>
                <tr>
