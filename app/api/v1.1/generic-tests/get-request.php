...
$general->addApiTracking($transactionId, $user['user_id'], count($rowData ?? []), 'get-request', 'generic-tests', $_SERVER['REQUEST_URI'], $origJson, $payload, 'json', null, null, $authToken);
