...
<div class="content-wrapper">
	...
	<section class="content">
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<!-- form start -->
				<form class="form-horizontal" method='post' name='facilityTestMapForm' id='facilityTestMapForm'
					enctype="multipart/form-data" autocomplete="off" action="mapTestTypeHelper.php">
					<div class="box-body">
						<div class="panel panel-default">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-md-7">
										<div class="form-group">
											<label for="testType"
												class="col-lg-4 control-label"><?php echo _translate("Test Type"); ?></label>
											<div class="col-lg-8">
												<select class="form-control" id="testType" name="testType"
													title="<?= _translate('Choose at least one test type'); ?>"
													onchange="loadMapTestType();">
													...
													if (isset(SYSTEM_CONFIG['modules']['eid']) && SYSTEM_CONFIG['modules']['eid'] === true) { ?>
														<option value="eid">
															<?php echo _translate("Early Infant Diagnosis"); ?></option>
													<?php }
													if (isset(SYSTEM_CONFIG['modules']['covid19']) && SYSTEM_CONFIG['modules']['covid19'] === true) { ?>
														<option value="covid19"><?php echo _translate("Covid-19"); ?>
														</option>
													<?php }
													if (isset(SYSTEM_CONFIG['modules']['hepatitis']) && SYSTEM_CONFIG['modules']['hepatitis'] === true) { ?>
														<option value='hepatitis'><?php echo _translate("Hepatitis"); ?>
														</option>
													<?php }
													...
													if (isset(SYSTEM_CONFIG['modules']['generic-tests']) && SYSTEM_CONFIG['modules']['generic-tests'] === true) { ?>
														<option value='generic-tests'>
															<?php echo _translate("Other Lab Tests"); ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label for="facilities" style="margin-left: 30px;"
												class="control-label"><?php echo _translate("Select the"); ?>
												<?php echo str_replace("Manage", "", (string) $title); ?>
												<?php echo _translate("for test type"); ?> </label>
											<div class="col-lg-12">
												<div class="col-md-5">
													<select name="facilities[]" id="search" class="form-control"
