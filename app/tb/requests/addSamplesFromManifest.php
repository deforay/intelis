...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-plus"></em> <?php echo _translate("TB | Add Samples from Manifest"); ?></h1>
		<ol class="breadcrumb">
					...
					<table aria-describedby="table" class="table" aria-hidden="true"
						...
						<tr>
							<td style="width:20%;vertical-align:middle;">
								<strong><?php echo _translate("Enter Sample Manifest Code"); ?> :</strong>
							</td>
							<td>
							...
							<td>
								<button class="btn btn-primary btn-sm pull-right" style="margin-right:5px;"
									onclick="verifyManifest('tb');return false;"><span><?php echo _translate("Submit"); ?></span></button>
							</td>
						</tr>
						<tr class="activateSample" style="display:none;">
							...
							<td style="width:50%;vertical-align:middle;"><input type="text" name="sampleReceivedOn"
							...
							<td style="width:100%;" colspan="3">
								<a class="btn btn-success btn-sm pull-right activateSample"
									...
									onclick="activateSamplesFromManifest();"><em class="fa-solid fa-check"></em>
									<?= _translate("Activate Samples"); ?></a>
							</td>
						</tr>
					</table>
