				...
				<div class="box">
					<table aria-describedby="table" class="table" aria-hidden="true" style="margin-left:1%;margin-top:20px;width: 98%;margin-bottom: 0px;display: block;">
						<tr>
							...
							<td>
								<button class="btn btn-primary btn-sm pull-right" style="margin-right:5px;" onclick="verifyManifest('tb');return false;"><span><?php echo _translate("Submit"); ?></span></button>
							</td>
						</tr>
