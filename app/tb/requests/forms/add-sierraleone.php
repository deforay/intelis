							...
							<div class="box-body">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control" id="requestingClinician"
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										...
										<th scope="row"><label for="dob">Date of Birth <span
													class="mandatory">*</span></label></th>
										<td>
									...
									<tr>
										...
										<td><input type="text" class="form-control isRequired" id="patientAddress"
												...
												title="Patient Complete Address" style="width:100%;" onchange="" /></td>
										...
										<td><input type="text" class="form-control phone-number" id="patientPhoneNumber"
												...
												title="Patient phone number" style="width:100%;" onchange="" /></td>
									</tr>
								...
								<table aria-describedby="table" class="table" aria-hidden="true">
									<tr>
										...
										<td>
											<input type="text" class="form-control specimenTypeOther"
												id="specimenTypeOther" name="specimenTypeOther"
												placeholder="Enter specimen type of others"
												title="Please enter the specimen type if others"
												style="display: none;" />
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control isRequired" id="sampleRequestorName"
												name="sampleRequestorName" placeholder="Enter Name"
							...
							<div class="box box-primary">
								<div class="box-body">
									...
									<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
										<tr>
											...
											<th scope="row"><label class="label-control" for="sampleReceivedDate">Date of
													Reception </label></th>
											<td>
												<input type="text" class="date-time form-control" id="sampleReceivedDate"
													name="sampleReceivedDate"
													placeholder="<?= _translate("Please enter date"); ?>"
										...
										<tr>
											...
											<td>
												<input type="text" class="date-time form-control" id="sampleTestedDateTime"
											...
											<td>
												<input type="text" class="date-time form-control" id="sampleDispatchedDate"
									...
									<tr>
										...
										<td><input type="text" name="approvedOn" id="approvedOn"
									...
									<tr>
										...
										<td>
											<textarea class="form-control labSection" name="labComments" id="labComments"
												placeholder="Lab comments"></textarea>
										</td>
									</tr>
									</table>
								</div>
