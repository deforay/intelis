                                ...
                                <tr>
                                    <td style="width: 33.33%;">
                                        ...
                                        <input type="text" value="<?php echo $tbInfo['etb_tracker_number']; ?>"
                                            ...
                                            title="
                                        <?php echo _translate("Please enter the e-TB tracker number"); ?>" />
                                    </td>
                                    <td style="width: 33.33%;">
                                        <label for="dob">
                                    ...
                                    <td style="width: 33.33%;">
                                        ...
                                        <input type="number" value="<?php echo $tbInfo['patient_age']; ?>" max="150"
                                            maxlength="3" class="form-control isRequired" id="patientAge"
                                            name="patientAge" placeholder="<?php echo _translate("Age (in years)"); ?>"
                                            title="<?php echo _translate("Please enter the patient age"); ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 33.33%;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 33.33%;">
                                        ...
                                        <input
                                            ...
                                            value="
                                        <?php echo $tbInfo['risk_factor_other'] ?? ''; ?>" type="text"
                                ...
                                <tr class="treatmentSelected"
                                    ...
                                    <td style="width: 33.33%;">
                                        ...
                                        <input type="text"
                                            ...
                                            class="treatmentSelectedInput form-control date <?php echo (isset($tbInfo['is_patient_initiated_on_tb_treatment']) && !empty($tbInfo['is_patient_initiated_on_tb_treatment']) && $tbInfo['is_patient_initiated_on_tb_treatment'] == 'yes') ? 'isRequired' : ''; ?>"
                                            placeholder="Date of Initiation of Current Regimen"
                                ...
                                <tr>
                                    <td style="width: 33.33%;">
                                        <label class="label-control" for="sampleCollectionDate">
                                            <?php echo _translate("Date and Time of Specimen Collection"); ?><span
                                                class="mandatory">*</span>
                                        </label>
                                                    ...
                                                    <tr class="rejection-date-field"
                                                        ...
                                                        <td style="width: 33.33%;">
                                                            ...
                                                            <input class="form-control date rejection-date"
                                                                ...
                                                                title="
                                                <?php echo _translate("Please select the rejection date"); ?>" />
                                                        </td>
                                                        <td style="width: 33.33%;"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td style="width: 33.33%;" class="tested-field-td">
                                                            ...
                                                            <select name="testResult[testedBy][]" id="testedBy<?php echo $n; ?>"
                                                                class="form-control test-required-field"
                                                        ...
                                                        <td style="width: 33.33%;" class="tested-field-td">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                class="date-time form-control test-required-field"
                                                    ...
                                                    <tr>
                                                        <td style="width: 33.33%;">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                class="date-time disabled-field form-control test-required-field"
                                                    ...
                                                    <tr style="display: none;" class="revisedFields">
                                                        ...
                                                        <td style="width: 33.33%;">
                                                            ...
                                                            <input type="hidden" name="testResult[testId][]" value="<?php echo htmlspecialchars((string) ($test['tb_test_id'] ?? '')); ?>" />
                                            ...
                                            <table class="table" style="width:100%; margin-top: 15px;">
                                                ...
                                                <tr>
                                                    <td style="width: 33.33%;">
                                                        ...
                                                        <select class="form-control test-type-select test-required-field"
                                                            name="testResult[testType][]" id="testType1"
                                                            title="<?php echo _translate("Please select the test type"); ?>"
                                                            onchange="updateTestResults(1);updateTestFieldsRequired(this);">
                                                            <option value="">
                                                                <?php echo _translate("Select test type"); ?>
                                                            </option>
                                                    ...
                                                    <td style="width: 33.33%;">
                                                        ...
                                                        <select class="form-control test-result-select test-required-field"
                                                            name="testResult[testResult][]" id="testResult1"
                                                            title="<?php echo _translate("Please select the test result"); ?>"
                                                            onchange="updateTestFieldsRequired(this);">
                                                            <option value="">
                                                                <?php echo _translate("Select test result"); ?>
                                                            </option>
                                                        </select>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 33.33%;" class="tested-field-td">
                                                        ...
                                                        <input type="text" class="date-time form-control test-required-field"
                                                ...
                                                <tr style="display: none;" class="revisedFields">
                                                    ...
                                                    <td style="width: 33.33%;">
                                                        ...
                                                        <input type="hidden" name="testResult[testId][]" value="" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
...
<script type="text/javascript">
    ...
    // Show revised fields when result part is modified
