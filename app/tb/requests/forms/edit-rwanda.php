...
<script type="text/javascript">
    ...
    // Show revised fields only when a stored result is changed
    ...
    // the test cards rather than leaving a half-filled result behind that the helper
    // would only null out on save.
