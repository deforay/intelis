                                ...
                                <tr>
                                    ...
                                    <td style="width: 33.33%;">
                                        <label for="patientAge"><?= _translate('Age (years)'); ?><span
                                                class="mandatory">*</span></label>
                                        <input type="number" max="150" maxlength="3" class="form-control isRequired"
                                ...
                                <tr class="treatmentSelected" style="display: none;">
                                    ...
                                    <td style="width: 33.33%;">
                                        ...
                                        <select id="currentRegimen" name="currentRegimen"
                                            ...
                                            <option value="No information provided">No information provided</option>
                                            <option value="First-line TB Treatment">First-line TB Treatment</option>
                                            <option value="Second-line TB Treatment">Second-line TB Treatment</option>
                                        </select>
                                    </td>
                                    <td style="width: 33.33%;">
                                        <label class="label-control"
                                        ...
                                        <table class="table" style="width:100%; margin-top: 15px;">
                                            ...
                                            <tr>
                                                <td style="width: 33.33%;">
                                                    ...
                                                    <select class="form-control test-type-select resultSectionInput test-required-field"
                                                ...
                                                <td style="width: 33.33%;">
                                                    ...
                                                    <select class="form-control test-result-select resultSectionInput test-required-field"
