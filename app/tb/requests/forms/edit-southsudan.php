					...
					<div class="box-body">
						<div class="box box-default">
							<div class="box-body">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr>
										<td><label class="label-control" for="province">Health Facility/POE State
										...
										<td><label class="label-control" for="district">Health Facility/POE County
											</label><span class="mandatory">*</span></td>
										<td>
											<select class="form-control select2 isRequired" name="district"
												id="district" title="Please choose County" style="width:100%;"
										...
										<td>
											<select name="testTypeRequested[]" id="testTypeRequested"
												...
												<optgroup label="Xpert MTB">
													...
													<option value="MTB/RIF ULTRA" <?php echo (is_array($tbInfo['tests_requested']) && in_array("MTB/RIF ULTRA", $testTypeRequested)) ? "selected='selecetd'" : ""; ?>>
														MTB/RIF ULTRA</option>
													<option value="TB LAM" <?php echo (is_array($tbInfo['tests_requested']) && in_array("TB LAM", $testTypeRequested)) ? "selected='selecetd'" : ""; ?>>TB LAM
													</option>
												</optgroup>
											</select>
										</td>
									...
									<?php if ($general->isLISInstance()) { ?>
										<tr>
											<th scope="row"><label class="label-control" for="sampleReceivedDate">Date of
													Reception<span class="mandatory">*</span> </label></th>
											<td>
									...
									<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
										<tr>
											...
											<td>
												<input type="text" value="<?php echo $tbInfo['sample_tested_datetime']; ?>"
													class="date-time form-control" id="sampleTestedDateTime"
										...
										<tr>
											<th scope="row" class="platform xpert" <?php echo (isset($attributes) && $attributes != "" && in_array("xpert", $attributes)) ? 'style="display:none;"' : ''; ?>><label class="label-control"
													for="xPertMTMResult">Xpert MTB Result</label></th>
											<td class="platform xpert" <?php echo (isset($attributes) && $attributes != "" && in_array("xpert", $attributes)) ? 'style="display:none;"' : ''; ?>>
												<select class="form-control" name="xPertMTMResult" id="xPertMTMResult"
													title="Please select the Xpert MTM Result">
													<?= $general->generateSelectOptions($tbXPertResults, $tbInfo['xpert_mtb_result'], '-- Select --'); ?>
												</select>
											</td>
											<th scope="row" class="platform lam" <?php echo (isset($attributes) && $attributes != "" && in_array("lam", $attributes)) ? 'style="display:none;"' : ''; ?>><label class="label-control" for="tbLamResult">TB LAM
													Result</label></th>
											<td class="platform lam" <?php echo (isset($attributes) && $attributes != "" && in_array("lam", $attributes)) ? 'style="display:none;"' : ''; ?>>
												<select class="form-control" name="tbLamResult" id="tbLamResult"
										...
										<tr>
											<th scope="row"><label class="label-control" for="reviewedBy">Reviewed
													By</label></th>
											<td>
											...
											<th scope="row"><label class="label-control" for="reviewedOn">Reviewed
													on</label></th>
											<td><input type="text"
										...
										<tr>
											<th scope="row"><label class="label-control" for="approvedBy">Approved
													By</label></th>
											<td>
											...
											<th scope="row"><label class="label-control" for="approvedOn">Approved
													on</label></th>
											<td><input type="text"
													value="<?php echo $tbInfo['result_approved_datetime']; ?>"
													name="approvedOn" id="approvedOn" class="date-time form-control"
													placeholder="Approved on" title="Please enter the approved on date" />
											</td>
										</tr>
