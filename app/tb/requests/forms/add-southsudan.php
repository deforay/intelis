									...
									<tr style=" border: 1px solid #8080804f; ">
										...
										<td style="float: left;text-align: center;">
											<div class="follow-up hide-reasons" style="display: none;">
												<input type="text" class="form-control followup-uncheck reason-checkbox"
													id="followUp" name="reasonForTbTest[elaboration][followup][value]"
							...
							<div class="box box-primary">
								<div class="box-body">
									...
									<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
										...
										<tr>
											<th scope="row" class="platform xpert"><label class="label-control"
											...
											<th scope="row" class="platform lam"><label class="label-control"
													for="tbLamResult">TB LAM Result</label></th>
