                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <td class="td-input">
                                                <input value="<?php echo $tbInfo['sample_code']; ?>" type="text" class="form-control isRequired" id="sampleCode" name="sampleCode" readonly="readonly" placeholder="Sample ID" title="<?= _translate("Please make sure you have selected Sample Collection Date and Requesting Facility"); ?>" style="width:100%;" />
                                            </td>
                                        <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-input">
                                            <select class="select2 form-control isRequired" name="typeOfPatient" id="typeOfPatient" title="Please select the type of patient" onchange="showOther(this.value,'typeOfPatientOther');" style="width:100%;">
                                                <option value=''> -- <?= _translate("Select"); ?> -- </option>
                                                <option value='new' <?php echo ($tbInfo['patient_type'] == "new") ? "selected='selected'" : ""; ?>> <?= _translate("New"); ?> </option>
                                                <option value='loss-to-follow-up' <?php echo ($tbInfo['patient_type'] == "loss-to-follow-up") ? "selected='selected'" : ""; ?>> <?= _translate("Loss to Follow Up"); ?> </option>
                                                <option value='treatment-failure' <?php echo ($tbInfo['patient_type'] == "treatment-failure") ? "selected='selected'" : ""; ?>> <?= _translate("Treatment Failure"); ?> </option>
                                                <option value='relapse' <?php echo ($tbInfo['patient_type'] == "relapse") ? "selected='selected'" : ""; ?>> <?= _translate("Relapse"); ?> </option>
                                                <option value='other' <?php echo ($tbInfo['patient_type'] == "other") ? "selected='selected'" : ""; ?>> <?= _translate("Other"); ?> </option>
                                            </select>
                                ...
                                <div class="box-body">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-input">
                                                <select name="testedBy" id="testedBy" class="select2 form-control" title="<?= _htmlTranslate('Please choose who tested the sample'); ?>" style="width: 100%;">
