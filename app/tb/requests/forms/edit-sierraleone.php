		...
		<div class="box box-default">
			...
			<div class="box-body">
				...
				<form class="form-horizontal" method="post" name="editTbRequestForm" id="editTbRequestForm"
					autocomplete="off" action="tb-edit-request-helper.php">
					<div class="box-body">
						<div class="box box-default">
							<div class="box-body">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr>
										<?php if ($_SESSION['accessType'] == 'collection-site') { ?>
											<th scope="row" style="width: 16.6%;"><label class="label-control"
													for="sampleCode">Sample ID </label></th>
											<td style="width: 16.6%;">
												<span id="sampleCodeInText"
													style="width:100%;border-bottom:1px solid #333;"><?php echo (isset($tbInfo['remote_sample_code']) && $tbInfo['remote_sample_code'] != "") ? $tbInfo['remote_sample_code'] : $tbInfo['sample_code']; ?></span>
												<input type="hidden" id="sampleCode" name="sampleCode" />
											</td>
										<?php } else { ?>
											<th scope="row" style="width: 14%;"><label class="label-control"
													for="sampleCode">Sample ID </label><span class="mandatory">*</span></th>
											<td style="width: 18%;">
												<input type="text" value="<?php echo $tbInfo['sample_code']; ?>"
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr>
										<td><label class="label-control" for="province">Health Facility/POE Region
											</label><span class="mandatory">*</span></td>
										<td>
											<select class="form-control select2 isRequired" name="province"
												id="province" title="Please choose region"
												onchange="getfacilityDetails(this);" style="width:100%;">
												<?php echo $province; ?>
											</select>
										</td>
										<td><label class="label-control" for="district">Health Facility/POE District
											</label><span class="mandatory">*</span></td>
										<td>
									...
									<tr>
										<th scope="row"><label for="requestedDate">Date of request <span
										...
										<td>
											<input type="text" class="form-control"
												value="<?php echo $tbInfo['requesting_clinician']; ?>"
												id="requestingClinician" name="requestingClinician"
												placeholder="<?= _translate("Enter clinician name"); ?>"
												title="Enter clinician name" style="width:100%;" />
										</td>
										...
										<td>
											<select class="form-control " name="referringUnit" id="referringUnit"
												...
												<option value="art" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'art') ? "selected='selected'" : ""; ?>>
													ART</option>
												<option value="opd" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'opd') ? "selected='selected'" : ""; ?>>
													OPD</option>
												<option value="tb" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'tb') ? "selected='selected'" : ""; ?>">
													TB</option>
										...
										<td>
											<input type="text" class="form-control typeOfReferringUnit"
												...
												value="<?php echo $tbInfo['other_referring_unit']; ?>"
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										...
										<td>
											<input type="text" value="<?php echo $tbInfo['patient_id']; ?>"
												class="form-control isRequired patientId" id="patientId"
									...
									<tr>
										...
										<td>
											<input type="text" value="<?php echo $tbInfo['patient_surname']; ?>"
												...
												placeholder="Last name" title="Please enter Last name"
												style="width:100%;" onchange="" />
										</td>
										<th scope="row"><label for="dob">Date of Birth<span class="mandatory">*</span>
											</label></th>
										<td>
											<input type="text"
									...
									<tr>
										...
										<td><input type="number" value="<?php echo $tbInfo['patient_age']; ?>" max="150"
												maxlength="3"
										...
										<td>
											<select class="form-control isRequired" name="patientGender"
												...
												<option value=''> -- Select -- </option>
												<option value='male' <?php echo (isset($tbInfo['patient_gender']) && $tbInfo['patient_gender'] == 'male') ? "selected='selected'" : ""; ?>>
													Male </option>
									...
									<tr>
										...
										<td><input type="text" class="form-control isRequired" id="patientAddress"
												name="patientAddress" placeholder="Patient Complete Address"
												title="Patient Complete Address" style="width:100%;" onchange=""
												value="<?php echo ($tbInfo['patient_address']); ?>" /></td>
										...
										<td><input type="text" class="form-control phone-number" id="patientPhoneNumber"
												...
												title="Patient phone number" style="width:100%;" onchange=""
												value="<?php echo ($tbInfo['patient_phone']); ?>" /></td>
									</tr>
									<tr>
										...
										<td>
											<select class="select2 form-control isRequired" name="typeOfPatient[]"
												...
												<option value=''> -- Select -- </option>
												<option value='new' <?php echo (is_array($typeOfPatient) && in_array("new", $typeOfPatient)) ? "selected='selected'" : ""; ?>>
													New </option>
												...
												<option value='other' <?php echo (is_array($typeOfPatient) && in_array("other", $typeOfPatient)) ? "selected='selected'" : ""; ?>>
													Other </option>
											</select>
										</td>
										<td>
											<input type="text" class="form-control typeOfPatientOther"
												value="<?php echo $tbInfo['other_patient_type']; ?>"
									...
									<tr>
										<th scope="row" colspan="4">Reason for Examination<span
									...
									<tr style=" border: 1px solid #8080804f; ">
										<td>
											<label class="radio-inline" style="margin-left:0;">
												<input type="radio" class="isRequired diagnosis-check"
													...
													value="diagnosis" title="Select reason for examination"
													onchange="checkSubReason(this,'diagnosis', 'followup-uncheck');"
													<?php echo (isset($reasonForTbTest->reason->diagnosis) && $reasonForTbTest->reason->diagnosis == "yes") ? "checked" : ""; ?>>
										...
										<td>
											<label class="radio-inline" style="margin-left:0;">
												<input type="radio" class="isRequired followup-uncheck"
													...
													<?php echo (isset($followup) && array_filter($followup) !== []) ? "checked" : ""; ?>>
										...
										<td style="float: left;text-align: center;">
											...
											<div class="follow-up hide-reasons"
												style="display: <?php echo (isset($followup) && array_filter($followup) !== []) ? "block" : "none"; ?>;">
												<ul class="followUp">
													<li>
									...
									<tr>
										<th scope="row"><label for="hivStatus">HIV Status<span
													class="mandatory">*</span></label></th>
										<td>
											<select class="form-control isRequired" name="hivStatus" id="hivStatus"
												title="Please select HIV Status">
												<option value=''> -- Select -- </option>
												<option value='yes' <?php echo (isset($tbInfo['hiv_status']) && $tbInfo['hiv_status'] == 'yes') ? "selected='selected'" : ""; ?>> Yes
												</option>
												<option value='no' <?php echo (isset($tbInfo['hiv_status']) && $tbInfo['hiv_status'] == 'no') ? "selected='selected'" : ""; ?>> No
												</option>
												<option value='unknown' <?php echo (isset($tbInfo['hiv_status']) && $tbInfo['hiv_status'] == 'unknown') ? "selected='selected'" : ""; ?>>
													Unknown </option>
											</select>
										</td>
										<th scope="row"><label for="previouslyTreatedForTB">Previously treated for TB?
												<span class="mandatory">*</span></label></th>
										<td>
											<select class="form-control isRequired" name="previouslyTreatedForTB"
												id="previouslyTreatedForTB" title="Please select options">
												<option value=''> -- Select -- </option>
								...
								<table aria-describedby="table" class="table" aria-hidden="true">
									<tr>
										...
										<td>
											<input class="form-control specimenTypeOther" type="text"
												id="specimenTypeOther"
												value="<?php echo $tbInfo['other_specimen_type']; ?>"
												name="specimenTypeOther" placeholder="Enter sample type of others"
												title="Please enter the sample type if others" style="display: none;" />
										</td>
									</tr>
									<tr>
										<!-- <th scope="row">
										...
										<td>
											<select name="testTypeRequested[]" id="testTypeRequested"
												...
												<optgroup label="Xpert MTB">
													...
													<option value="MTB/RIF ULTRA" <?php echo (isset($tbInfo['tests_requested']) && in_array("MTB/RIF ULTRA", $testTypeRequested)) ? "selected='selecetd'" : ""; ?>>MTB/RIF
														ULTRA</option>
									...
									<tr>
										<th scope="row">
											<label class="label-control">
												Name or signature of person requesting examination<span
													class="mandatory">*</span>
											</label>
										</th>
										<td>
											<input type="text" class="form-control isRequired"
												value="<?php echo $tbInfo['sample_requestor_name']; ?>"
												id="sampleRequestorName" name="sampleRequestorName"
												placeholder="Enter Name" title="Please enter the Name" />
										</td>
									</tr>
								</table>
							</div>
								...
								<div class="box-body">
									...
									<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
										...
										<tr>
											...
											<td>
												<input type="text" value="<?php echo $tbInfo['sample_tested_datetime']; ?>"
													...
													value="<?php echo $tbInfo['sample_collection_date']; ?>"
											...
											<td>
												<input type="text"
													value="<?php echo $tbInfo['sample_dispatched_datetime']; ?>"
													class="date-time form-control" id="sampleDispatchedDate"
													name="sampleDispatchedDate"
													placeholder="<?= _translate("Please enter date"); ?>"
										...
										<tr>
											...
											<td>
												<select class="form-control" name="isSampleRejected" id="isSampleRejected"
													title="Please select the Is sample rejected?">
													<option value=''> -- Select -- </option>
											...
											<td><select name="correctiveAction" id="correctiveAction" class="form-control"
													...
													<?php foreach ($correctiveActions as $action) { ?>
														<option
															...
															<?php echo ($tbInfo['recommended_corrective_action'] == $action['recommended_corrective_action_id']) ? 'selected="selected"' : ''; ?>>
													...
													<thead>
														<tr>
															<th scope="row" colspan="3" style="text-align: center;">
																Microscopy Test Results</th>
														</tr>
														<tr>
															<th scope="row" style="width: 10%;" class="text-center">Test #
															</th>
															<th scope="row" style="width: 40%;" class="text-center">Result
															</th>
															<th scope="row" style="width: 40%;" class="text-center">Actual
																Number</th>
														</tr>
													</thead>
											...
											<td colspan="5">
												<table aria-describedby="table" class="table table-bordered table-striped"
													...
													<thead>
														...
														<tr>
															<th scope="row" style="width: 30%;" class="text-center">Test
																Name</th>
															<th scope="row" style="width: 40%;" class="text-center">Result
															</th>
															<th scope="row" style="width: 40%;" class="text-center">Date of
																Result</th>
														</tr>
													</thead>
													<tbody>
														<tr>
															...
															<td>
																<select class="form-control" name="xPertMTMResult"
																	id="xPertMTMResult"
															...
															<td>
																<input type="text" name="xpertDateOfResult"
																	id="xpertDateOfResult" class="dateTime form-control"
																	placeholder="Date Of Result"
																	title="Please enter the Date Of Result"
																	value="<?php echo $tbInfo['xpert_result_date']; ?>" />
															</td>
														</tr>
														<tr>
															...
															<td>
																<input type="text" name="tbLamDateOfResult"
																	id="tbLamDateOfResult" class="dateTime form-control"
																	placeholder="Date Of Result"
																	title="Please enter the Date Of Result"
																	value="<?php echo $tbInfo['tblam_result_date']; ?>" />
															</td>
										...
										<tr>
											...
											<td>
												<select class="form-control" name="cultureResult" id="cultureResult"
													title="Please select the Culture Result">
													<?= $general->generateSelectOptions($tbCultureResults, $tbInfo['culture_result'], '-- Select --'); ?>
												</select>
											</td>
											<td>
												<input type="text" name="cultureDateOfResult" id="cultureDateOfResult"
													class="dateTime form-control" placeholder="Date Of Result"
													title="Please enter the Date Of Result"
													value="<?php echo $tbInfo['culture_result_date']; ?>" />
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control" name="identicationResult"
													id="identicationResult" title="Please select the Identification result">
													<?= $general->generateSelectOptions($tbIdentificationResults, $tbInfo['identification_result'], '-- Select --'); ?>
												</select>
											</td>
											<td>
												<input type="text" name="identificationDateOfResult"
													id="identificationDateOfResult" class="dateTime form-control"
													placeholder="Date Of Result" title="Please enter the Date Of Result"
													value="<?php echo $tbInfo['identification_result_date']; ?>" />
											</td>
										...
										<tr>
											...
											<td>
												<input type="text" name="drugMGITDateOfResult" id="drugMGITDateOfResult"
													class="dateTime form-control" placeholder="Date Of Result"
													title="Please enter the Date Of Result"
													value="<?php echo $tbInfo['drug_mgit_result_date']; ?>" />
											</td>
										...
										<tr>
											...
											<td>
												<select class="form-control" name="drugLPAResult" id="drugLPAResult"
													title="Please select the Drug LPA result">
													<?= $general->generateSelectOptions($tbdrugLPAResults, $tbInfo['drug_lpa_result'], '-- Select --'); ?>
												</select>
											</td>
											<td>
												<input type="text" name="drugLPADateOfResult" id="drugLPADateOfResult"
													class="dateTime form-control" placeholder="Date Of Result"
													title="Please enter the Date Of Result"
													value="<?php echo $tbInfo['drug_lpa_result_date']; ?>" />
											</td>
									...
									<tr>
										<th scope="row"><label class="label-control" for="reviewedBy">Reviewed By</label>
										</th>
										<td>
										...
										<th scope="row"><label class="label-control" for="reviewedOn">Reviewed on</label>
										</th>
										<td><input type="text" value="<?php echo $tbInfo['result_reviewed_datetime']; ?>"
									...
									<tr>
										<th scope="row"><label class="label-control" for="approvedBy">Approved By</label>
										</th>
										<td>
										...
										<th scope="row"><label class="label-control" for="approvedOn">Approved on</label>
										</th>
										<td><input type="text" value="<?php echo $tbInfo['result_approved_datetime']; ?>"
												name="approvedOn" id="approvedOn" class="date-time form-control"
												placeholder="Approved on" title="Please enter the approved on date" /></td>
									</tr>
									<tr>
										<th scope="row"><label class="label-control" for="labComments">Lab Comments</label>
										</th>

										<td>
											<textarea class="form-control labSection" name="labComments" id="labComments"
												placeholder="Lab comments"><?php echo trim((string) $tbInfo['lab_tech_comments']); ?></textarea>
										</td>
									</tr>
