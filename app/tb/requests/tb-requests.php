                ...
                <div class="box filter-panel filter-panel-collapsed">
                    ...
                    <div class="filter-actions">
                        ...
                        <?php if (_isAllowed("/tb/requests/tb-add-request.php") && !$hidesrcofreq) { ?>
                            <a href="/tb/requests/tb-add-request.php" class="filter-keep btn btn-primary btn-sm pull-right">
                                <em class="fa-solid fa-plus"></em> <?= _htmlTranslate("Add new TB Request"); ?>
                            </a>
                        <?php } ?>
                        <?php if (_isAllowed("/tb/requests/export-tb-requests.php")) { ?>
                            <a class="filter-export btn btn-success btn-sm pull-right" href="javascript:void(0);" onclick="exportAllPendingTbRequest();">
