        ...
        where tb_id= " . $result['tb_id'] . " ORDER BY tb_test_id DESC";
            ...
            if (!empty($tbTestInfo)) {
                ...
                foreach ($tbTestInfo as $row) {
                    ...
                    $html .= '</tr>';
                    $html .= '<tr>';
                    $html .= '<td style="line-height:17px;font-size:12px;text-align:left;width:20%">Approved By:</td>';
                    $html .= '<td style="line-height:17px;font-size:12px;text-align:left;width:30%">' . $row['approvedBy'] . '</td>';
