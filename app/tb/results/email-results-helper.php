...
if (isset($_POST['toEmail']) && trim((string) $_POST['toEmail']) !== '') {
   $tempMailData = ["to_mail" => $_POST['toEmail'], "subject" => $_POST['subject'], "text_message" => $_POST['message'], "report_email" => $_POST['reportEmail'], "test_type" => 'tb', "attachment" => MailAttachmentUtility::queueValue($_POST['pdfFile1'] ?? null), "samples" => trim((string) $_POST['sample']) === '' ? $_POST['sample'] : $db->inIntList($_POST['sample']), "status" => "pending"];
