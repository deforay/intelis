		...
		<div class="box box-default">
			<div class="box-header with-border">
				<div class="pull-right" style="font-size:15px;"><span class="mandatory">*</span>
					<?= _translate("indicates required fields"); ?> &nbsp;
				</div>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
					...
					<div class="box-body">
						<div class="box box-default disabledForm">
							<div class="box-body">
									...
									<tr>
										...
										<td>
											<select class="form-control select2" name="province" id="province"
												title="Please choose Region" onchange="getfacilityDetails(this);"
												style="width:100%;">
												<?php echo $province; ?>
											</select>
										</td>
									...
									<tr>
										...
										<td>
											<input type="text"
												...
												class="date-time form-control" id="requestedDate" name="requestedDate"
										...
										<td>
											...
											<input type="text" style="display: none;" name="otherReferringUnit"
								...
								<div class="box-header with-border">
									<input style="width:30%;" type="text" name="patientNoSearch" id="patientNoSearch"
										class="" placeholder="Enter Patient ID or Patient Name"
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr>
										<th scope="row" style="width:15%"><label for="patientId">TB Registration Unique
												ID </label></th>
										<td style="width:35%">
										...
										<th scope="row" style="width:15%"><label for="firstName">First Name </label>
										</th>
										<td style="width:35%">
									...
									<tr>
										...
										<td>
											<input type="text"
												...
												class="form-control" id="dob" name="dob" placeholder="Date of Birth"
									...
									<tr>
										...
										<td>
											<select class="select2 form-control" name="typeOfPatient" id="typeOfPatient"
												title="Please select the type of patient"
											...
											<input type="text" class="form-control" id="typeOfPatientOther"
												name="typeOfPatientOther" placeholder="Enter type of patient if others"
										...
										<td colspan="2">
											<label class="radio-inline" style="margin-left:0;">
												<input type="radio" class="diagnosis-check" id="reasonForTbTest1"
													...
													title="Select reason for examination"
										...
										<td colspan="2">
											<label class="radio-inline" style="margin-left:0;">
												<input type="radio" class="followup-uncheck" id="reasonForTbTest2"
													...
													<?php echo (isset($reasonForTbTest->reason->followup) && $reasonForTbTest->reason->followup == "yes") ? "checked" : ""; ?>>
												<strong>Follow Up</strong>
											</label>
										</td>
									</tr>
									<tr class="diagnosis hide-reasons"
										style="display: <?php echo (isset($reasonForTbTest->reason->diagnosis) && $reasonForTbTest->reason->diagnosis == "yes") ? "table-row" : "none"; ?>; border: 1px solid #8080804f;">
										<td colspan="2" style="text-align: left; padding: 10px;">
											<ul
												style="display: inline-flex; list-style: none; padding: 0px; margin: 0;">
												<li style="margin-right: 20px;">
													<label class="radio-inline" style="margin-left:0;">
														<input type="checkbox" class="diagnosis-check reason-checkbox"
															id="presumptiveTb"
									...
									<tr class="follow-up hide-reasons"
										style="display: <?php echo (isset($reasonForTbTest->reason->followup) && $reasonForTbTest->reason->followup == "yes") ? "table-row" : "none"; ?>; border: 1px solid #8080804f;">
										<td colspan="2"></td>
										<td colspan="2" style="text-align: left; padding: 10px;">
											<ul class="followUp"
												style="display: inline-flex; list-style: none; padding: 0px; margin: 0;">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									<tr>
										<th scope="row" style="width:15%"><label class="label-control"
												for="sampleCollectionDate">Date
									...
									<tr>
										...
										<td>
											...
											<input type="text" id="sampleTypeOther" name="sampleTypeOther"
												placeholder="Enter sample type of others"
								...
								<div class="box-body">
									...
									<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
										<tr>
											...
											<td>
												<input type="text" value="<?php echo $tbInfo['sample_tested_datetime']; ?>"
													class="date-time form-control isRequired" id="sampleTestedDateTime"
										...
										<tr>
											...
											<!-- Duplicate of the Tested By control in the sign-off row below, which is later in
											     the DOM and is therefore the value PHP keeps. Editing this one had no effect. -->
											<!--
											...
											<td>
												<select name="testedBy" id="testedBy" class="select2 form-control"
													...
													options came from $general->generateSelectOptions($userInfo, $tbInfo['tested_by'], '-- Select --')
												</select>
											</td>
											-->
										...
										<tr>
											...
											<td>
												<select class="form-control isRequired" name="isSampleRejected"
													id="isSampleRejected" title="Please select the Is sample rejected?">
													<option value=''> -- Select -- </option>
										...
										<tr class="show-rejection" style="display:none;">
											...
											<th scope="row"><label class="label-control" for="sampleRejectionReason">Reason
													for Rejection
									...
									<tr>
										<th scope="row"><label class="label-control" for="reviewedBy">Reviewed By <span
										...
										<th scope="row"><label class="label-control" for="reviewedOn">Reviewed on <span
													class="mandatory">*</span></label></th>
									...
									<tr>
										<th scope="row"><label class="label-control" for="approvedBy">Approved By <span
													class="mandatory">*</span></label></th>
										<td>
											<select name="approvedBy" id="approvedBy"
												class="select2 form-control isRequired" title="Please choose approved by"
												style="width: 100%;">
												<?= $general->generateSelectOptions($userInfo, $tbInfo['result_approved_by'], '-- Select --'); ?>
											</select>
										</td>
										<th scope="row"><label class="label-control" for="approvedOn">Approved on <span
													class="mandatory">*</span></label></th>
										<td><input type="text" value="<?php echo $tbInfo['result_approved_datetime']; ?>"
												name="approvedOn" id="approvedOn" class="date-time form-control isRequired"
												placeholder="Approved on" title="Please enter the approved on date" /></td>
									</tr>
									<tr>
										<th scope="row"><label class="label-control" for="testedBy">Tested By <span
													class="mandatory">*</span></label></th>
										<td>
