				...
				<div class="box-body">
					<div class="box box-default disabledForm">
						<div class="box-body">
							...
							<div class="box-header with-border">
								<h3 class="box-title" style="font-size:1em;">To be filled by requesting Clinician/Nurse
								</h3>
							</div>
									...
									<?php } else { ?>
										...
										<td style="width: 18%;">
											<input type="text" value="<?php echo $tbInfo['sample_code']; ?>"
												class="form-control" id="sampleCode" name="sampleCode" readonly="readonly"
							...
							<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
								<tr>
									<td><label class="label-control" for="province">Health Facility/POE State </label>
									</td>
									<td>
									...
									<td><label class="label-control" for="district">Health Facility/POE County </label>
									</td>
									<td>
								...
								<tr>
									...
									<td>
										<input type="text" value="<?php echo $tbInfo['request_created_datetime']; ?>"
											class="date-time form-control" id="requestedDate" name="sampleReceivedDate"
									...
									<td>
										<select class="form-control " name="referringUnit" id="referringUnit"
											...
											<option value="">-- Select --</option>
											<option value="art" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'art') ? "selected='selected'" : ""; ?>>ART
											</option>
											<option value="opd" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'opd') ? "selected='selected'" : ""; ?>>OPD
											</option>
											<option value="tb" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'tb') ? "selected='selected'" : ""; ?>">TB
											</option>
											<option value="pmtct" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'pmtct') ? "selected='selected'" : ""; ?>>
												PMTCT</option>
											<option value="medical" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'medical') ? "selected='selected'" : ""; ?>>
												Medical</option>
											...
											<option value="others" <?php echo (isset($tbInfo['referring_unit']) && $tbInfo['referring_unit'] == 'others') ? "selected='selected'" : ""; ?>>
												Others</option>
										</select>
							...
							<div class="box-header with-border">
								...
								<a style="margin-top:-0.35%;" href="javascript:void(0);" class="btn btn-default btn-sm"
									onclick="showPatientList();"><em
										class="fa-solid fa-magnifying-glass"></em>Search</a><span id="showEmptyResult"
							...
							<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
								<tr>
									...
									<td>
										<input type="text" value="<?php echo $tbInfo['patient_name']; ?>"
											...
											placeholder="First Name" title="Please enter First name" style="width:100%;"
											onchange="" />
									</td>
								</tr>
								<tr>
									...
									<td>
										<input type="text" value="<?php echo $tbInfo['patient_surname']; ?>"
											...
											title="Please enter Last name" style="width:100%;" onchange="" />
									</td>
								...
								<tr>
									...
									<td><input type="number" value="<?php echo $tbInfo['patient_age']; ?>" max="150"
											...
											placeholder="Patient Age (in years)" title="Patient Age" style="width:100%;"
											onchange="" /></td>
									...
									<td>
										<select class="form-control" name="patientGender" id="patientGender"
											...
											<option value='male' <?php echo (isset($tbInfo['patient_gender']) && $tbInfo['patient_gender'] == 'male') ? "selected='selected'" : ""; ?>>
												Male </option>
											<option value='female' <?php echo (isset($tbInfo['patient_gender']) && $tbInfo['patient_gender'] == 'female') ? "selected='selected'" : ""; ?>>
												Female </option>
											<option value='other' <?php echo (isset($tbInfo['patient_gender']) && $tbInfo['patient_gender'] == 'other') ? "selected='selected'" : ""; ?>>
												Other </option>
										</select>
									</td>
								</tr>
								<tr>
									...
									<td>
										<select class="select2 form-control" name="typeOfPatient" id="typeOfPatient"
											...
											<option value='relapse' <?php echo ($typeOfPatient == 'relapse') ? "selected='selected'" : ""; ?>>
												Relapse </option>
											<option value='other' <?php echo ($typeOfPatient == 'other') ? "selected='selected'" : ""; ?>> Other </option>
										</select>
									...
									<td>
										<label class="radio-inline" style="margin-left:0;">
											<input type="radio" class="diagnosis-check" id="reasonForTbTest1"
												...
												onchange="checkSubReason(this,'diagnosis', 'followup-uncheck');" <?php echo (isset($reasonForTbTest->reason->diagnosis) && $reasonForTbTest->reason->diagnosis == "yes") ? "checked" : ""; ?>>
									...
									<td>
										<label class="radio-inline" style="margin-left:0;">
											<input type="radio" class="followup-uncheck" id="reasonForTbTest2"
												...
												title="Select reason for examination"
												onchange="checkSubReason(this,'follow-up', 'diagnosis-check');" <?php echo (isset($reasonForTbTest->reason->followup) && $reasonForTbTest->reason->followup == "yes") ? "checked" : ""; ?>>
									...
									<td style="float: left;text-align: center;">
										<div class="follow-up hide-reasons"
											...
											<input type="text"
												...
												placeholder="Enter the follow up" title="Please enter the follow up">
										</div>
									</td>
								</tr>
							</table>
									...
									<td>
										<select name="testTypeRequested[]" id="testTypeRequested"
											...
											<optgroup label="Xpert MTB">
												...
												<option value="MTB/RIF ULTRA" <?php echo (isset($tbInfo['tests_requested']) && in_array("MTB/RIF ULTRA", $testTypeRequested)) ? "selected='selecetd'" : ""; ?>>MTB/RIF ULTRA
												</option>
							...
							<div class="box box-primary">
								<div class="box-body">
									...
									<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
										...
										<tr>
											<th scope="row" class="platform xpert" <?php echo (isset($attributes) && $attributes != "" && in_array("xpert", $attributes)) ? 'style="display:none;"' : ''; ?>><label class="label-control"
													for="xPertMTMResult">Xpert MTB Result <span
											...
											<td class="platform xpert" <?php echo (isset($attributes) && $attributes != "" && in_array("xpert", $attributes)) ? 'style="display:none;"' : ''; ?>>
												<select class="form-control test-result test-name-table-input isRequired"
													name="xPertMTMResult" id="xPertMTMResult"
													title="Please select the Xpert MTM Result">
													<?= $general->generateSelectOptions($tbXPertResults, $tbInfo['xpert_mtb_result'], '-- Select --'); ?>
												</select>
											</td>
											<th scope="row"
												class="platform lam <?php echo (isset($attributes) && $attributes != "" && in_array("lam", $attributes)) ? 'style="display:none;"' : ''; ?>">
												<label class="label-control" for="result">TB LAM Result <span
														class="mandatory">*</span></label>
											</th>
											<td
												class="platform lam <?php echo (isset($attributes) && $attributes != "" && in_array("lam", $attributes)) ? 'style="display:none;"' : ''; ?>">
												<select class="form-control isRequired" name="tbLamResult" id="tbLamResult"
										...
										<tr>
											...
											<th scope="row"><label class="label-control" for="reviewedOn">Reviewed on <span
														class="mandatory">*</span></label></th>
											<td><input type="text"
													value="<?php echo $tbInfo['result_reviewed_datetime']; ?>"
										...
										<tr>
											...
											<th scope="row"><label class="label-control" for="approvedOn">Approved on <span
														class="mandatory">*</span></label></th>
											<td><input type="text"
													value="<?php echo $tbInfo['result_approved_datetime']; ?>"
													name="approvedOn" id="approvedOn"
													class="date-time form-control isRequired" placeholder="Approved on"
