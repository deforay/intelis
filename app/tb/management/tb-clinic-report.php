...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		ClinicReports.start();
		$("#highTbReport input, #highTbReport select, #sampleRjtReport input, #sampleRjtReport select, #notAvailReport input, #notAvailReport select, #incompleteFormReport input, #incompleteFormReport select").on("change", function() {
			searchExecuted = false;
		});
	});
