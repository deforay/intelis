							...
							<div class="widget-content">
								<div class="bs bs-tabs">
									<ul id="myTab" class="nav nav-tabs clinic-tabs">
										<li class="active"><a href="#highTbReport" data-toggle="tab" data-tab-name="positivity"><?php echo _translate("Positivity"); ?></a></li>
									...
									<div id="myTabContent" class="tab-content">
										<div class="tab-pane fade in active" id="highTbReport">
											<div class="box box-default filter-panel filter-panel-collapsed">
												...
												<div class="box-footer filter-actions">
													&nbsp;<input type="button" onclick="searchTbRequestData();" value="<?php echo _htmlTranslate("Search"); ?>" class="filter-search btn btn-success btn-sm">
										...
										<div class="tab-pane fade" id="dataQualityReport">
											<?php $dqTestType = 'tb'; require APPLICATION_PATH . '/reports/_data-quality-tab.php'; ?>
										</div>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('#positiveTbSampleTestDate,#rjtSampleCollectionDate,#noResultSampleTestDate,#stSampleCollectionDate').daterangepicker({
				locale: {
		...
		ClinicReports.start();
		$("#highTbReport input, #highTbReport select, #sampleRjtReport input, #sampleRjtReport select, #notAvailReport input, #notAvailReport select").on("change", function() {
			searchExecuted = false;
		});
	});
