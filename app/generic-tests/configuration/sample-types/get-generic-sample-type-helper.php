...
$aColumns = ['sample_type_name', 'sample_type_code', 'sample_type_status', 'updated_datetime'];
...
$aResultFilterTotal = $db->rawQuery("SELECT * FROM r_generic_sample_types $sWhere");
