...
<style>
    /* TB-style field layout: label sits on top of a full-width input (frees long labels
       from the narrow side column), and each row's columns are equal height so wrapped
       labels never leave uneven gaps. Scoped to .gtStackedForm so only this form changes. */
    .gtStackedForm .row {
        display: flex;
        flex-wrap: wrap;
    }

    .gtStackedForm .row>[class*="col-md-"],
    .gtStackedForm .row>[class*="col-lg-"] {
        display: flex;
        flex-direction: column;
    }

    /* Vertical breathing room between field rows (each field column carries it). */
    .gtStackedForm .row>[class*="col-md-"] {
        margin-bottom: 16px;
    }

    .gtStackedForm label.col-lg-5,
    .gtStackedForm label.control-label {
        line-height: 1.3;
    }
    ...
    .gtStackedForm .col-lg-7 {
        float: none;
        width: 100%;
        padding: 0;
    }

    .gtStackedForm .col-lg-7 .form-control,
    .gtStackedForm .col-lg-7 .select2-container {
        width: 100% !important;
    }

    /* Sections whose fields are split across several 2-per-row wrappers: flatten those
       wrappers so the col-md-4 columns flow three-to-a-row. The -15px sides reproduce a
       Bootstrap .row's gutters, so these sections line up identically to the .row ones. */
    .gtStackedForm .gtFlat {
        display: flex;
        flex-wrap: wrap;
        margin-left: -15px;
        margin-right: -15px;
    ...
    .gtStackedForm .gtFlat>.row {
        display: contents;
    }

</style>
                         <div class="box-body gtStackedForm">
                              ...
                              <div class="box box-primary requestForm<?= $dnr ?>" style="display:none;">
                                   ...
                                   <div class="requestForm gtFlat" style="display:none;">
                                        <div class="row">
                                             <!-- BARCODESTUFF START -->
                              ...
                              <div class="box box-primary requestForm<?= $dnr ?>" style="display:none;">
                                   ...
                                   <div class="box-body gtFlat">
                                        ...
                                        <div class="row">
                                             ...
                                             <div class="col-md-4 femaleSection">
                                                  <label class="col-lg-5"
                                        ...
                                        <div class="row ">
                                             ...
                                             <div class="col-md-4" style="display:none;" id="patientSection">
                                                  <label class="col-lg-5"
                                   ...
                                   <div class="box box-primary<?= $dnr ?>">
                                        ...
                                        <div class="box-body">
                                             <div class="row">
                                                  ...
                                                  <div class="col-md-4" id="specimenSection">
                                                       <label class="col-lg-5"
