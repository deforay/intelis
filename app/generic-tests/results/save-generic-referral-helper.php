...
try {
    ...
    foreach ($referralSamples as $sampleId) {
        ...
        if ($update) {
            ...
            $resource = 'generic-results-referral-lab';
    ...
    LoggerUtility::log("error", "Generic Referral Error: " . $e->getMessage(), [
        'file' => __FILE__,
        'line' => __LINE__,
...
header("Location: /generic-tests/results/generic-referral-list.php");
exit;
