		...
		<div class="box box-default">
			...
			<div class="box-body">
				<form class="form-inline" method="post" name="vlRequestFormRwd" id="vlRequestFormRwd"
					...
					$disableNonResult  = true;
					$onTestTypeChange         = 'getTestTypeForm();';
					$onFacilityChange         = '';
					$onLabChange              = 'autoFillFocalDetails();';
					$onSampleCollectionChange = 'checkSampleTestingDate();';
					$cancelUrl                = 'generic-test-results.php';
					include __DIR__ . '/../requests/_request-form-body.php';
					?>
				</form>
	</section>
</div>
			...
			$.post("/generic-tests/requests/getTestTypeForm.php", {
				...
				function(data) {
					...
					if (typeof (data.caseInformation) != "undefined" && data.caseInformation !== null && data.caseInformation.length > 0) {
						...
						$('#caseInformation input, #caseInformation select , #caseInformation textarea').attr('disabled', true);
						$('#caseInformation input, #caseInformation select , #caseInformation textarea').removeClass("isRequired");
