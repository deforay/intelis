...
$genericTestInfo = $db->rawQuery($genericTestQuery, [$id]);
		...
		<div class="box box-default">
			...
			<div class="box-body">
				<div class="box-body">
					<div class="box box-primary disabledForm">
							...
							<div class="col-md-6">
								...
								<div class="col-lg-7">
									<input type="checkbox" class="" id="sampleReordered" name="sampleReordered"
										value="yes" <?php echo (trim((string) $genericResultInfo['sample_reordered']) === 'yes') ? 'checked="checked"' : '' ?>
										title="<?= _translate('Please indicate if this is a reordered sample'); ?>">
						...
						<div class="requestForm" style="display:none;">
							<div class="row">
								<div class="col-md-6">
									<label class="col-lg-5" for="province"><?= _translate("State/Province"); ?> <span
											class="mandatory">*</span></label>
									<div class="col-lg-7">
										<select class="form-control isRequired" name="province" id="province"
											title="<?= _translate('Please choose state'); ?>" style="width:100%;"
								...
								<div class="col-md-6">
									<label class="col-lg-5" for="district"><?= _translate("District/County"); ?> <span
											class="mandatory">*</span></label>
									<div class="col-lg-7">
										<select class="form-control isRequired" name="district" id="district"
											title="<?= _translate('Please choose county'); ?>" style="width:100%;"
							...
							<div class="row">
								<div class="col-md-6">
									<label class="col-lg-5" for="facilityId"><?= _translate('Clinic/Health Center'); ?>
								...
								<div class="col-md-6" style="display:none;">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control" style="width:100%;" name="facilityCode"
											id="facilityCode"
					...
					<div class="box box-primary requestForm" style="display:none;">
						...
						<div class="box-body disabledForm">
							<div class="row">
								<div class="col-md-6">
									<label class="col-lg-5" for="artNo"><?= _translate('Patient ID'); ?> <span
											class="mandatory">*</span></label>
									<div class="col-lg-7">
										<input type="text" name="artNo" id="artNo" class="form-control isRequired"
											placeholder="<?= _translate('Enter Patient ID'); ?>"
											title="<?= _translate('Enter patient id'); ?>"
									...
									<div class="col-lg-7">
										...
										<label class="radio-inline" style="margin-left:0px;">
											<input type="radio" class="" id="genderFemale" name="gender" value="female"
												title="<?= _translate('Please choose sex'); ?>" <?php echo ($genericResultInfo['patient_gender'] == 'female') ? "checked='checked'" : "" ?>>
											Female
										</label>
										<label class="radio-inline" style="margin-left:0px;">
											<input type="radio" class="" id="genderUnreported" name="gender"
												value="unreported" title="<?= _translate('Please choose sex'); ?>" <?php echo ($genericResultInfo['patient_gender'] == 'unreported') ? "checked='checked'" : "" ?>>
											Unreported
										</label>
									</div>
								</div>
									...
									<div class="col-lg-7">
										<label class="radio-inline" style="margin-left:0px;">
											<input type="radio" class="" id="receivesmsYes" name="receiveSms"
												value="yes" title="<?= _translate('Patient consent to receive SMS'); ?>"
								...
								<div class="col-md-6 femaleSection"
									...
									<div class="col-lg-7">
										<label class="radio-inline">
											<input type="radio" class="" id="pregYes" name="patientPregnant" value="yes"
												title="<?= _translate('Is Patient Pregnant?'); ?>" <?php echo ($genericResultInfo['is_patient_pregnant'] == 'yes') ? "checked='checked'" : "" ?>>
											<?= _translate('Yes'); ?>
										</label>
										<label class="radio-inline">
											<input type="radio" class="" id="pregNo" name="patientPregnant" value="no"
												<?php echo ($genericResultInfo['is_patient_pregnant'] == 'no') ? "checked='checked'" : "" ?>>
											<?= _translate('No'); ?>
										</label>
									</div>
								</div>
						...
						<div class="box box-primary disabledForm">
							...
							<div class="box-body">
								<div class="row">
									<div class="col-md-6">
										<label class="col-lg-5" for=""><?= _translate('Date of Sample Collection'); ?>
											<span class="mandatory">*</span></label>
										<div class="col-lg-7">
									...
									<div class="col-md-6">
										<label class="col-lg-5" for=""><?= _translate('Sample Dispatched On'); ?> <span
												class="mandatory">*</span></label>
										<div class="col-lg-7">
											<input type="text" class="form-control isRequired dateTime"
								...
								<div class="box-body labSectionBody">
										...
										<div class="col-md-6">
											...
											<div class="col-lg-7">
												<select name="labId" id="labId" class="form-control isRequired"
													title="<?= _translate('Please choose lab'); ?>"
													onchange="autoFillFocalDetails();" style="width:100%;">
													<option value=""><?= _translate("-- Select --"); ?></option>
										...
										<div class="col-md-6">
											...
											<div class="col-lg-7">
												<input type="text"
													...
													<?php echo ($genericResultInfo['is_sample_rejected'] == 'yes') ? ' disabled="disabled" ' : ''; ?> id="sampleTestingDateTimeAtLab"
									...
									<div class="row" style="margin-top: 10px;">
												...
												<select name="reasonForTesting" id="reasonForTesting"
													...
													<?php foreach ($testReason as $treason) { ?>
														<option value="<?php echo $treason['test_reason_id']; ?>" <?php echo ($genericResultInfo['reason_for_testing'] == $treason['test_reason_id']) ? 'selected="selected"' : ''; ?>>
															<?php echo ucwords((string) $treason['test_reason']); ?>
														</option>
													<?php } ?>
												</select>
											</div>
										...
										<div class="col-md-6 vlResult">
											<label class="col-lg-5 control-label"
												for="resultDispatchedOn"><?= _translate("Date Results Dispatched"); ?>
											</label>
											<div class="col-lg-7">
												<input type="text" class="form-control labSection dateTime"
										...
										<div class="col-md-6 vlResult subTestFields">
											...
											<div class="col-lg-7">
												<select class="form-control ms-container subTestFields multiselect"
									...
									<div class="row">
										...
										<div class="col-md-6">
											<label class="col-lg-5 control-label"
												for="reviewedOn"><?= _translate("Reviewed On"); ?>
									...
									<div class="row">
										<div class="col-md-6">
											<label class="col-lg-5 control-label"
												for="testedBy"><?= _translate("Tested By"); ?>
											</label>
											<div class="col-lg-7">
										...
										<div class="col-md-6" style="margin-top: 10px;">
											<label class="col-lg-5 control-label"
												for="approvedBy"><?= _translate("Approved By"); ?>
												<span class="mandatory review-approve-span"
									...
									<div class="row">
										<div class="col-md-6">
											<label class="col-lg-5 control-label"
												for="approvedOn"><?= _translate("Approved On"); ?>
												<span class="mandatory review-approve-span"
													style="display: <?php echo ($genericResultInfo['is_sample_rejected'] != '') ? 'block' : 'none'; ?>;">*</span></label>
											<div class="col-lg-7">
												<input type="text"
				...
				<div class="box-footer">
					...
					<input type="hidden" name="sampleCode" id="sampleCode"
						value="<?= ($genericResultInfo[$sampleCode]); ?>" />
