...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1><em class="fa-solid fa-list-check"></em> <?php echo _translate("Import"); ?>
			<?= strtoupper(htmlspecialchars((string) $type)); ?> <?php echo _translate("Test Results From File"); ?>
		</h1>
		<ol class="breadcrumb">
			...
			<div class="box-body">
				...
				<div style="font-size:1.1em;padding:1em;">
					<h3 style="color:red;font-weight:bold;">
						<?php echo _translate("Please ensure that the Sample IDs in the import file match the Sample IDs in the LIS."); ?>
					</h3>

					<p>
						<?php echo _translate("To ensure proper result import :") ?>
					<ol>
						<li><?php echo _translate("Record the Samples in LIS before sending them to Testing machine."); ?>
						</li>
						<li><?php echo _translate("Create a Batch with the samples recorded in the previous step."); ?>
						</li>
						<li><?php echo _translate("Use the Batch to test Samples in Viral Load machines."); ?></li>
						<li><?php echo _translate("Export the result file (containing Sample IDs generated by VLSM) from the VL machine."); ?>
						</li>
						<li><?php echo _translate("Import the file below. Make sure to pick the specific Machine Name/Code."); ?>
						</li>
					</ol>
					</p>


					<form class="form-horizontal" method='post' name='importResultFileForm' id='importResultFileForm'
						enctype="multipart/form-data" autocomplete="off" action="import-file-helper.php">
						<div class="box-body">
								...
								<div class="col-md-12">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="machineName"
													class="col-lg-5 control-label"><?php echo _translate("Instrument/Platform Name"); ?>
													<span class="mandatory">*</span></label>
												<div class="col-lg-7">
													<select name="machineName" id="machineName"
														class="form-control isRequired"
														title="<?php echo _translate('Please select the import machine type'); ?>"
														onchange="getConfigMachineName();">
														<option value=""> <?php echo _translate("-- Select --"); ?>
														</option>
														<?php foreach ($instrumentsList as $val) { ?>
															<option
																value="<?php echo base64_encode((string) $val['instrument_id']); ?>">
																<?php echo ($val['machine_name']); ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="machineName"
													class="col-lg-5 control-label"><?php echo _translate("Specific Machine Name/Code"); ?></label>
												<div class="col-lg-7">
													<select name="configMachineName" id="configMachineName"
														class="form-control"
														title="<?php echo _translate('Please select instrument'); ?>">
														<option value=""> <?php echo _translate("-- Select --"); ?>
														</option>
													</select>
												</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label for="dateFormat" class="col-lg-5 control-label">
													<?php echo _translate("Date Format"); ?> <span
													...
													<div class="smart-date-cell">
														...
														<div style="margin-bottom: 8px;">
															<input type="text" name="sampleDateInput"
																id="sampleDateInput" class="form-control"
																...
																data-row-id="import" data-default-format="d/m/Y H:i" />
															<small style="color: #666; font-size: 11px;">💡
																<?php echo _translate("Enter any date from your import file to auto-detect format"); ?></small>
														</div>

														<!-- Smart Suggestions Container -->
														<div id="formatSuggestions"
															class="format-suggestions-container"></div>

														<!-- The actual field your backend expects (KEEP EXACT NAMES) -->
														<input type="hidden" class="form-control isRequired"
															id="dateFormat" name="dateFormat" value=""
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label for="labId"
													class="col-lg-5 control-label"><?php echo _translate("Testing Lab Name"); ?>
													<span class="mandatory">*</span></label>
												<div class="col-lg-7">
													<select name="labId" id="labId" class="form-control isRequired"
														...
														foreach ($facilitiesList as $val) {
															...
															<option
																...
																<?php echo ($val['facility_name']); ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label
													class="col-lg-5 control-label"><?php echo _translate("Upload"); ?>
													<?= $testName; ?> <?php echo _translate("File"); ?> <span
														class="mandatory">*</span></label>
												<div class="col-lg-7">
													<input type="file" class="isRequired"
														accept=".xls,.xlsx,.csv,.txt,.lis" name="resultFile"
														id="resultFile"
														title="<?php echo _translate('Please choose result file'); ?>">
