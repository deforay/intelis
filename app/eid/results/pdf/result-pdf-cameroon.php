...
if (!empty($result)) {
    ...
    if (!empty($result['vl_facility_attributes'])) {
        $vlFacilityAttributes = json_decode((string) $result['vl_facility_attributes'], true);
    ...
    $html .= '<tr>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('Health Facility/POE')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('Health Facility/POE CODE')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('Health Facility/POE STATE')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('Health Facility/POE COUNTY')) . '</td>';
    $html .= '</tr>';
    $html .= '<tr>';
    ...
    $html .= '<tr>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('LAB NAME')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('PATIENT NAME')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('ARV PROTOCOL FOLLOWED BY MOTHER')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('CHILD ID')) . '</td>';
    $html .= '</tr>';
    $html .= '<tr>';
    ...
    $html .= '</tr>';
    $html .= '<tr>';
    $html .= '<td colspan="2" style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('REQUESTING CLINICIAN NAME')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('TEL')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('EMAIL')) . '</td>';
    $html .= '</tr>';
    $html .= '<tr>';
    ...
    $html .= '</tr>';
    $html .= '<tr>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('SAMPLE ID')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('SAMPLE COLLECTION DATE')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('SAMPLE RECEIPT DATE')) . '</td>';
    $html .= '</tr>';
    $html .= '<tr>';
    $html .= '<td colspan="3" style="line-height:5px;"></td>';
    $html .= '</tr>';
    ...
    $html .= '</tr>';
    $html .= '<tr>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('SAMPLE TYPE')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('SAMPLE TEST DATE')) . '</td>';
    $html .= '<td style="line-height:11px;font-size:11px;font-weight:bold;text-align:left;">' . _toUpperCase(_translate('RESULT RELEASE DATE')) . '</td>';
    $html .= '</tr>';
    $html .= '<tr>';
    $html .= '<td colspan="3" style="line-height:5px;"></td>';
    $html .= '</tr>';
    ...
    if ($result['result_modified'] == "yes") {
        ...
        $resultHistory = json_decode((string) $result['reason_for_changing']);
    ...
    if ($displaySignatureTable) {
        ...
        if (!empty($testedBy) && !empty($result['sample_tested_datetime']) && ($testedBySignaturePath !== null && $testedBySignaturePath !== '' && $testedBySignaturePath !== '0') && MiscUtility::isImageValid($testedBySignaturePath)) {
            ...
            if ($testedBySignaturePath !== '' && $testedBySignaturePath !== '0' && MiscUtility::isImageValid($testedBySignaturePath)) {
        ...
        if (!empty($revisedBy) && ($revisedBySignaturePath !== null && $revisedBySignaturePath !== '' && $revisedBySignaturePath !== '0') && MiscUtility::isImageValid($revisedBySignaturePath)) {
            $html .= '<tr>';
            $html .= '<td colspan="3" style="line-height:22px;"></td>';
            $html .= '</tr>';
            $html .= '<tr>';
            ...
            if ($revisedBySignaturePath !== '' && $revisedBySignaturePath !== '0' && MiscUtility::isImageValid($revisedBySignaturePath)) {
        ...
        if ($reviewedBy != $resultApprovedBy) {
            ...
            if ($reviewedBySignaturePath !== null && $reviewedBySignaturePath !== '' && $reviewedBySignaturePath !== '0' && MiscUtility::isImageValid($reviewedBySignaturePath)) {
                $html .= '<td style="line-height:11px;font-size:11px;text-align:left;"><img src="' . $reviewedBySignaturePath . '" style="width:50px;" /></td>';
            } elseif ($approvedBySignaturePath !== null && $approvedBySignaturePath !== '' && $approvedBySignaturePath !== '0' && MiscUtility::isImageValid($approvedBySignaturePath)) {
                $html .= '<td style="line-height:11px;font-size:11px;text-align:left;"><img src="' . $approvedBySignaturePath . '" style="width:50px;" /></td>';
            } else {
                $html .= '<td style="line-height:11px;font-size:11px;text-align:left;"></td>';
            }
