        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                        ...
                        <div class="box-body disabledForm">
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <?php if ($_SESSION['accessType'] == 'collection-site') { ?>
                                        ...
                                        <td>
                                            <span id="sampleCodeInText"
                                                style="width:100%;border-bottom:1px solid #333;"><?= htmlspecialchars((string) $eidInfo['sample_code']); ?></span>
                                ...
                                <tr>
                                    ...
                                    <td class="labels"><label for="district">Health Facility/POE County </label><span
                                            class="mandatory">*</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <?php if ($general->isSTSInstance() && $_SESSION['accessType'] == 'collection-site') { ?>
                                        <th class="labels" scope="row">Testing Laboratory <span class="mandatory">*</span>
                                        </th>
                                        <td>
                                ...
                                <tr>
                                    ...
                                    <td> <input type="text" class="form-control" id="clinicianName" name="clinicianName"
                                            placeholder="Requesting Clinician Name"
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                ...
                                <tr>
                                    <th scope="row" class="labels" style="width:15% !important"><label
                                            for="childId">Exposed Infant Identification <span class="mandatory">*</span>
                                        </label></th>
                                    <td style="width:35% !important">
                                        <input type="text" class="form-control isRequired" id="childId" name="childId"
                                            placeholder="Exposed Infant Identification (Patient)"
                                            title="Please enter Exposed Infant Identification" style="width:100%;"
                                            value="<?php echo $eidInfo['child_id']; ?>" onchange="" />
                                    </td>
                                    <th scope="row" class="labels" style="width:15% !important"><label
                                ...
                                <tr>
                                    ...
                                    <th class="labels" scope="row"><label for="childGender"><?= _translate("Sex"); ?>
                                        </label></th>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="number" max=9 maxlength="1"
                                            ...
                                            title="Age" style="width:100%;" onchange=""
                                            value="<?= htmlspecialchars((string) $eidInfo['child_age']); ?>" /></td>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" class="form-control phone-number" id="caretakerPhoneNumber"
                                    ...
                                    <td><textarea class="form-control " id="caretakerAddress" name="caretakerAddress"
                                            placeholder="Caretaker Address" title="Caretaker Address"
                                            style="width:100%;"
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                ...
                                <tr>
                                    <th scope="row" class="labels" style="width:15% !important">Mother's HIV Status:
                                    </th>
                                    <td style="width:35% !important">
                                    ...
                                    <th scope="row" class="labels" style="width:15% !important">ART given to the Mother
                                        during:</th>
                                    <td style="width:35% !important">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="pcrTestReason" id="pcrTestReason">
                                            <option value=''> -- Select -- </option>
                                            <option value="Confirmation of positive first EID PCR test result" <?php echo ($eidInfo['reason_for_pcr'] == 'Confirmation of positive first EID PCR test result') ? "selected='selected'" : ""; ?>> Confirmation of
                                                positive first EID PCR test result </option>
                                            <option value="Follow-up at 9 months for negative first EID PCR results"
                                                <?php echo ($eidInfo['reason_for_pcr'] == 'Follow-up at 9 months for negative first EID PCR results') ? "selected='selected'" : ""; ?>>
                                                Follow-up at 9 months for negative first EID PCR results </option>
                                            <option
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true">
                                ...
                                <tr>
                                    <th scope="row" class="labels" style="width:15% !important">Sample Collection Date
                                    ...
                                    <th scope="row" class="labels" style="width:15% !important">Sample Type <span
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" name="sampleRequestorName"
                                            ...
                                            value="<?= htmlspecialchars((string) $eidInfo['sample_requestor_name']); ?>" />
                                    </td>
                                    ...
                                    <td>
                                        <input class="form-control" type="text" name="sampleRequestorPhone"
                                            ...
                                            value="<?= htmlspecialchars((string) $eidInfo['sample_requestor_phone']); ?>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th class="labels" scope="row">Sample Received Date (at Testing Lab) <span
                                            class="mandatory">*</span></th>
                                    <td>
                    ...
                    <form class="form-horizontal" method="post" name="editEIDRequestForm" id="editEIDRequestForm"
                        ...
                        <div class="box box-primary">
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        <th class="labels" scope="row">Testing Laboratory <span
                                                class="mandatory">*</span></th>
                                        <td>
                                            <select name="labId" id="labId" class="select2 form-control isRequired"
                                        ...
                                        <td><select name="eidPlatform" id="eidPlatform"
                                                class="form-control isRequired result-optional"
                                    ...
                                    <tr>
                                        ...
                                        <th class=" labels" scope="row">Is Sample Rejected? <span
                                                    class=" mandatory">*</span></th>
                                        <td>
                                    ...
                                    <tr class="show-rejection rejected" style="display:none;">
                                        ...
                                        <td class="rejected" style="display: none;">
                                            <select class="form-control" name="sampleRejectionReason"
                                                id="sampleRejectionReason" title="Please choose the rejection reason">
                                                <option value="">-- Select --</option>
                                        ...
                                        <th class="labels" scope="row">Rejection Date<span class="mandatory">*</span>
                                        </th>
                                        <td><input
                                                ...
                                                title="Please enter sample rejection date" /></td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width:25%;">
                                            <input type="text" class="form-control dateTime isRequired"
                                                ...
                                                value="<?= DateUtility::humanReadableDateFormat($eidInfo['sample_tested_datetime']) ?>"
                                                style="width:100%;" />
                                        </td>
                                        ...
                                        <td>
                                            <select class="form-control isRequired" name="result" id="result"
                                                ...
                                                title="Please enter the EID Test Result">
                                                <option value=''> -- Select -- </option>
                                                <?php foreach ($eidResults as $eidResultKey => $eidResultValue) { ?>
                                    ...
                                    <tr>
                                        ...
                                        <th class="labels" scope="row">Reviewed By <span
                                                class="mandatory review-approve-span"
                                                style="display: <?php echo ($eidInfo['is_sample_rejected'] != '') ? 'inline' : 'none'; ?>;">*</span>
                                        </th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="labels" scope="row">Reviewed on <span
                                                class="mandatory review-approve-span"
                                                style="display: <?php echo ($eidInfo['is_sample_rejected'] != '') ? 'inline' : 'none'; ?>;">*</span>
                                        </th>
                                        <td><input type="text"
                                                ...
                                                placeholder="Reviewed on" title="Please enter reviewed on" /></td>
                                        <th class="labels" scope="row">Approved By <span
                                                class="mandatory review-approve-span"
                                                style="display: <?php echo ($eidInfo['is_sample_rejected'] != '') ? 'inline' : 'none'; ?>;">*</span>
                                        </th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <th class="labels" style="width:25%;">Approved On <span
                                                class="mandatory review-approve-span"
                                                style="display: <?php echo ($eidInfo['is_sample_rejected'] != '') ? 'inline' : 'none'; ?>;">*</span>
                                        </th>
                                        <td style="width:25%;">
                                            <input type="text"
                                                value="<?= DateUtility::humanReadableDateFormat($eidInfo['result_approved_datetime']); ?>"
                                                class="form-control dateTime isRequired" id="approvedOnDateTime"
                                                name="approvedOnDateTime"
                                                placeholder="<?= _translate("Please enter date"); ?>"
                                                title="Please enter approved on" <?php echo $labFieldDisabled; ?>
                                                style="width:100%;" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:25%;">
                                            <textarea class="form-control" id="labTechCmt" name="labTechCmt" <?php echo $labFieldDisabled; ?> style="width:100%;"
                                                ...
                                                title="Please Comments from the Lab Technician "><?= htmlspecialchars((string) $eidInfo['lab_tech_comments']); ?></textarea>
                                        </td>
                ...
                <div class="box-footer">
                    ...
                    <input type="hidden" class="" id="sampleReceivedDate" name="sampleReceivedDate"
                        placeholder="<?= _translate("Please enter date"); ?>" title="Please enter sample receipt date"
                        value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['sample_received_at_lab_datetime']) ?>" />
                    <input type="hidden" name="revised" id="revised" value="no" />
                    <input type="hidden" name="formId" id="formId" value="1" />
                    <input type="hidden" name="eidSampleId" id="eidSampleId"
                        value="<?php echo ($eidInfo['eid_id']); ?>" />
