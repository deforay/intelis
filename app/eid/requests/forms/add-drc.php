						...
						<div class="box box-default">
							<div class="box-body">
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
										...
										<?php } else { ?>
											...
											<td>
												<input type="text" class="form-control isRequired" id="sampleCode"
													...
													title="<?= _translate("Please enter the Sample ID", true); ?>"
									...
									<tr>
										<td><label for="province">Province <span class="mandatory">*</span> </label>
										</td>
										<td>
										...
										<td><label for="district">Zone de Santé <span class="mandatory">*</span>
											</label>
										</td>
										<td>
									...
									<tr>
										<td><label for="facilityId">POINT DE COLLECT<span class="mandatory">*</span>
											</label></td>
										<td>
										...
										<td>
											<input type="email" class="form-control isEmail" id="email" name="email"
												placeholder="Adresse Email" title="Please enter Adresse Email"
												style="width:100%;" />
										</td>
									</tr>
									<tr>
										...
										<td>
											<input type="text" class="form-control date" id="testRequestDate"
												name="testRequestDate" placeholder="Date de la demande"
												title="Please enter Date de la demande" style="width:100%;" />
										</td>
										<td><label for="supportPartner">Partnaire d'appui <span
									...
									<tr>
										<td><label for="fundingSource">Source de Financement<span
													class="mandatory">*</span></label></td>
										<td>
											<select class="form-control select2 isREquired" name="fundingSource"
										...
										<td><label for="clinicianName">Demandeur<span class="mandatory">*</span>
											</label></td>
										<td>
											<input type="text" class="form-control isRequired" id="clinicianName"
									...
									<tr>
										<td><label for="reqClinicianPhoneNumber">Demander le numéro de téléphone du
												clinicien <span class="mandatory">*</span></label></td>
										<td>
											<input type="text" class="form-control phone-number isRequired"
												id="reqClinicianPhoneNumber" name="reqClinicianPhoneNumber"
												placeholder="Téléphone" title="Veuillez entrer le téléphone" value=""
												style="width:100%;" />
										</td>
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										<th scope="row" style="width:15%;"><label for="mothersId">Code (si applicable)
												<span class="mandatory">*</span></label></th>
										<td style="width:35%;">
											<input type="text" class="form-control isRequired" id="mothersId"
												name="mothersId" placeholder="Code du mère"
												title="Please enter code du mère" style="width:100%;" onchange="" />
										</td>
										<th scope="row" style="width:15%;"><label for="mothersName">Nom <span
													class="mandatory">*</span></label></th>
										<td style="width:35%;">
											<input type="text" class="form-control isRequired" id="mothersName"
												name="mothersName" placeholder="Nom du mère"
												title="Please enter nom du mère" style="width:100%;" onchange="" />
										</td>
									</tr>
									<tr>
										<th scope="row"><label for="mothersDob">Date de naissance <span
													class="mandatory">*</span></label></th>
										<td>
											<input type="text" class="form-control date isRequired" id="mothersDob"
												name="mothersDob" placeholder="Date de naissance"
												title="Please enter Date de naissance" style="width:100%;"
												onchange="" />
										</td>
										<th scope="row"><label for="mothersMaritalStatus">Etat civil <span
													class="mandatory">*</span></label></th>
										<td>
											<select class="form-control isRequired" name="mothersMaritalStatus"
									...
									<tr>
										...
										<th scope="row"><label for="childName">Nom<span class="mandatory">*</span>
											</label></th>
										<td>
											<input type="text" class="form-control isRequired" id="childName"
												name="childName" placeholder="Nom" title="Please enter nom"
									...
									<tr>
										...
										<td>
											<input type="text" class="form-control isMobile" id="phone" name="phone"
									...
									<tr>
										...
										<td><input type="number" class="form-control " id="childAgeInDays"
												name="childAgeInDays" placeholder="Age en Jour" title="Age en Jour"
												style="width:100%;" /></td>
									</tr>
									<tr>
										...
										<td><input type="number" maxlength="3"
												...
												title="<?php echo _translate("Age in years"); ?>" style="width:100%;"
												onchange="$('#childDob').val('')" /></td>
										<th scope="row">Age en semaines</th>
										<td><input type="number" maxlength="5"
												oninput="this.value=this.value.slice(0,$(this).attr('maxlength'))"
												class="form-control " id="childAgeInWeeks" name="childAgeInWeeks"
												placeholder="<?php echo _translate("Age in weeks"); ?>"
												title="<?php echo _translate("Age in weeks"); ?>" style="width:100%;" />
										</td>
									</tr>
								</table>
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										<th scope="row" colspan=2>ARV donnés à la maman pendant la grossesse:<span
												class="mandatory">*</span></th>
										<td colspan=4>
											<input type="checkbox" class="isRequired" name="motherTreatment[]"
												value="Nothing" /> Rien
											&nbsp;&nbsp;&nbsp;&nbsp;
											<input type="checkbox" class="isRequired" name="motherTreatment[]"
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										...
										<td>
											<input type="checkbox" class="isRequired" name="childTreatment[]"
												value="Nothing" />&nbsp;Rien
											&nbsp; &nbsp;&nbsp;&nbsp;
											<input type="checkbox" class="isRequired" name="childTreatment[]"
												value="AZT" />&nbsp;AZT
										...
										<th scope="row"><label for="isInfantReceivingTratment">Bébé reçoit-il le
												traitement?</label></th>
										<td>
											<select class="form-control" id="isInfantReceivingTratment"
												name="isInfantReceivingTratment"
												title="Please select bébé reçoit-il le traitement" style="width:100%;"
												onchange="[...document.getElementsByClassName('specific-infant-treatment')].forEach(el => el.style.display = this.value === 'Oui' ? '' : 'none');">
									...
									<tr>
										<th class="specific-infant-treatment" style="display: none;" scope="row"><label
												for="specificInfantTreatment">Si Oui à préciser</label></th>
										<td class="specific-infant-treatment" style="display: none;">
											<select class="form-control" name="specificInfantTreatment"
												id="specificInfantTreatment" title="Please select the si oui à préciser"
												onchange="document.getElementById('specificInfantTreatmentOther').style.display = this.value === 'Autres' ? '' : 'none';">
												<option value="">-- Raison de la PCR (cocher une) --</option>
												<option value="1st test pour bébé exposé (4 à 6 semaines)">1st test pour
													bébé exposé (4 à 6 semaines)</option>
												<option value="1st test pour bébé exposé (plus de 6 semaines)">1st test
													pour bébé exposé (plus de 6 semaines)</option>
												<option value="Test à 9 mois">Test à 9 mois</option>
												<option value="Test à plus de 9 mois">Test à plus de 9 mois</option>
												<option value="1st test pour bébé malade">1st test pour bébé malade
												</option>
												<option value="Répéter car problème avec 1er test">Répéter car problème
													avec 1er test</option>
												<option value="Répéter pour confirmer 1er résultat">Répéter pour
													confirmer 1er résultat</option>
												<option value="Répéter test après arrêt allaitement">Répéter test après
													arrêt allaitement</option>
												<option value="maternel (6 semaines au moins après arrêt allaitement)">
													maternel (6 semaines au moins après arrêt allaitement)</option>
												<option value="Autres">Autres (à préciser)</option>
											</select>
											<input type="text" placeholder="Veuillez préciser si autre"
												title="Veuillez préciser si autre" id="specificInfantTreatmentOther"
												name="specificInfantTreatmentOther" class="form-control"
												style="display: none;" />
										</td>
										<th scope="row">Bébé a arrêté allaitement maternel ? <span
												class="mandatory">*</span></th>
										<td>
									...
									<tr>
										<th scope="row"><label for="ageBreastfeedingStopped">Age (mois) arrêt
												allaitement : <span class="mandatory"
													style="display:none;">*</span></label></th>
										<td>
											<input type="number" class="form-control"
							  ...
							  <td>
								  <select class="form-control" name="isInfantStillBeingBreastfed" id="isInfantStillBeingBreastfed">
									...
									<option value="unknown" /> Inconnu </option>
										...
										<th scope="row"><label for="choiceOfFeeding">Choix d’allaitement de bébé : <span
													class="mandatory" style="display:none;">*</span></label></th>
										<td>
									...
									<tr>
										<th scope="row">Cotrimoxazole donné au bébé? <span class="mandatory">*</span>
										</th>
										<td>
								...
								<table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
									...
									<tr>
										<th scope="row" style="width:15%;">Date de collecte <span
												class="mandatory">*</span> </th>
										<td style="width:35%;">
										...
										<td>
											<select name="specimenType" id="specimenType"
												...
												<?php foreach ($sampleResult as $name) { ?>
													<option value="<?php echo $name['sample_id']; ?>">
														<?= $name['sample_name']; ?>
													</option>
												<?php } ?>
											</select>
									...
									<tr>
										<th scope="row">Raison de la PCR (cocher une): <span class="mandatory">*</span>
										</th>
										<td>
											<select class="form-control isRequired" name="pcrTestReason"
												id="pcrTestReason">
												<option value=''> <?= _translate("-- Select --"); ?> </option>
										...
										<tr>
											...
											<td style="width:35%;">
												<input type="text" class="form-control dateTime" id="sampleReceivedDate"
													...
													title="Please enter date de réception de léchantillon"
													style="width:100%;" />
											</td>
										<tr>
										...
										<tr class="rejected" style="display: none;">
											...
											<td>
												<select name="sampleRejectionReason" id="sampleRejectionReason"
													...
													title="Please choose a Rejection Reason">
													<option value=""><?= _translate("-- Select --"); ?> </option>
