                        ...
                        <div class="box box-default">
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        <th scope="row" style="width:15% !important"><label for="childId">CRVS file name
                                    ...
                                    <tr>
                                        <th scope="row"><label for="childDob">Date of Birth <span
                                                    class="mandatory">*</span> </label></th>
                                        <td>
                                            <input type="text" class="form-control isRequired date" id="childDob"
                                ...
                                <br><br>
                                <div class="box-header with-border">
                                    <h3 class="box-title"><?= _translate("Infant and Mother's Health Information"); ?></h3>
                                    &nbsp;&nbsp;&nbsp;
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        <th scope="row" style="width:16% !important">Mother's HIV Status: <span
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control isRequired" name="rapidTestPerformed"
                                                ...
                                                onchange="setrapidTestRelatedField(this.value);">
                                                <option value=''> -- Select -- </option>
                                        ...
                                        <td>
                                            <select class="form-control" name="rapidTestResult" id="rapidTestResult">
                                                ...
                                                <?php foreach ($eidResults as $eidResultKey => $eidResultValue) { ?>
                                                    <option value="<?php echo strtolower($eidResultKey); ?>" <?php echo ($eidInfo['rapid_test_result'] == strtolower($eidResultKey)) ? "selected='selected'" : ""; ?>> <?php echo $eidResultValue; ?>
                                                    </option>
                                                <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control isRequired" name="pcrTestPerformedBefore"
                                                title="Please select if Previous PCR Test was done"
                                                id="pcrTestPerformedBefore" onchange="setRelatedField(this.value)">
                                                <option value=''> -- Select -- </option>
