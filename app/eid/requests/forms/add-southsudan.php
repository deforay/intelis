                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <td>
                                                <input type="text" class="form-control isRequired" id="sampleCode"
                                                    name="sampleCode" placeholder="Sample ID"
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="text" class="form-control" id="clinicianName"
                                                ...
                                                title="Please enter request clinician" /></td>
                                    </tr>
                                </table>
                                <br>
                                            ...
                                            <select class="form-control" name="rapidTestResult" id="rapidTestResult">
                                                ...
                                                <?php foreach ($eidResults as $eidResultKey => $eidResultValue) { ?>
                                                    <option value="<?php echo $eidResultKey; ?>">
                                                        <?php echo $eidResultValue; ?> </option>
                                                <?php } ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="pcrTestReason" id="pcrTestReason"
                                                ...
                                                <option
                                                    value="Follow-up at 9 months for negative first EID PCR results">
