                            ...
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="row" class="labels"><label
                                                for="childGender"><?= _translate("Sex"); ?> <span
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="reasonForRepeatPcrOther"
                                                ...
                                                value="<?= htmlspecialchars((string) $eidInfo['reason_for_repeat_pcr_other']); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35% !important;">
                                            <input class="form-control dateTime isRequired" type="text"
                                                ...
                                                value="<?= $eidInfo['sample_collection_date']; ?>"
                                        ...
                                        <td style="width:35% !important;">
                                            <input class="form-control dateTime isRequired" type="text"
                                                ...
                                                value="<?= $eidInfo['sample_dispatched_datetime']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <th scope="row" style="width:15% !important" class="labels">Location Of Sample
                                            Collection</th>
                                        <td style="width:35% !important;">
                                            <select name="locationOfSampleCollection" id="locationOfSampleCollection"
                                                class="form-control" title="Please choose location of sample collection"
                                                style="width:100%">
                                                <option value=""> -- Select -- </option>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:25%;">
                                                <input type="text"
                                                    ...
                                                    placeholder="<?= _translate("Please enter date"); ?>" <?php echo $labFieldDisabled; ?> style="width:100%;"
