                            ...
                            <div class="box-body">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <td>
                                                <input type="text" readonly value="<?php echo $eidInfo[$sampleCode]; ?>"
                                                    ...
                                                    placeholder="<?= _translate('Sample ID'); ?>"
                                    ...
                                    <tr>
                                        <td style="width:25%"><label for="province"><?= _translate('Region'); ?>
                                            ...
                                            <select class="form-control isRequired" name="province" id="province"
                                                title="Please select province" onchange="getfacilityDetails(this);"
                                                style="width:100%;">
                                                <?php echo $province; ?>
                                            </select>
                                        </td>
                                        ...
                                        <td style="width:25%"><label for="facilityId"><?= _translate('Facility'); ?>
                                            </label><span class="mandatory">*</span><br>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35% !important">
                                            <input type="text" class="form-control isRequired patientId" id="childId"
                                                ...
                                                style="width:100%;" value="<?php echo $eidInfo['child_id']; ?>"
                                                onchange="" />
                                        </td>
                                        <th scope="row" style="width:15% !important"><label
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control date" id="childDob" name="childDob"
                                                ...
                                                onchange="calculateAgeInMonths();" <?php if ($ageInfo === "ageUnreported") {
                                                    echo "readonly";
                                                } ?> />
                                            <input type="checkbox" name="ageUnreported" id="ageUnreported"
                                                onclick="updateAgeInfo();" <?php if ($ageInfo === "ageUnreported") {
                                        ...
                                        <td><input type="number" max=24 maxlength="2"
                                                ...
                                                title="<?= _translate('Age'); ?>" style="width:100%;" onchange=""
                                                value="<?= htmlspecialchars((string) $eidInfo['child_age']); ?>" <?php if ($ageInfo === "ageUnreported") {
                                                       echo "readonly";
                                                   } ?> /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control isRequired" name="childGender" id="childGender">
                                                ...
                                                <option value='female' <?php echo ($eidInfo['child_gender'] == 'female') ? "selected='selected'" : ""; ?>> <?= _translate('Female'); ?>
                                                </option>
                                        ...
                                        <td><input type="text" name="healthInsuranceCode" id="healthInsuranceCode"
                                                class="form-control" value="<?= $eidInfo['health_insurance_code']; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" class="form-control forceNumeric" id="childWeight"
                                                ...
                                                title="<?= _translate('Infant weight of the day'); ?>"
                                                style="width:100%;" value="<?= $eidInfo['child_weight']; ?>" /></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea class="form-control " id="caretakerAddress"
                                                ...
                                                title="<?= _translate('Caretaker Address'); ?>" style="width:100%;"
                                        ...
                                        <td>
                                            <select class="form-control isRequired" name="childProphylacticArv"
                                                ...
                                                <option value=''> <?= _translate('-- Select --'); ?> </option>
                                                <option value='nothing' <?php echo ($eidInfo['child_prophylactic_arv'] == 'nothing') ? "selected='selected'" : ""; ?>> <?= _translate('Nothing'); ?>
                                                </option>
                                                ...
                                                <option value='other' <?php echo ($eidInfo['child_prophylactic_arv'] == 'other') ? "selected='selected'" : ""; ?>> <?= _translate('Other'); ?>
                                                </option>
                                            </select>
                                            <input type="text" name="childProphylacticArvOther"
                                                id="childProphylacticArvOther"
                                                value="<?php echo ($eidInfo['child_prophylactic_arv_other']); ?>"
                                                class="form-control"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control date"
                                                ...
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['child_treatment_initiation_date']); ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control forceNumeric" type="text"
                                                ...
                                                value="<?php echo ($eidInfo['no_of_infected_children']); ?>"
                                                id="noOfInfectedChildren"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control date"
                                                ...
                                                placeholder="<?= _translate('Enter date of initiation'); ?>"
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['mother_treatment_initiation_date']); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" class="form-control date" name="motherHivTestDate"
                                                ...
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['mother_hiv_test_date']); ?>" />
                                        </td>
                                    </tr>
                                </table>
                                <br>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:30% !important">
                                            <select class="form-control isRequired" name="isChildSymptomatic"
                                                ...
                                                <option value=''> <?= _translate('-- Select --'); ?> </option>
                                                <option value="yes" <?php echo ($eidInfo['is_child_symptomatic'] == 'yes') ? "selected='selected'" : ""; ?>> <?= _translate('Yes'); ?>
                                                </option>
                                        ...
                                        <td style="width:30% !important">
                                            <input type="text" class="form-control date" name="dateOfWeaning"
                                                ...
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['date_of_weaning']); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" style="width:16% !important">
                                        ...
                                        <td style="width:30% !important">
                                            <select class="form-control" name="wasChildBreastfed"
                                                ...
                                                <option value=''> <?= _translate('-- Select --'); ?> </option>
                                                <option value="yes" <?php echo ($eidInfo['was_child_breastfed'] == 'yes') ? "selected='selected'" : ""; ?>> <?= _translate('Yes'); ?>
                                                </option>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:30% !important">
                                            <input type="text" class="form-control date" name="childStartedCotrimDate"
                                                ...
                                                placeholder="<?= _translate('Enter date of Initiation'); ?>"
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['child_started_cotrim_date']); ?>" />
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:30% !important">
                                            <input type="text" class="form-control date" name="childStartedArtDate"
                                                ...
                                                title="<?= _translate('Enter date of Initiation'); ?>"
                                                placeholder="<?= _translate('Enter date of Initiation'); ?>"
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['child_started_art_date']); ?>" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="hasInfantStoppedBreastfeeding"
                                                ...
                                                <option value="unknown" <?php echo ($eidInfo['has_infant_stopped_breastfeeding'] == 'unknown') ? "selected='selected'" : ""; ?>> <?= _translate('Unknown'); ?>
                                                </option>
                                            </select>
                                        </td>
                                        ...
                                        <td>
                                            <input type="number" class="form-control"
                                                ...
                                                type="text" name="ageBreastfeedingStopped" id="ageBreastfeedingStopped"
                                    ...
                                    <tr>
                                        ...
                                        <td><select class="form-control editableSelectClinician" id="clinicianName"
                                                name="clinicianName"
                                                title="<?= _translate('Please enter request clinician'); ?>"
                                                value="<?php echo $eidInfo['clinician_name']; ?>">
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="2" style="text-align:center;">
                                            ...
                                            <input <?php echo ($eidInfo['serological_test'] == 'negative') ? "checked='checked'" : ""; ?> type="radio" class="form-check"
                                                name="serologicalTest" id="serologicalTest"
                                                value="negative" />&nbsp;&nbsp;<label
                                                for="negative"><?= _translate('Negative'); ?>&nbsp;&nbsp;&nbsp;
                                                <input <?php echo ($eidInfo['serological_test'] == 'notdone') ? "checked='checked'" : ""; ?> type="radio" class="form-check"
                                                    name="serologicalTest" id="serologicalTest"
                                                    value="notdone" />&nbsp;&nbsp;<label
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['pcr_1_test_date']); ?>"
                                                class="form-control date" type="text" name="pcr1TestDate"
                                                id="pcr1TestDate" placeholder="<?= _translate('Test date'); ?>" /><br>
                                            <input
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['pcr_2_test_date']); ?>"
                                                class="form-control date" type="text" name="pcr2TestDate"
                                                id="pcr2TestDate" placeholder="<?= _translate('Test date'); ?>" /><br>
                                            <input
                                                value="<?php echo DateUtility::humanReadableDateFormat($eidInfo['pcr_3_test_date']); ?>"
                                                class="form-control date" type="text" name="pcr3TestDate"
                                                id="pcr3TestDate" placeholder="<?= _translate('Test date'); ?>" />
                                        </td>
                                        <td>
                                            <?= _translate('Results'); ?><br><br>
                                            <input value="<?php echo ($eidInfo['pcr_1_test_result']); ?>" type="text"
                                                class="form-control input-sm" name="pcr1TestResult"
                                                id="pcr1TestResult" /><br>
                                            <input value="<?php echo ($eidInfo['pcr_2_test_result']); ?>" type="text"
                                                class="form-control input-sm" name="pcr2TestResult"
                                                id="pcr1TestResult" /><br>
                                            <input value="<?php echo ($eidInfo['pcr_3_test_result']); ?>" type="text"
                                                class="form-control input-sm" name="pcr3TestResult"
                                                id="pcr1TestResult" /><br>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control" name="sampleCollectionReason"
                                                ...
                                                <option value=''> <?= _translate('-- Select --'); ?> </option>
                                                <option value="1st Test for well child born of HIV+ mother" <?php echo ($eidInfo['sample_collection_reason'] == '1st Test for well child born of HIV+ mother') ? "selected='selected'" : ""; ?>>
                                                ...
                                                <option value="Repeat Testing due to loss of 1st sample" <?php echo ($eidInfo['sample_collection_reason'] == 'Repeat Testing due to loss of 1st sample') ? "selected='selected'" : ""; ?>>
                                                    <?= _translate('Repeat Testing due to loss of 1st sample'); ?>
                                                </option>
                                                <option
                                                    value="Repeat due to clinical suspicion following negative 1st test"
                                                    <?php echo ($eidInfo['sample_collection_reason'] == 'Repeat due to clinical suspicion following negative 1st test') ? "selected='selected'" : ""; ?>>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="labTestingPointOther" id="labTestingPointOther"
                                                ...
                                                style="display:<?php echo ($eidInfo['lab_testing_point'] == 'other') ? 'none' : '' ?>;"
                                    ...
                                    <?php if ($general->isLISInstance()) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" class="form-control" id="labAssignedCode"
                                                    name="labAssignedCode"
                                                    placeholder="<?= _translate("Enter Lab Assigned Code"); ?>"
                                                    title="Enter Lab Assigned Code" <?php echo $labFieldDisabled; ?>
                                                    value="<?php echo $eidInfo['lab_assigned_code']; ?>" onchange=""
                                                    style="width:100%;"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="form-control" type="text" name="sampleRequestorName"
                                                ...
                                                value="<?= $eidInfo['sample_requestor_name'] ?>" />
                                        </td>
                                        ...
                                        <?php if ($general->isLISInstance()) { ?>
                                            ...
                                            <td>
                                                <input type="text" class="form-control dateTime" id="sampleReceivedDate"
                                                    ...
                                                    value="<?php echo $eidInfo['sample_received_at_lab_datetime']; ?>"
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        <tr>
                                            ...
                                            <td>
                                                <input name="eidNumber" id="eidNumber" class="form-control"
                                                    ...
                                                    value="<?php echo $eidInfo['eid_number']; ?>">
                                            </td>
                                            <th><?= _translate('Testing Platform'); ?> </th>
                                            <td>
                                                <select class="form-control result-optional" name="eidPlatform"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:25%;">
                                                <input type="text" class="form-control dateTime" id="sampleTestedDateTime"
                                                    ...
                                                    value="<?php echo $eidInfo['sample_tested_datetime']; ?>"
                                                    style="width:100%;" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text"
                                                    ...
                                                    title="Please enter the Reviewed on" /></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text"
                                                    ...
                                                    name="approvedOnDateTime" id="approvedOnDateTime"
                                                    class="dateTime disabled-field form-control"
                                                    placeholder="<?= _translate('Approved on'); ?>"
                                                    title="Please enter the approved on date" /></td>
                                        ...
                                        <tr class="change-reason">
                                            <th scope="row" class="change-reason" style="display: none;">
                                                <?= _translate('Reason for Changing'); ?> <span class="mandatory">*</span>
                                            </th>
                                            <td class="change-reason" style="display: none;"><textarea
                                                    name="reasonForChanging" id="reasonForChanging" class="form-control"
                                                    placeholder="<?= _translate('Enter the reason for changing'); ?>"
                                                    title="<?= _translate('Please enter the reason for changing'); ?>"></textarea>
                                            </td>
                                            <th scope="row"></th>
                                            <td></td>
                                        </tr>
