        ...
        <div class="box box-default">
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" method='post' name='editSampleForm' id='editSampleForm' autocomplete="off"
                    enctype="multipart/form-data" action="save-vl-sample-type-helper.php">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control isRequired" id="sampleName"
                                            ...
                                            onblur="checkNameValidation('r_vl_sample_type','sample_name',this,'<?php echo "sample_id##" . $id; ?>','The sample name that you entered already exists.Enter another name',null)" />
