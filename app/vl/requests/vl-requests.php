		...
		<div class="row">
			<div class="col-xs-12">
				...
				<div class="box filter-panel filter-panel-collapsed">
					<table aria-describedby="table" id="advancedFilters" class="table pageFilters filter-panel-body" aria-hidden="true"
					...
					<div class="filter-actions">
						...
						<?php if (_isAllowed("/vl/requests/addVlRequest.php") && !$hidesrcofreq) { ?>
							<a href="/vl/requests/addVlRequest.php" class="filter-keep btn btn-primary btn-sm pull-right">
								<em class="fa-solid fa-plus"></em> <?= _htmlTranslate("Add VL Request Form"); ?>
							</a>
						<?php } ?>
						<?php if (_isAllowed("/vl/requests/vl-requests.php") && $formId == COUNTRY\DRC) { ?>
							<a href="/vl/requests/sample-storage.php" class="filter-keep btn btn-primary btn-sm pull-right">
								<em class="fa-solid fa-jar"></em> <?= _htmlTranslate("Samples Storage"); ?>
							</a>
						<?php } ?>
