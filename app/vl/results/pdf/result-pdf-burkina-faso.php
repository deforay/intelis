...
if (!empty($result)) {
     ...
     $html .= '<td style="line-height:10px;font-size:10px;text-align:left;">' . ucwords((string) $patientFname) . '</td>';
     ...
     // $html .= '</tr>';
     $html .= '<tr>';
     $html .= '<td colspan="3" style="line-height:15px;font-size:11px;font-weight:bold;">' . _translate("TEST PLATFORM") . ' &nbsp;&nbsp;:&nbsp;&nbsp; <span style="font-weight:normal;">' . (($result['instrument_machine_name'] ?? $result['vl_test_platform'] ?? '')) . '</span></td>';
     $html .= '</tr>';
     // $html .= '<tr>';
