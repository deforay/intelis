...
if (!empty($result)) {
     ...
     $html .= '<td width="50%" style="line-height:18px;font-size:10px;text-align:left; border: 1px solid black;">&nbsp;' . ($result['instrument_machine_name'] ?? $result['vl_test_platform'] ?? '') . '</td>';
