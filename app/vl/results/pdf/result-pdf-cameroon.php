...
if (!empty($result)) {
    ...
    if (str_contains(strtolower((string) $instrumentMachineName), 'm2000')) {
     ...
     $html .= '<tr>';
     $html .= '<td colspan="3" style="line-height:13px;font-size:10px;font-weight:bold;">' . _translate("TEST PLATFORM") . ' &nbsp;&nbsp;:&nbsp;&nbsp; <span style="font-weight:normal;">' . $instrumentMachineName . '</span></td>';
     $html .= '</tr>';
     ...
     if ($result['result'] != '' || (empty($result['result']) && $result['result_status'] == REJECTED)) {
