                  ...
                  <div class="col-lg-12" style="text-align:center !important;">
                     <table aria-describedby="table" class="table table-bordered table-striped" aria-hidden="true"
                        ...
                        <tbody>
                           ...
                           for ($s = 0; $s < $counter; $s++) {
                              $sampleQuery = "SELECT vl_sample_id,sample_code FROM form_vl as vl LEFT JOIN facility_details as f ON vl.facility_id=f.facility_id where vl.vl_sample_id = '" . $db->escape((string) $selectedSamplesArray[$s]) . "' AND vl.result IS NOT NULL AND vl.result!= '' ORDER BY f.facility_name ASC";
