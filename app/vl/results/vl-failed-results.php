            ...
            <div class="col-xs-12">
                <div class="box">
                    <table aria-describedby="table" id="advanceFilter" class="table" aria-hidden="true"
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="status[]" id="status" multiple="multiple"
                                    title="<?php echo _translate('Please choose Sample Status'); ?>">
                                    <option value="<?= SAMPLE_STATUS\TEST_FAILED; ?>" selected="selected">
                                        <?php echo _translate("Failed"); ?></option>
                                    <option value="<?= SAMPLE_STATUS\ON_HOLD; ?>" selected="selected">
                                        <?php echo _translate("Hold"); ?></option>
                                    <option value="<?= SAMPLE_STATUS\LOST_OR_MISSING; ?>">
                                        <?php echo _translate("Lost"); ?></option>
                        ...
                        <tr>
                            <td colspan="2"><input class="btn btn-primary btn-sm" type="button"
                                    onclick="searchVlRequestData();" value="<?= _translate('Search'); ?>">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-3">
                                    <input type="checkbox" onclick="fnShowHide(this.value);" value="0" id="iCol0"
                                        ...
                                        for="iCol0"><?php echo _translate("Sample ID"); ?></label>
                                </div>
                                <?php $i = 0;
                    ...
                    <div class="box-body">
                        ...
                        <table aria-describedby="table" id="vlFailedResultDataTable"
                        ...
                        if (isset($global['bar_code_printing']) && $global['bar_code_printing'] == 'zebra-printer') {
                            ...
                            <div id="printer_details" style="display:none">
                                ...
                                <button type="button" class="btn btn-success"
                                    onclick="changePrinter()"><?php echo _translate("Change/Retry"); ?></button>
