                            ...
                            <div class="widget-content">
                                <div class="bs bs-tabs">
                                    <ul id="myTab" class="nav nav-tabs" style="font-size:1.4em;">
                                        <li class="active"><a href="#notPrintedData"
                                                data-toggle="tab"><?php echo _translate("Results not yet Printed"); ?>
                                            </a></li>
                                        <li><a href="#printedData" data-toggle="tab"
                                                class="printedData"><?php echo _translate("Results already Printed"); ?>
                                            </a></li>
                                    </ul>
                                    <div id="myTabContent" class="tab-content">
                                        <div class="tab-pane fade in active" id="notPrintedData">
                                            <table aria-describedby="table" class="table" aria-hidden="true"
                                                ...
                                                <tr>
                                                    <td><strong><?php echo _translate("Sample Collection Date"); ?>&nbsp;:</strong>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><strong><?php echo _translate("Province/State"); ?>&nbsp;:</strong>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><strong><?php echo _translate("District/County"); ?> :</strong>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><strong><?php echo _translate("Sample Test Date"); ?>&nbsp;:</strong>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="text" id="sampleReceivedDate"
                                                            name="sampleReceivedDate" class="form-control"
                                                            placeholder="<?php echo _translate('Select Sample Received Date'); ?>"
                                                            readonly style="background:#fff;" />
                                                    </td>
                                                    <td><strong><?php echo _translate("Facility Name"); ?> :</strong>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><strong><?php echo _translate("Testing Labs"); ?> :</strong>
                                                    </td>
                                                    <td>
                                                        <select class="form-control" id="labId" name="labId"
                                                            title="<?php echo _translate('Please select testing labs'); ?>"
                                                            multiple="multiple">
                                                            <?= $labsDropdown; ?>
                                                        </select>
                                                    </td>
                                                    <td><strong><?php echo _translate("Patient ID"); ?>&nbsp;:</strong>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td><strong><?php echo _translate("Patient Name"); ?>&nbsp;:</strong>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td colspan="6">&nbsp;<input type="button"
                                                            ...
                                                            value="<?php echo _translate("Search"); ?>"
                                                            class="btn btn-success btn-sm">
                                                        &nbsp;<button class="btn btn-danger btn-sm"
                                                            onclick="document.location.href = document.location"><span><?= _translate('Reset'); ?></span></button>
                                                        &nbsp;<button class="btn btn-primary btn-sm"
                                                            onclick="$('#showhide').fadeToggle();return false;"><span><?php echo _translate("Manage Columns"); ?></span></button>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                ...
                                                                for="iCol1"><?php echo _translate("Sample ID"); ?></label>
                                                        </div>
                                                        <?php $i = 1;
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                                                id="iCol<?php echo $i; ?>" data-showhide="batch_code"
                                                                class="showhideCheckBox" /> <label
                                                        ...
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                ...
                                                                class="showhideCheckBox" /> <label
                                                                for="iCol<?php echo $i; ?>"><?php echo _translate("Testing Labs"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                                                ...
                                                                class="showhideCheckBox" /> <label
                                                                for="iCol<?php echo $i; ?>"><?php echo _translate("Province/State"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                                                ...
                                                                class="showhideCheckBox" /> <label
                                                                for="iCol<?php echo $i; ?>"><?php echo _translate("District/County"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                                                id="iCol<?php echo $i; ?>" data-showhide="hcv_vl_count"
                                                                class="showhideCheckBox" /> <label
                                                                for="iCol<?php echo $i; ?>"><?php echo _translate("HCV VL Count"); ?></label>
                                                            <br>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                                                id="iCol<?php echo $i; ?>" data-showhide="hbv_vl_count"
                                                                class="showhideCheckBox" /> <label
                                                                for="iCol<?php echo $i; ?>"><?php echo _translate("HBV VL Count"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                                                ...
                                                                class="showhideCheckBox" /> <label
                                                                for="iCol<?php echo $i; ?>"><?php echo _translate("Last Modified On"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox" onclick="fnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                            ...
                                            <div id="notPrintedResult" style="display:none;">
                                                &nbsp;<button class="btn btn-primary btn-sm"
                                                    onclick="convertSearchResultToPdf('');"><span><em
                                                            class="fa-solid fa-print"></em>
                                                        <?php echo _translate("Print Selected Results PDF"); ?>
                                                    </span></button></div>

                                            <table aria-describedby="table" id="notPrintedTable"
                                        ...
                                        <div class="tab-pane fade" id="printedData">
                                            <table aria-describedby="table" class="table" aria-hidden="true"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="printSampleTestDate"
                                                            name="printSampleTestDate" class="form-control"
                                                            placeholder="<?php echo _translate('Select Sample Test Date'); ?>"
                                                            readonly style="background:#fff;" />
                                                    </td>
                                                    <td><strong>
                                                    ...
                                                    <td>
                                                        <input type="text" id="printSampleReceivedDate"
                                                            name="printSampleReceivedDate" class="form-control"
                                                            placeholder="<?php echo _translate('Select Sample Received Date'); ?>"
                                                            readonly style="background:#fff;" />
                                                    </td>
                                                    <td><strong><?php echo _translate("Facility Name"); ?> :</strong>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" id="printBatchCode" name="printBatchCode"
                                                            class="form-control autocomplete"
                                                            placeholder="<?php echo _translate('Enter Batch Code'); ?>"
                                                            style="background:#fff;" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="6">&nbsp;<input type="button"
                                                        ...
                                                        &nbsp;<button class="btn btn-danger btn-sm"
                                                            onclick="document.location.href = document.location"><span><?= _translate('Reset'); ?></span></button>
                                                        &nbsp;<button class="btn btn-primary btn-sm"
                                                            onclick="$('#printShowhide').fadeToggle();return false;"><span><?php echo _translate("Manage Columns"); ?></span></button>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                ...
                                                                for="printiCol1"><?php echo _translate("Sample ID"); ?></label>
                                                        </div>
                                                        <?php $i = 1;
                                                        if (!$general->isStandaloneInstance()) {
                                                            $i = 2; ?>
                                                            <div class="col-md-3">
                                                                <input type="checkbox"
                                                                    ...
                                                                    data-showhide="remote_sample_code"
                                                                    class="printShowhideCheckBox" /> <label
                                                                    for="printiCol<?php echo $i; ?>"><?php echo _translate("Remote Sample ID"); ?></label>
                                                            </div>
                                                        <?php } ?>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                ...
                                                                value="<?php echo $i += 1; ?>"
                                                                id="printiCol<?php echo $i; ?>"
                                                                data-showhide="batch_code"
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Batch Code"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                ...
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Patient ID"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                ...
                                                                data-showhide="patient_first_name"
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Patient's Name"); ?></label>
                                                            <br>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                ...
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Facility Name"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                ...
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Testing Labs"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                ...
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Province/State"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                ...
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("District/County"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                value="<?php echo $i += 1; ?>"
                                                                id="printiCol<?php echo $i; ?>"
                                                                data-showhide="hcv_vl_count"
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("HCV VL Count"); ?></label>
                                                            <br>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                ...
                                                                value="<?php echo $i += 1; ?>"
                                                                id="printiCol<?php echo $i; ?>"
                                                                data-showhide="hbv_vl_count"
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("HBV VL Count"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                ...
                                                                data-showhide="last_modified_datetime"
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Last Modified On"); ?></label>
                                                        </div>
                                                        <div class="col-md-3">
                                                            <input type="checkbox"
                                                                onclick="printfnShowHide(this.value);"
                                                                ...
                                                                class="printShowhideCheckBox" /> <label
                                                                for="printiCol<?php echo $i; ?>"><?php echo _translate("Status"); ?></label>
                                                        </div>
                                            ...
                                            <div id="printedResult" style="display:none;">
                                                &nbsp;<button class="btn btn-primary btn-sm"
                                                    onclick="convertSearchResultToPdf('','printData');"><em
                                                        class="fa-solid fa-print"></em><span>
                                                        <?php echo _translate("Print selected Results PDF"); ?>
                                                    </span></button></div>
                                            <table aria-describedby="table" id="alreadyPrintedTable"
                                                class="table table-bordered table-striped" aria-hidden="true">
                                                <thead>
                                                    <tr>
