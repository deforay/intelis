...
$aResultFilterTotal = $db->rawQuery("SELECT * FROM r_hepatitis_results $sWhere");
...
foreach ($rResult as $aRow) {
    ...
    $row = [];
    $row[] = ($aRow['result']);
    $row[] = _isAllowed("hepatitis-sample-type.php") && $general->isLISInstance() === false ? $status : $aRow['status'];
    $output['aaData'][] = $row;
}
