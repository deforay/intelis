...
$title = _translate("Hepatitis | Clinic Reports");
						...
						<div class="widget">
							<div class="widget-content">
								<div class="bs bs-tabs">
									<?php $crTestType = 'hepatitis'; require APPLICATION_PATH . '/reports/_clinic-report-tabs.php'; ?>
									<div id="myTabContent" class="tab-content">
										...
										<div class="tab-pane fade" id="dataQualityReport">
											<?php $dqTestType = 'hepatitis'; require APPLICATION_PATH . '/reports/_data-quality-tab.php'; ?>
										</div>
