			...
			<div class="col-xs-12">
				<div class="box filter-panel filter-panel-collapsed" id="filterDiv">
					...
					<div class="filter-actions">
						...
						<button class="filter-export btn btn-success" type="button" onclick="exportInexcel('generate-export-data.php')"><em class="fa-solid fa-cloud-arrow-down"></em>
							<?= _htmlTranslate("Download"); ?>
						</button>
						<button type="button" class="filter-keep btn btn-default pull-right" onclick="$('#showhide').fadeToggle();return false;"><span>
					...
					<span style="display: none;position:absolute;z-index: 9999 !important;color:#000;padding:5px;" id="showhide" class="">
						<div class="row" style="background:#e0e0e0;padding: 15px;margin-top: -25px;">
							<div class="col-md-12">
								...
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="<?php echo $i += 1; ?>" id="iCol<?php echo $i; ?>" data-showhide="hcv_vl_count" class="showhideCheckBox" /> <label for="iCol<?php echo $i; ?>"><?php echo _translate("HCV Results"); ?></label>
								</div>
								<div class="col-md-3">
									<input type="checkbox" onclick="fnShowHide(this.value);" value="<?php echo $i += 1; ?>" id="iCol<?php echo $i; ?>" data-showhide="hbv_vl_count" class="showhideCheckBox" /> <label for="iCol<?php echo $i; ?>"><?php echo _translate("HBV Result"); ?></label>
								</div>
								<div class="col-md-3">
