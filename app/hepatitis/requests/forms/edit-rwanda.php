...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="box box-default">
            ...
            <div class="box-body">
                <!-- form start -->
                <form class="form-horizontal" method="post" name="editHepatitisRequestForm"
                    id="editHepatitisRequestForm" autocomplete="off" action="hepatitis-edit-request-helper.php">
                    <div class="box-body">
                        <div class="box box-default">
                            <div class="box-body">
                                <div class="box-header with-border">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        <?php if ($general->isSTSInstance()) { ?>
                                            ...
                                            <td style="width:35%;">
                                                <span id="sampleCodeInText"
                                                    style="width:30%;border-bottom:1px solid #333;"><?php echo $hepatitisInfo[$sampleCode]; ?></span>
                                                <input type="hidden" class="<?php echo $sampleClass; ?>" id="sampleCode"
                                                    name="sampleCode" value="<?php echo $hepatitisInfo[$sampleCode]; ?>" />
                                            </td>

                                        <?php } else { ?>
                                            <th style="width:15%;"><label for="sampleCode">Sample ID </label><span
                                                    class="mandatory">*</span> </th>
                                            <td style="width:35%;">
                                                <input type="text" readonly
                                                    value="<?php echo $hepatitisInfo[$sampleCode]; ?>"
                                        ...
                                        <?php } ?>
                                        <th scope="row" style="width:15%"><label for="patientId">Patient Code <span
                                        ...
                                        <td style="width:35%;">
                                            <input type="text" class="form-control isRequired patientId" id="patientId"
                                                ...
                                                value="<?php echo $hepatitisInfo['patient_id']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="width:15%;"><label for="hepatitisTestType">Hepatitis Test Type
                                            </label><span class="mandatory">*</span></th>
                                        <td style="width:35%;">
                                            <select class="form-control isRequired" name="hepatitisTestType"
                                                id="hepatitisTestType" title="Please choose type hepatitis test"
                                                style="width:100%;" onchange="hepatitisTestTypeFn(this.value);">
                                        ...
                                        <th style="width:15%;"><label for="province">Province </label><span
                                                class="mandatory">*</span></th>
                                        <td style="width:35%;">
                                    ...
                                    <tr>
                                        <th style="width:15%;"><label for="district">District </label><span
                                                class="mandatory">*</span></th>
                                        <td style="width:35%;">
                                        ...
                                        <th style="width:15%;"><label for="facilityId">Health Facility </label><span
                                                class="mandatory">*</span></th>
                                        <td style="width:35%;">
                                    ...
                                    <tr>
                                        <th style="width:15%">Sample Collection Date <span class="mandatory">*</span>
                                        </th>
                                        <td style="width:35%;">
                                            <input value="<?php echo ($hepatitisInfo['sample_collection_date']); ?>"
                                                class="form-control isRequired" type="text" name="sampleCollectionDate"
                                        ...
                                        <td style="width:35%;">
                                            <input value="<?php echo ($hepatitisInfo['external_sample_code']); ?>"
                                                class="form-control" type="text" name="externalSampleCode"
                                                id="externalSampleCode" placeholder="DHIS2 Case ID" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <?php if ($general->isSTSInstance() && $_SESSION['accessType'] == 'collection-site') { ?>
                                            <th style="width:35%;"><label for="labId">Lab Name <span
                                                        class="mandatory">*</span></label> </th>
                                            <td style="width:35%;">
                                        ...
                                        <?php } ?>
                                        <th class="encryptPIIContainer" scope="row" style="width:15%"><label
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        ...
                                        <td style="width:35%">
                                            <input type="text" class="form-control isRequired" id="firstName"
                                                ...
                                                value="<?php echo $hepatitisInfo['patient_name']; ?>" />
                                        </td>
                                        ...
                                        <td style="width:35%">
                                            <input type="text" class="form-control " id="lastName" name="lastName"
                                                ...
                                                style="width:100%;"
                                                value="<?php echo $hepatitisInfo['patient_surname']; ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th style="width:15%" scope="row"><label for="patientPhoneNumber">Phone
                                                number</label></th>
                                        <td style="width:35%;"><input type="text" class="form-control phone-number"
                                                id="patientPhoneNumber" name="patientPhoneNumber"
                                                placeholder="Patient Phone Number" title="Patient Phone Number"
                                                style="width:100%;"
                                                value="<?php echo $hepatitisInfo['patient_phone_number']; ?>" /></td>

                                        <th style="width:15%" scope="row"><label for="dob">Date of Birth <span
                                                    class="mandatory">*</span> </label></th>
                                        <td style="width:35%;">
                                            <input type="text" class="form-control isRequired" id="dob" name="dob"
                                                ...
                                                value="<?php echo DateUtility::humanReadableDateFormat($hepatitisInfo['patient_dob']); ?>" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row" style="width:15%"><label for="patientAge">Patient Age
                                                (years)</label></th>
                                        <td style="width:35%;"><input type="number" max="150" maxlength="3"
                                                ...
                                                style="width:100%;"
                                                value="<?php echo $hepatitisInfo['patient_age']; ?>" /></td>
                                        <th scope="row" style="width:15%"><label for="patientGender">Sex <span
                                                    class="mandatory">*</span> </label></th>
                                        <td style="width:35%;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%;"><input type="text"
                                                value="<?php echo $hepatitisInfo['patient_province']; ?>"
                                        ...
                                        <td style="width:35%;"><input class="form-control"
                                                value="<?php echo $hepatitisInfo['patient_district']; ?>"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35%;"><input type="text" class="form-control"
                                                value="<?php echo $hepatitisInfo['patient_city']; ?>" id="patientCity"
                                                name="patientCity" placeholder="Patient Village"
                                                title="Please enter the patient village" style="width:100%;" /></td>

                                        <th scope="row" style="width:15%"><label for="patientGender">Insurance</label>
                                        </th>
                                        <td style="width:35%;">
                                            <select class="form-control" name="insurance" id="insurance"
                                                title="Please select the Insurance">
                                                <option value=''> -- Select -- </option>
                        ...
                        <div class="box-body">
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                <tr>
                                    ...
                                    <th style="width:15%;" scope="row" class="hbvFields"><label for="HBsAg">HBsAg
                                            Result</label></th>
                                    <td class="hbvFields" style="width:35%;">
                                        <select class="hbvFields form-control" name="HBsAg" id="HBsAg"
                                            title="Please choose HBsAg result">
                                            <option value=''> -- Select -- </option>
                                ...
                                <tr>
                                    <th style="width:15%;" scope="row" class="hcvFields"><label for="antiHcv">Anti-HCV
                                            Result</label></th>
                                    <td style="width:35%;" class="hcvFields">
                                        <select class="hcvFields form-control" name="antiHcv" id="antiHcv"
                                            title="Please choose Anti-HCV result">
                                            <option value=''> -- Select -- </option>
                                    ...
                                    <th style="width:15%;" scope="row"><label for="labTechnician">Lab Technician
                                        </label></th>
                                    <td style="width:35%;">
                        ...
                        <?php if (_isAllowed('/hepatitis/results/hepatitis-update-result.php') && $_SESSION['accessType'] != 'collection-site') { ?>
                            <div class="box box-primary">
                                <div class="box-body">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        <tr>
                                            <th style="width:15%;" scope="row"><label for="">Sample Received Date </label>
                                            </th>
                                            <td style="width:35%;">
                                                <input
                                                    value="<?php echo DateUtility::humanReadableDateFormat($hepatitisInfo['sample_received_at_lab_datetime']) ?>"
                                                    type="text" class="labSecInput form-control" id="sampleReceivedDate"
                                                    name="sampleReceivedDate"
                                                    placeholder="<?= _translate("Please enter date"); ?>"
                                                    title="Please enter sample receipt date" style="width:100%;" />
                                            </td>
                                            <th style="width:15%;"><label for="labId">Lab Name <span
                                                        class="mandatory">*</span></label> </th>
                                            <td style="width:35%;">
                                                <select name="labId" id="labId" class="labSecInput form-control"
                                                    title="Please select Testing Lab name" style="width:100%;">
                                                    <?= $general->generateSelectOptions($testingLabs, $hepatitisInfo['lab_id'], '-- Select --'); ?>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            <th style="width:15%;" scope="row"><label for="sampleTestedDateTime">VL Testing
                                                    Date</label></th>
                                            <td style="width:35%;">
                                                <input
                                                    value="<?php echo DateUtility::humanReadableDateFormat($hepatitisInfo['sample_tested_datetime']) ?>"
                                                    type="text" class="labSecInput form-control" id="sampleTestedDateTime"
                                                    name="sampleTestedDateTime"
                                                    placeholder="<?= _translate("Please enter date"); ?>"
                                                    title="Please enter testing date" style="width:100%;" />
                                            </td>
                                            <th style="width:15%;" scope="row"><label for="vlTestingSite">VL Testing
                                                    Site</label></th>
                                            <td style="width:35%;">
                                                <select class="labSecInput form-control" id="vlTestingSite"
                                                    name="vlTestingSite" title="Please select testing site"
                                                    style="width:100%;">
                                                    <?= $testingLabsDropdown; ?>
                                                </select>
                                            </td>
                                        ...
                                        <tr>
                                            <th style="width:15%;" scope="row"><label for="reasonVlTest">VL test
                                                    purpose</label></th>
                                            <td style="width:35%;">
                                                <select class="labSecInput form-control" name="reasonVlTest"
                                                    id="reasonVlTest">
                                                    <option value=''> -- Select -- </option>
                                            ...
                                            <td style="width:35%;">
                                                <select class="labSecInput form-control result-focus"
                                                    name="isSampleRejected" id="isSampleRejected">
                                                    <option value=""> -- Select -- </option>
                                        ...
                                        <tr class="show-rejection" style="display:none;">
                                            <th style="width:15%;" scope="row" class="show-rejection" style="display:none;">
                                                Reason for Rejection<span class="mandatory">*</span></th>
                                            <td style="width: 35%;" class="show-rejection" style="display:none;">
                                                <select class="form-control" name="sampleRejectionReason"
                                                    id="sampleRejectionReason" title="Please choose reason for rejection">
                                                    <option value="">-- Select --</option>
                                                    <?php echo $rejectionReason; ?>
                                                </select>
                                            </td>
                                            <th style="width:15%;" scope="row">Rejection Date<span
                                                    class="mandatory">*</span></th>
                                            <td style="width:35%;"><input
                                                    value="<?php echo DateUtility::humanReadableDateFormat($hepatitisInfo['rejection_on']); ?>"
                                                    class="form-control date rejection-date" type="text"
                                                    name="rejectionDate" id="rejectionDate"
                                                    placeholder="Select Rejection Date" /></td>
                                        </tr>
                                        <tr>
                                            <th style="width:15%;" scope="row" class="hcvFields"><label for="hcvCount">HCV
                                                    VL Count</label></th>
                                            <td style="width: 35%;" class="hcvFields">
                                                <input value="<?php echo $hepatitisInfo['hcv_vl_count']; ?>" data-val=""
                                                    type="text"
                                                    class="hcvFields  result-focus labSecInput form-control rejected-input"
                                                    placeholder="Enter HCV Count" title="Please enter HCV Count"
                                                    name="hcvCount" id="hcvCount">
                                            </td>
                                            <th style="width:15%;" scope="row" class="hbvFields"><label for="hbvCount">HBV
                                                    VL Count</label></th>
                                            <td style="width: 35%;" class="hbvFields">
                                                <input value="<?php echo $hepatitisInfo['hbv_vl_count']; ?>" data-val=""
                                                    type="text"
                                                    class="hbvFields result-focus labSecInput form-control rejected-input"
                                                    placeholder="Enter HBV Count" title="Please enter HBV Count"
                                                    name="hbvCount" id="hbvCount">
                                            </td>
                                        </tr>
                                        <tr>
                                            <th style="width:15%;"><label for="">Testing Platform </label></th>
                                            <td style="width:35%;"><select name="hepatitisPlatform" id="hepatitisPlatform"
                                                    class="labSecInput form-control rejected-input"
                                            ...
                                            <td style="width:35%;"><select name="machineName" id="machineName"
                                                    class="labSecInput form-control rejected-input"
                                            ...
                                            <td style="width:35%;">
                                                <select name=" isResultAuthorized" id="isResultAuthorized"
                                                    class="labSecInput disabled-field form-control rejected-input"
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:35%;"><input
                                                    value="<?php echo DateUtility::humanReadableDateFormat($hepatitisInfo['authorized_on']) ?>"
                                                    type="text" <?php echo $disabled; ?> name="authorizedOn"
                                                    id="authorizedOn"
                                                    class="labSecInput disabled-field rejected-input form-control date"
                                                    placeholder="Authorized on" title="Please select the authorized on" />
                                            </td>
                                            <th style="width:15%;" scope="row" class="change-reason" style="display: none;">
                                                Reason for Changing <span class="mandatory">*</span></th>
                                            <td style="width:35%;" class="change-reason" style="display: none;"><textarea
                    ...
                    <div class="box-footer">
                        ...
                        <input type="hidden" name="hepatitisSampleId" id="hepatitisSampleId"
                            value="<?php echo $hepatitisInfo['hepatitis_id']; ?>" />
                        ...
                        <input type="hidden" name="oldStatus" id="oldStatus"
                            value="<?php echo $hepatitisInfo['result_status']; ?>" />
