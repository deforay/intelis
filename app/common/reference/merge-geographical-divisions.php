...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a
                    href="/common/reference/geographical-divisions-details.php"><?php echo _translate("Geographical Divisions"); ?></a>
            </li>
    ...
    <section class="content">
        <div class="box box-default">
            ...
            <form class="form-horizontal" method="post" id="mergeGeographicalDivisions"
                action="merge-geographical-divisions-helper.php">
                <div class="box-body">
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?php echo _translate("Merge Type"); ?><span
                    ...
                    <div id="provinceMergeSection">
                        <div class="form-group">
                            <label for="selectedProvinces"
                                class="col-lg-3 control-label"><?php echo _translate("Select Provinces to Merge"); ?><span
                                    class="mandatory">*</span></label>
                            <div class="col-lg-7">
                                <select name="selectedProvinces[]" id="selectedProvinces"
                                ...
                                <p class="help-block">
                                    <?php echo _translate("Select at least two provinces. All districts and facilities from the non-primary provinces will move to the chosen primary province."); ?>
                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="primaryProvince"
                                class="col-lg-3 control-label"><?php echo _translate("Primary Province (remains active)"); ?><span
                                    class="mandatory">*</span></label>
                            <div class="col-lg-7">
                                <select name="primaryProvince" id="primaryProvince" class="form-control select2-element"
                                    data-placeholder="<?php echo _translate("Select primary province"); ?>">
                    ...
                    <div id="districtMergeSection" style="display:none;">
                        <div class="form-group">
                            <label for="selectedDistricts"
                                class="col-lg-3 control-label"><?php echo _translate("Select Districts to Merge"); ?><span
                                    class="mandatory">*</span></label>
                            <div class="col-lg-7">
                                <select name="selectedDistricts[]" id="selectedDistricts"
                                    class="form-control select2-element" multiple
                                ...
                                <p class="help-block">
                                    <?php echo _translate("Select at least two districts. All facilities from the non-primary districts will move to the chosen primary district."); ?>
                                </p>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="primaryDistrict"
                                class="col-lg-3 control-label"><?php echo _translate("Primary District (remains active)"); ?><span
                                    class="mandatory">*</span></label>
                            <div class="col-lg-7">
                                <select name="primaryDistrict" id="primaryDistrict" class="form-control select2-element"
                                    data-placeholder="<?php echo _translate("Select primary district"); ?>">
                                    <option value=""><?php echo _translate("-- Select --"); ?></option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="box-footer">
                    ...
                    <a href="geographical-divisions-details.php"
