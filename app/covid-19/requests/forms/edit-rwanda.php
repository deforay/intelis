...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><em class="fa-solid fa-pen-to-square"></em>
            <?php echo _translate("COVID-19 VIRUS LABORATORY TEST REQUEST FORM"); ?></h1>
        <ol class="breadcrumb">
                                                ...
                                                <?php foreach ($covid19Symptoms as $symptomId => $symptomName) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <select name="symptomDetected[]" class="form-control isRequired"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35% !important;">
                                            <select name="isSampleCollected" id="isSampleCollected"
                                                class="form-control isRequired" title="Is Lab Sample collected ?"
                                                style="width:100%">
                                                <option value="">-- Select --</option>
