...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1><em class="fa-solid fa-pen-to-square"></em>
            <?php echo _translate("WHO COVID-19 VIRUS LABORATORY TEST REQUEST FORM"); ?></h1>
        <ol class="breadcrumb">
                            ...
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="isSamplePostMortem" id="isSamplePostMortem"
                                                class="form-control" title="Is Clinical Sample Post-mortem ?"
                                                style="width:100%">
                                                <option value="">-- Select --</option>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true">
                                    ...
                                    <tr>
                                        <th scope="row" colspan=2>Has the patient had a recent history of travelling to
                                            an affected area? <span class="mandatory">*</span></th>
                                        <td style="width:25% !important;">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                                        ...
                                                        <?php if (!empty($covid19TestInfo)) {
                                                            foreach ($covid19TestInfo as $indexKey => $rows) { ?>
                                                                <tr>
                                                                    ...
                                                                    <td><select
                                                                            class="form-control test-result test-result test-name-table-input result-focus"
                                                                            name="testResult[]"
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" value="<?php echo $covid19Info['authorized_by']; ?>"
                                                    ...
                                                    class="disabled-field form-control" placeholder="Authorized By" /></td>
                                        </tr>
                                        <tr>
