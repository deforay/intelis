...
// app/covid-19/requests/getManifestInGridHelper.php
...
$covid19Results = ContainerRegistry::get(Covid19Service::class)->getCovid19Results();

$manifestGrid = [
    'select' => "SELECT * FROM form_covid19 as vl
    ...
    'rowMapper' => function (array $aRow) use ($general, $covid19Results): array {
