...
[$sOffset, $sLimit] = \App\Utilities\DataTableUtility::paging($_POST);
...
$aResultFilterTotal = $db->rawQuery("SELECT * FROM r_covid19_qc_testkits $sWhere");
