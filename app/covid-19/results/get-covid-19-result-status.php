...
foreach ($rResult as $aRow) {
    ...
    $status = '<select class="form-control"  name="status[]" id="' . $aRow['covid19_id'] . '" title="' . _translate("Please select status") . '" onchange="updateStatus(this,' . (int) $aRow['result_status'] . ')">
