    ...
    class DRCCovid19PDF5 extends Covid19ResultPDFHelper
    {
        ...
        public function Header(): void
        {
            ...
            if ($this->htitle !== null && $this->htitle !== '' && $this->htitle !== '0' && trim($this->htitle) !== '') {
                ...
                if ($this->logo !== null && $this->logo !== '' && $this->logo !== '0' && trim($this->logo) !== '' && file_exists(UPLOAD_PATH . DIRECTORY_SEPARATOR . "facility-logo" . DIRECTORY_SEPARATOR . "inrb.png")) {
                ...
                if ($this->logo !== null && $this->logo !== '' && $this->logo !== '0' && trim($this->logo) !== '') {
                    if ($this->facilityInfo !== null && $this->facilityInfo !== [] && !empty($this->facilityInfo['facility_logo']) && file_exists(UPLOAD_PATH . DIRECTORY_SEPARATOR . "facility-logo" . DIRECTORY_SEPARATOR . $this->facilityInfo['facility_id'] . DIRECTORY_SEPARATOR . $this->facilityInfo['facility_logo'])) {
...
if ($result['result'] != '' || ($result['result'] == '' && $result['result_status'] == REJECTED)) {
    ...
    if (isset($arr['covid19_report_qr_code']) && $arr['covid19_report_qr_code'] == 'yes' && !empty($general->getRemoteURL())) {
        ...
        $pdf->write2DBarcode($remoteURL . '/covid-19/results/view.php?q=' . urlencode((string) $viewId), 'QRCODE,H', 170, 60, 100, 100, [], 'N');
    }
    $pdf->lastPage();
