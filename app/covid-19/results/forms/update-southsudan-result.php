...
$provResult = $db->query("SELECT * FROM geographical_divisions WHERE geo_parent = 0 and geo_status='active'");
$provinceInfo = [];
foreach ($provResult as $state) {
            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" method="post" name="updateCovid19ConfirmatoryRequestForm"
                            ...
                            <div class="box-body">
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    <tr>
                                        ...
                                        <td class="show-alert-poe"
                                            ...
                                            <label for="sourceOfAlertPOE">Source of Alert / POE Others</label>
                                        </td>
                                        <td class="show-alert-poe"
                                            style="<?php echo (isset($covid19Info['source_of_alert']) && $covid19Info['source_of_alert'] == 'others') ? "" : "display:none;"; ?>">
                                            <input type="text"
                                    ...
                                    <tr>
                                        <td><label for="province">Health Facility/POE State </label><span
                                        ...
                                        <td><label for="district">Health Facility/POE County </label><span
                                                class="mandatory">*</span></td>
                                        <td>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35% !important">
                                            <input type="text" class="form-control" id="firstName" name="firstName"
                                                placeholder="First Name" title="Please enter Case first name"
                                                style="width:100%;"
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35% !important">
                                            <input type="text" class="form-control" id="patientId" name="patientId"
                                                placeholder="Identification" title="Please enter ID" style="width:100%;"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control select2" name="patientDistrict"
                                                id="patientDistrict" title="Please Case County" style="width:100%;">
                                                <option value="">--Select--</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td><input class="form-control"
                                                ...
                                                name="patientCity" placeholder="Case City/Village"
                                                title="Please enter the Case City/Village" style="width:100%;"></td>
                                ...
                                <table aria-describedby="table" class="table" aria-hidden="true">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="reasonForCovid19Test" id="reasonForCovid19Test"
                                                class="form-control" title="Please choose specimen type"
                                                style="width:100%">
                                                <option value="">-- Select --</option>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width:35% !important;">
                                            <input class="form-control" type="text" name="sampleCollectionDate"
                                                id="sampleCollectionDate" placeholder="Sample Collection Date"
                                                value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['sample_collection_date']); ?>" />
                                        </td>
                                ...
                                <div class="box-body">
                                    ...
                                    <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                        <tr>
                                            ...
                                            <td class="lab-show"><label for="labId">Testing Laboratory <span
                                        ...
                                        <tr>
                                        <tr>
                                            <td><label for="specimenQuality">Specimen Quality<span
                                                        class="mandatory">*</span></label></td>
                                            <td>
                                                <select class="form-control isRequired" id="specimenQuality"
                                                    name="specimenQuality" title="Please enter the specimen quality">
                                                    <option value="">--Select--</option>
                                            ...
                                            <td>
                                                <select name="labTechnician" id="labTechnician"
                                                    class="form-control isRequired" title="Please select a Lab Technician"
                                                    style="width:100%;">
                                                    <option value="">--Select--</option>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select name="testingPlatform[]"
                                                                            ...
                                                                            class="form-control result-optional test-name-table-input isRequired"
                                                                    ...
                                                                    <td>
                                                                        <select
                                                                            ...
                                                                            <?php foreach ($covid19Results as $c19ResultKey => $c19ResultValue) { ?>
                                                                                <option value="<?= $c19ResultKey; ?>"
                                                                                    <?= ($rows['result'] == $c19ResultKey) ? "selected='selected'" : ""; ?>>
                                                                                    <?= $c19ResultValue; ?> </option>
                                                                            <?php } ?>
                                                                        </select>
                                                                    </td>
                                                                    <td
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="authorizedBy" id="authorizedBy"
                                                    class="select2 form-control isRequired"
                                                    title="Please choose authorized by" style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text"
                                                    ...
                                                    placeholder="Authorized on" title="Please enter the Authorized on" />
                                            </td>
                                            <th scope="row"></th>
                                            <td></td>
                                        </tr>
                    ...
                    <div class="box-footer">
                        <a class="btn btn-primary submit-btn" href="javascript:void(0);"
                        ...
                        <input type="hidden" name="remoteSampleCodeCol" id="remoteSampleCodeCol"
                            value="<?php echo $covid19Info['remote_sample_code']; ?>" />
