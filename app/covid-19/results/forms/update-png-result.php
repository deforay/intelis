                        ...
                        <div class="box-body disabledForm">
                            ...
                            <table aria-describedby="table" class="table" aria-hidden="true" style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" class="form-control isRequired" value="<?php echo DateUtility::humanReadableDateFormat($covid19Info['patient_dob']); ?>" id="dob" name="dob" placeholder="Date of birth" title="Please enter Date of birth" style="width:100%;" onchange="calculateAgeInYears('dob', 'patientAge');" />
                                    </td>
                                </tr>
                                <tr>
