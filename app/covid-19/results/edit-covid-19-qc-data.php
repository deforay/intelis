            ...
            <div class="box-body">
                ...
                <form class="form-horizontal" method='post' name='addQcTestKits' id='addQcTestKits' autocomplete="off"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" value="<?php echo $qcDataInfo['qc_code']; ?>"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    <label for="lotNo"
                                        class="col-lg-4 control-label"><?php echo _translate("Lot number"); ?> <span
                                            class="mandatory">*</span></label>
                                    <div class="col-lg-7">
                                        <input type="text" value="<?php echo $qcDataInfo['lot_no']; ?>"
                                            class="form-control isRequired" id="lotNo" name="lotNo"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text"
                                            value="<?php echo date("d-M-Y", strtotime((string) $qcDataInfo['expiry_date'])); ?>"
                                            class="form-control date isRequired" id="expiryDate" name="expiryDate"
                                            placeholder="<?php echo _translate('Expiry date'); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text"
                                            value="<?php echo date("d-M-Y H:s:i", strtotime((string) $qcDataInfo['qc_received_datetime'])); ?>"
                                            class="form-control date-time isRequired" id="receivedOn" name="receivedOn"
                                            placeholder="<?php echo _translate('Received on'); ?>"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text"
                                            value="<?php echo date("d-M-Y H:s:i", strtotime((string) $qcDataInfo['qc_tested_datetime'])); ?>"
                                            class="form-control date-time isRequired" id="testedOn" name="testedOn"
                                            placeholder="<?php echo _translate('Tested on'); ?>"
                            ...
                            <?php foreach ($qcResultDataInfo as $key => $row) { ?>
                                <tr>
                                    <td>
                                        ...
                                        <input type="hidden" value="<?php echo $row['qc_test_id']; ?>"
                                            id="qcTestId<?php echo ($key + 1); ?>" name="qcTestId[]" />
                                        <input type="hidden" value="<?php echo $row['test_label']; ?>"
                                            id="testLabel<?php echo ($key + 1); ?>" name="testLabel[]" />
                                    </td>
                                    <td><select class="form-control" id="testResults<?php echo ($key + 1); ?>"
                                            name="testResults[]" class="form-control" title="Please enter the test result">
                    ...
                    <div class="box-footer">
                        <input type="hidden" name="qcDataId" id="qcDataId"
                            value="<?php echo base64_encode((string) $qcDataInfo['qc_id']); ?>" />
