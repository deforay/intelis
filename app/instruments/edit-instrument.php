...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="box box-default">
			...
			<div class="box-body">
				<!-- form start -->
				<form class="form-horizontal" method='post' name='instrumentForm' id='instrumentForm' autocomplete="off"
					action="edit-instrument-helper.php">
					<div class="box-body">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control isRequired" id="configurationName"
											...
											placeholder="<?php echo _translate('eg. Roche or Abbott'); ?>"
											title="<?php echo _translate('Please enter instrument name'); ?>"
											value="<?php echo $sInfo['machine_name']; ?>"
											onchange="setConfigFileName();"
						...
						<?php if ($general->isLISInstance()) { ?>
							<input type="hidden" value="<?= $general->getSystemConfig('sc_testing_lab_id'); ?>"
								name="testingLab" />
						<?php } else { ?>
							<div class="row">
								<div class="col-md-6">
									...
									<div class="col-lg-7">
										<select multiple class="" id="supportedTests" name="supportedTests[]">
											...
											<?php foreach ($activeTests as $testType) { ?>
												<option value="<?= $testType; ?>" <?php echo (in_array($testType, $sInfo['supported_tests'])) ? "selected='selected'" : ''; ?>>
													<?php echo TestsService::getTestName($testType); ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<div class="col-lg-7">
										...
										<select name="configurationFile" id="configurationFile"
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control forceNumeric" id="lowerLimit"
											name="lowerLimit" placeholder="<?php echo _translate('eg. 20'); ?>"
											title="<?php echo _translate('Please enter lower limit'); ?>"
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<input type="text" class="form-control forceNumeric" id="higherLimit"
											name="higherLimit" placeholder="<?php echo _translate('eg. 10000000'); ?>"
											title="<?php echo _translate('Please enter lower limit'); ?>"
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="maxNOfSamplesInBatch" class="col-lg-4 control-label">
										<?php echo _translate("Maximum No. of Samples In a Batch"); ?> <span
											class="mandatory">*</span>
									</label>
									<div class="col-lg-7">
										<input type="text" class="form-control forceNumeric isRequired"
											id="maxNOfSamplesInBatch" name="maxNOfSamplesInBatch"
											placeholder="<?php echo _translate('Max. no of samples'); ?>"
											title="<?php echo _translate('Please enter max no of samples in a row'); ?>"
									...
									<div class="form-group">
										...
										<div class="col-lg-7">
											<textarea class="form-control" id="lowVlResultText" name="lowVlResultText"
												placeholder="<?php echo _translate('Comma separated Low Viral Load Result Text for eg. Target Not Detected, TND, < 20, < 40'); ?>"
												title="<?php echo _translate('Low Viral Load Result Text for eg. Target Not Detected, TND, < 20, < 40'); ?>"><?php echo $sInfo['low_vl_result_text']; ?></textarea>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="row additionalText">
							<div class="col-md-12">
								<div class="form-group">
									...
									<div class="col-lg-7">
										<textarea class="form-control richtextarea" id="additionalText"
											name="additionalText"
											placeholder='<?php echo _translate("Enter Description or Comment to be added in Test Result"); ?>'
											title='<?php echo _translate("Enter Description or Comment to be added in Test Result"); ?>'><?php echo htmlspecialchars_decode((string) $sInfo['additional_text'], ENT_QUOTES); ?></textarea>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="form-group">
									...
									<div class="col-lg-7">
										<select class="form-control" id="status" name="status"
											title="<?php echo _translate('Please select instrument status'); ?>">
											<option value="active" <?php echo ($sInfo['status'] == 'active') ? 'selected="selected"' : ''; ?>><?php echo _translate("Active"); ?>
											</option>
											<option value="inactive" <?php echo ($sInfo['status'] == 'inactive') ? 'selected="selected"' : ''; ?>><?php echo _translate("Inactive"); ?>
											</option>
										</select>
									</div>
								</div>
									...
									<tbody>
										<?php if (SYSTEM_CONFIG['modules']['vl']) { ?>
											<tr class="vl-access user-access-form"
												...
												<td align="left" style="text-align:center;">
													<?php echo _translate("VL"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="vl" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByVl"
														class="form-control user-vl select2"
														title='<?php echo _translate("Please enter Reviewed By for VL Test"); ?>'
														onchange="changeDefaultReviewer(this.value,'vl');">
												...
												<td>
													<select name="approvedBy[]" id="approvedByVl"
														class="form-control user-vl select2"
														title='<?php echo _translate("Please enter Approved By for VL Test"); ?>'
														onchange="changeDefaultApprover(this.value,'vl');">
										...
										if (SYSTEM_CONFIG['modules']['eid']) { ?>
											<tr class="eid-access user-access-form"
												...
												<td align="left" style="text-align:center;">
													<?php echo _translate("EID"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="eid" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByEid"
														class="form-control user-eid select2"
														title='<?php echo _translate("Please enter Reviewed By for EID Test"); ?>'
														onchange="changeDefaultReviewer(this.value,'eid');">
												...
												<td>
													<select name="approvedBy[]" id="approvedByEid"
														class="form-control user-eid select2"
														title='<?php echo _translate("Please enter Approved By for EID Test"); ?>'
														onchange="changeDefaultApprover(this.value,'eid');">
										...
										if (SYSTEM_CONFIG['modules']['covid19']) { ?>
											<tr class="covid19-access user-access-form"
												...
												<td align="left" style="text-align:center;">
													<?php echo _translate("Covid-19"); ?><input type="hidden"
														name="userTestType[]" id="testType1" value="covid19" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByCovid19"
														class="form-control user-covid19 select2"
														title='<?php echo _translate("Please enter Reviewed By for Covid19 Test"); ?>'
														onchange="changeDefaultReviewer(this.value,'covid19');">
												...
												<td>
													<select name="approvedBy[]" id="approvedByCovid19"
														class="form-control user-covid19 select2"
														title='<?php echo _translate("Please enter Approved By for Covid19 Test"); ?>'
														onchange="changeDefaultApprover(this.value,'covid19');">
										...
										if (SYSTEM_CONFIG['modules']['hepatitis']) { ?>
											<tr class="hepatitis-access user-access-form"
												...
												<td align="left" style="text-align:center;">
													<?php echo _translate("Hepatitis"); ?><input type="hidden"
														name="userTestType[]" id="testType1" value="hepatitis" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByHepatitis"
														class="form-control user-hepatitis select2"
														title='<?php echo _translate("Please enter Reviewed By for Hepatitis Test"); ?>'
														onchange="changeDefaultReviewer(this.value,'hepatitis');">
												...
												<td>
													<select name="approvedBy[]" id="approvedByHepatitis"
														class="form-control user-hepatitis select2"
														title='<?php echo _translate("Please enter Approved By for Hepatitis Test"); ?>'
														onchange="changeDefaultApprover(this.value,'hepatitis');">
										...
										if (SYSTEM_CONFIG['modules']['tb']) { ?>
											<tr class="tb-access user-access-form"
												...
												<td align="left" style="text-align:center;">
													<?php echo _translate("TB"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="tb" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByTb"
														class="form-control user-tb select2"
														title='<?php echo _translate("Please enter Reviewed By for TB Test"); ?>'
														onchange="changeDefaultReviewer(this.value,'tb');">
												...
												<td>
													<select name="approvedBy[]" id="approvedByTb"
														class="form-control user-tb select2"
														title='<?php echo _translate("Please select Approved By for TB Test"); ?>'
														onchange="changeDefaultApprover(this.value,'tb');">
										...
										if (SYSTEM_CONFIG['modules']['cd4']) { ?>
											<tr class="cd4-access user-access-form"
												style="<?php echo in_array('cd4', $sInfo['supported_tests']) ? "" : "display:none;"; ?>">
												<td align="left" style="text-align:center;">
													<?php echo _translate("CD4"); ?><input type="hidden" name="userTestType[]"
														id="testType1" value="cd4" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByCd4"
														class="form-control user-cd4 select2"
														title='<?php echo _translate("Please enter Reviewed By for CD4 Test"); ?>'
														onchange="changeDefaultReviewer(this.value,'cd4');">
														<?php echo $general->generateSelectOptions($userList, $sInfo['reviewed_by']['cd4'], '--Select--'); ?>
													</select>
												</td>
												<td>
													<select name="approvedBy[]" id="approvedByCd4"
														class="form-control user-cd4 select2"
														title='<?php echo _translate("Please enter Approved By for CD4 Test"); ?>'
														onchange="changeDefaultApprover(this.value,'cd4');">
										...
										if (SYSTEM_CONFIG['modules']['generic-tests']) { ?>
											<tr class="generic-access user-access-form"
												...
												<td align="left" style="text-align:center;">
													<?php echo _translate("Other Lab Tests"); ?><input type="hidden"
														name="userTestType[]" id="testType1" value="generic-tests" />
												</td>
												<td>
													<select name="reviewedBy[]" id="reviewedByGeneric"
														class="form-control user-generic select2"
														title='<?php echo _translate("Please enter Reviewed By for Other Lab Test"); ?>'
														onchange="changeDefaultReviewer(this.value,'generic-tests');">
												...
												<td>
													<select name="approvedBy[]" id="approvedByGeneric"
														class="form-control user-generic select2"
														title='<?php echo _translate("Please enter Approved By for Other Lab Test"); ?>'
														onchange="changeDefaultApprover(this.value,'generic-tests');">
									...
									<tbody id="testTypesTable">
										<?php if ((SYSTEM_CONFIG['modules']['vl'])) { ?>
											<tr id="vlTable" class="ctlCalibrator" <?php echo $vl; ?>>
												<td align="left">
													<?php echo _translate("VL"); ?><input type="hidden" name="testType[]"
														id="testType1" value="vl" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['vl']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of In-House Controls in vl'); ?>"
														title="<?php echo _translate('Please enter No of In-House Controls in vl'); ?>" />
												</td>
												<td><input type="text"
														...
														placeholder="<?php echo _translate('No of Manufacturer Controls in vl'); ?>"
														title="<?php echo _translate('Please enter No of Manufacturer Controls in vl'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['vl']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Calibrators in vl'); ?>"
														title="<?php echo _translate('Please enter No of Calibrators in vl'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['eid'])) { ?>
											<tr id="eidTable" class="ctlCalibrator" <?php echo $eid; ?>>
												<td align="left">
													<?php echo _translate("EID"); ?><input type="hidden" name="testType[]"
														id="testType1" value="eid" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['eid']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of In-House Controls in eid'); ?>"
														title="<?php echo _translate('Please enter No of In-House Controls in eid'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['eid']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Manufacturer Controls in eid'); ?>"
														title="<?php echo _translate('Please enter No of Manufacturer Controls in eid'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['eid']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Calibrators in eid'); ?>"
														title="<?php echo _translate('Please enter No of Calibrators in eid'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['covid19'])) { ?>
											<tr id="covid19Table" class="ctlCalibrator" <?php echo $covid19; ?>>
												<td align="left">
													<?php echo _translate("Covid-19"); ?><input type="hidden" name="testType[]"
														id="testType1" value="covid-19" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['covid-19']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of In-House Controls in covid-19'); ?>"
														title="<?php echo _translate('Please enter No of In-House Controls in covid-19'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['covid-19']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Manufacturer Controls in covid-19'); ?>"
														title="<?php echo _translate('Please enter No of Manufacturer Controls in covid-19'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['covid-19']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Calibrators in covid-19'); ?>"
														title="<?php echo _translate('Please enter No of Calibrators in covid-19'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['hepatitis'])) { ?>
											<tr id="hepatitisTable" class="ctlCalibrator" <?php echo $hepatitis; ?>>
												<td align="left">
													<?php echo _translate("Hepatitis"); ?><input type="hidden" name="testType[]"
														id="testType1" value="hepatitis" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['hepatitis']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of In-House Controls in hepatitis'); ?>"
														title="<?php echo _translate('Please enter No of In-House Controls in hepatitis'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['hepatitis']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Manufacturer Controls in hepatitis'); ?>"
														title="<?php echo _translate('Please enter No of Manufacturer Controls in hepatitis'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['hepatitis']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Calibrators in hepatitis'); ?>"
														title="<?php echo _translate('Please enter No of Calibrators in hepatitis'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['tb'])) { ?>
											<tr id="tbTable" class="ctlCalibrator" <?php echo $tb; ?>>
												<td align="left">
													<?php echo _translate("tb"); ?><input type="hidden" name="testType[]"
														id="testType1" value="tb" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['tb']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of In-House Controls in TB'); ?>"
														title="<?php echo _translate('Please enter No of In-House Controls in TB'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['tb']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Manufacturer Controls in TB'); ?>"
														title="<?php echo _translate('Please enter No of Manufacturer Controls in TB'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['tb']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Calibrators in TB'); ?>"
														title="<?php echo _translate('Please enter No of Calibrators in TB'); ?>" />
												</td>
											</tr>
										<?php }
										if ((SYSTEM_CONFIG['modules']['cd4'])) { ?>
											<tr id="cd4Table" class="ctlCalibrator" <?php echo $cd4; ?>>
												<td align="left">
													<?php echo _translate("CD4"); ?><input type="hidden" name="testType[]"
														id="testType1" value="cd4" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['cd4']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of In-House Controls in CD4'); ?>"
														title="<?php echo _translate('Please enter No of In-House Controls in CD4'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['cd4']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Manufacturer Controls in CD4'); ?>"
														title="<?php echo _translate('Please enter No of Manufacturer Controls in CD4'); ?>" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['cd4']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1"
														class="form-control forceNumeric"
														placeholder="<?php echo _translate('No of Calibrators in CD4'); ?>"
														title="<?php echo _translate('Please enter No of Calibrators in CD4'); ?>" />
												</td>
											</tr>
										<?php }
										if (SYSTEM_CONFIG['modules']['generic-tests']) { ?>
											<tr id="generic-testsTable" class="ctlCalibrator" <?php echo $genericTests; ?>>
												<td align="left">
													<?php echo _translate("Other Lab Tests"); ?><input type="hidden"
														name="testType[]" id="testType1" value="generic-tests" />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['generic-tests']['noHouseCtrl']; ?>"
														name="noHouseCtrl[]" id="noHouseCtrl1" class="form-control forceNumeric"
														placeholder='<?php echo _translate("No of In-House Controls in Other Lab Tests"); ?>'
														title='<?php echo _translate("Please enter No of In-House Controls in Other Lab Tests"); ?>' />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['generic-tests']['noManufacturerCtrl']; ?>"
														name="noManufacturerCtrl[]" id="noManufacturerCtrl1"
														class="form-control forceNumeric"
														placeholder='<?php echo _translate("No of Manufacturer Controls in Other Lab Tests"); ?>'
														title='<?php echo _translate("Please enter No of Manufacturer Controls in Other Lab Tests"); ?>' />
												</td>
												<td><input type="text"
														value="<?php echo $configControl['generic-tests']['noCalibrators']; ?>"
														name="noCalibrators[]" id="noCalibrators1"
														class="form-control forceNumeric"
														placeholder='<?php echo _translate("No of Calibrators in Other Lab Tests"); ?>'
														title='<?php echo _translate("Please enter No of Calibrators in Other Lab Tests"); ?>' />
												</td>
											</tr>
										<?php } ?>
									</tbody>
									...
									if (count($configMachineInfo) > 0) {
											...
											<tr>
												<td>
													...
													<input type="text" name="configMachineName[]"
														...
														placeholder="<?= _translate('Machine Name'); ?>"
														title="<?= _translate('Please enter machine name'); ?>"
														value="<?php echo $machine['config_machine_name']; ?>"
														onblur="checkDuplication(this, 'configMachineName');" ; />
												</td>
												<td class="smart-date-cell">
													<!-- Smart Date Format Detection Interface -->
													<div style="margin-bottom: 8px;">
														<input type="text" name="sampleDateInput[]"
															id="sampleDateInput<?php echo $i; ?>" class="form-control"
															...
															data-row-id="<?php echo $i; ?>" data-default-format="d/m/Y H:i"
															value="<?php echo $machine['date_format'] ?: ''; ?>" />
														<small style="color: #666; font-size: 11px;">💡
															<?= _translate("Enter any date from your instrument to auto-detect format"); ?></small>
													</div>

													<!-- Smart Suggestions Container -->
													<div id="formatSuggestions<?php echo $i; ?>"
														class="format-suggestions-container"></div>

													<!-- Hidden field to store selected format (this is what gets submitted) -->
													<input type="hidden" name="dateFormat[]" id="dateFormat<?php echo $i; ?>"
														value="<?php echo $machine['date_format'] ?: 'd/m/Y H:i'; ?>" />

													<!-- Manual Format Input (hidden by default) -->
													<div id="manualFormatInput<?php echo $i; ?>"
												...
												<td>
													<select name="fileName[]" id="fileName<?php echo $i; ?>"
														class="form-control select2 instrumentFile">
													...
													<div class="latLong<?php echo $i; ?> " style="<?php echo $style; ?>">
														<div class="col-md-4">
															<input type="text" name="latitude[]" id="latitude<?php echo $i; ?>"
																...
																class="form-control "
																placeholder="<?= _translate('Latitude'); ?>"
																data-placement="bottom"
																title="<?= _translate('Latitude'); ?>" />
														</div>
														<div class="col-md-4">
															<input type="text" name="longitude[]"
																...
																class="form-control "
																placeholder="<?= _translate('Longitude'); ?>"
																data-placement="bottom"
																title="<?= _translate('Longitude'); ?>" />
														</div>
													</div>
												</td>
										...
										<tr>
											...
											<td class="smart-date-cell">
												<!-- Smart Date Format Detection Interface -->
												<div style="margin-bottom: 8px;">
													<input type="text" name="sampleDateInput[]" id="sampleDateInput0"
														class="form-control"
														placeholder="📅 <?= _translate("Enter sample date (e.g., 06.19.2025 11:19 AM)"); ?>"
														title="<?= _translate("Enter a sample date from your instrument files"); ?>"
														style="border: 2px solid #007bff; font-size: 13px;"
														...
														data-manual-input="manualFormatInput0" data-row-id="0"
														data-default-format="d/m/Y H:i" />
													<small style="color: #666; font-size: 11px;">💡 Enter any date from your
														instrument to auto-detect format</small>
												</div>
												...
												<!-- Hidden field to store selected format (this is what gets submitted) -->
												<input type="hidden" name="dateFormat[]" id="dateFormat0"
													value="d/m/Y H:i" />
											...
											<td>
												<select name="fileName[]" id="fileName0"
													class="form-control select2 instrumentFile">
													<option value=""><?= _translate('Select File'); ?></option>
													<?php
													foreach ($fileList as $fileName) {
					...
					<div class="box-footer">
						<input type="hidden" id="configId" name="configId"
							value="<?php echo base64_encode((string) $sInfo['instrument_id']); ?>" />
