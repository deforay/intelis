(() => {
    ...
    function listLimit(e) {
        ...
        options.forEach(opt => {
            ...
            const optText = (opt.textContent || opt.value || '').trim().toLowerCase();
    ...
    function listSet(e) {
        ...
        // Use value attribute if available, otherwise fall back to trimmed textContent
        const newValue = (t && (t.value || (t.textContent || '').trim())) || '';
