...
$sharedGenericPrivileges = [
    ...
    '/generic-tests/results/edit-generic-referral.php' => '/generic-tests/results/generic-referral-list.php',
    ...
    '/generic-tests/configuration/export-test-type.php' => '/generic-tests/configuration/test-type.php',
    '/generic-tests/configuration/import-test-type.php' => '/generic-tests/configuration/test-type.php',
...
$sharedHepPrivileges = [
    ...
    '/hepatitis/requests/patientModal.php' => '/hepatitis/requests/hepatitis-requests.php',
