...
(`id`, `module`, `sub_module`, `is_header`, `display_text`, `link`, `inner_pages`, `show_mode`, `icon`, `has_children`, `additional_class_names`, `parent_id`, `display_order`, `status`, `updated_datetime`) VALUES 
(NULL, 'generic-tests', NULL, 'no', 'Refer to another lab', '/generic-tests/results/generic-referral-list.php', '/generic-tests/results/add-generic-referral.php,/generic-tests/results/edit-generic-referral.php', 'always', 'fa-solid fa-caret-right', 'no', 'allMenu genericFailedResultsMenu', '62', '90', 'active', CURRENT_TIMESTAMP);
