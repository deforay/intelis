...
CREATE TABLE `activity_log` (
  ...
  PRIMARY KEY (`log_id`),
  KEY `idx_activity_log_session_hash` (`session_hash`)
...
--
-- Table structure for table `audit_column_aliases`
--

DROP TABLE IF EXISTS `audit_column_aliases`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `audit_column_aliases`
--

LOCK TABLES `audit_column_aliases` WRITE;
/*!40000 ALTER TABLE `audit_column_aliases` DISABLE KEYS */;
/*!40000 ALTER TABLE `audit_column_aliases` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `form_generic` (
  ...
  `referral_manifest_code` varchar(64) DEFAULT NULL,
  `sample_reordered` varchar(3) DEFAULT 'no',
  ...
  `lab_name` text,
  `lab_id` int DEFAULT NULL,
  `referred_by_lab_id` int DEFAULT NULL,
  `referred_to_lab_id` int DEFAULT NULL,
  `reason_for_referral` varchar(128) DEFAULT NULL,
  `referred_on_datetime` datetime DEFAULT NULL,
...
CREATE TABLE `form_tb` (
  ...
  `sample_code_format` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `sample_code` varchar(500) DEFAULT NULL,
  `lab_assigned_code` varchar(32) DEFAULT NULL,
  `external_sample_code` varchar(100) DEFAULT NULL,
  `etb_tracker_number` varchar(24) DEFAULT NULL,
  `remote_sample` varchar(1000) NOT NULL DEFAULT 'no',
  `remote_sample_code_key` int DEFAULT NULL,
  `remote_sample_code_format` varchar(16) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `remote_sample_code` varchar(500) DEFAULT NULL,
  `sample_collection_date` datetime NOT NULL,
  `sample_dispatched_datetime` datetime DEFAULT NULL,
  `sample_received_at_hub_datetime` datetime DEFAULT NULL,
  ...
  `is_patient_initiated_on_tb_treatment` enum('yes','no','') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `date_of_treatment_initiation` date DEFAULT NULL,
  `current_regimen` varchar(24) DEFAULT NULL,
  `date_of_initiation_of_current_regimen` date DEFAULT NULL,
  `risk_factors` json DEFAULT NULL,
  `risk_factor_other` varchar(36) DEFAULT NULL,
  `is_specimen_reordered` enum('yes','no','') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `previously_treated_for_tb` text,
  `tests_requested` varchar(512) DEFAULT NULL,
  ...
  `referred_on_datetime` datetime DEFAULT NULL,
  `referred_by` varchar(128) DEFAULT NULL,
  `affiliated_lab_id` int DEFAULT NULL,
  `affiliated_district_hospital` varchar(255) DEFAULT NULL,
  ...
  `result_status` int DEFAULT NULL,
  `locked` varchar(256) DEFAULT 'no',
  `is_result_finalized` enum('no','yes','') NOT NULL DEFAULT 'no',
  `result` mediumtext,
  `xpert_mtb_result` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `tb_lam_result` varchar(64) DEFAULT NULL,
...
CREATE TABLE `form_vl` (
  ...
  `first_line` varchar(32) DEFAULT NULL,
  `second_line` varchar(32) DEFAULT NULL,
  `vl_result_category` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `vldash_sync` int DEFAULT '0',
  `source_of_request` text,
  `source_data_dump` text,
  `result_sent_to_source` varchar(10) DEFAULT 'pending',
  ...
  KEY `implementing_partner` (`implementing_partner`),
  KEY `reason_for_sample_rejection` (`reason_for_sample_rejection`),
  KEY `idx_vl_result_category_status` (`vl_result_category`,`result_status`),
  KEY `idx_sample_code_facility` (`sample_code`,`facility_id`),
  KEY `idx_result_pulled_via_api` (`result_pulled_via_api_datetime`),
...
--
-- Table structure for table `generic_referral_history`
--

DROP TABLE IF EXISTS `generic_referral_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `generic_referral_history`
--

LOCK TABLES `generic_referral_history` WRITE;
/*!40000 ALTER TABLE `generic_referral_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `generic_referral_history` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `generic_test_result_units_map` (
  ...
  CONSTRAINT `generic_test_result_units_map_ibfk_3` FOREIGN KEY (`test_type_id`) REFERENCES `r_test_types` (`test_type_id`),
  CONSTRAINT `generic_test_result_units_map_ibfk_4` FOREIGN KEY (`unit_id`) REFERENCES `r_generic_test_result_units` (`unit_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `global_config` VALUES ('Allow Remote Upgrade','allow_remote_upgrade','yes',NULL,'general','yes','2026-08-26 18:07:36',NULL,'active'),('Enforce API facility scope (vs observe-only)','api_facility_scope_enforce','no',NULL,'api','no','2025-11-18 13:16:51',NULL,'active'),('Skip Unchanged API Updates (no/shadow/yes)','api_skip_unchanged_updates','no',NULL,'general',NULL,NULL,NULL,'active'),('App Locale/Language','app_locale','en_EN',NULL,'common','no','2025-11-18 13:16:51',NULL,'active'),('App Menu Name','app_menu_name','VLSM',NULL,'app','no','2025-11-18 13:16:51',NULL,'active'),('Auto Approval','auto_approval','yes',NULL,'general','no','2025-11-18 13:16:51',NULL,'inactive'),('Auto Approve Interface Results','auto_approve_interface_results','yes',NULL,'interfacing','yes','2025-11-18 13:16:51',NULL,'active'),('Backup Encryption Enabled','backup_encryption_enabled','no',NULL,'backup','yes','2026-08-26 18:07:37',NULL,'active'),('Backup Key Recovery Enabled','backup_key_recovery_enabled','no',NULL,'backup','yes','2026-08-26 18:07:37',NULL,'active'),('Barcode Printing','bar_code_printing','off',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Barcode Format','barcode_format','C39',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Batch Pdf Layout','batch_pdf_layout','standard',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Copy Request On Save and Next Form','cd4_copy_request_save_and_next','no',NULL,'cd4','yes','2025-11-18 13:16:51',NULL,'active'),('Minimum Patient ID Length','cd4_min_patient_id_length','',NULL,'cd4','no','2025-11-18 13:16:51',NULL,'active'),('CD4 Sample Code Format','cd4_sample_code','MMYY',NULL,'cd4','no','2025-11-18 13:16:51',NULL,'active'),('CD4 Sample Code Prefix','cd4_sample_code_prefix','CD4',NULL,'cd4','no','2025-11-18 13:16:51',NULL,'active'),('Show Participant Name in Manifest','cd4_show_participant_name_in_manifest','yes',NULL,'CD4','no','2025-11-18 13:16:51',NULL,'active'),('COVID-19 Auto Approve API Results','covid19_auto_approve_api_results','no',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Copy Request On Save and Next Form','covid19_copy_request_save_and_next','no',NULL,'covid19','yes','2025-11-18 13:16:51',NULL,'active'),('Generate Patient Code','covid19_generate_patient_code','no',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Minimum Patient ID Length','covid19_min_patient_id_length',NULL,NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Patient Code Prefix','covid19_patient_code_prefix','P',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Positive Confirmatory Tests Required By Central Lab','covid19_positive_confirmatory_tests_required_by_central_lab','yes',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('COVID-19 Report QR Code','covid19_report_qr_code','no',NULL,NULL,'no','2025-11-18 13:16:51',NULL,'active'),('Report Type','covid19_report_type','default',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Covid-19 Sample Code Format','covid19_sample_code','MMYY',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Covid-19 Sample Code Prefix','covid19_sample_code_prefix','C19',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Show Participant Name in Manifest','covid19_show_participant_name_in_manifest','yes',NULL,'COVID19','no','2025-11-18 13:16:51',NULL,'active'),('Covid19 Tests Table in Results Pdf','covid19_tests_table_in_results_pdf','no',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Data Sync Interval','data_sync_interval','30',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('CSV Delimiter','default_csv_delimiter',',',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('CSV Enclosure','default_csv_enclosure','\"',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Default Phone Prefix','default_phone_prefix',NULL,NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Default Time Zone','default_time_zone','UTC',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Display Encrypt PII Option','display_encrypt_pii_option','no',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Edit Profile','edit_profile','yes',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('EID Auto Approve API Results','eid_auto_approve_api_results','no',NULL,'eid','no','2025-11-18 13:16:51',NULL,'active'),('Copy Request On Save and Next Form','eid_copy_request_save_and_next','no',NULL,'eid','yes','2025-11-18 13:16:51',NULL,'active'),('Minimum Patient ID Length','eid_min_patient_id_length',NULL,NULL,'eid','no','2025-11-18 13:16:51',NULL,'active'),('EID Report QR Code','eid_report_qr_code','yes',NULL,'EID','no','2025-11-18 13:16:51',NULL,'active'),('EID Sample Code','eid_sample_code','MMYY',NULL,'eid','no','2025-11-18 13:16:51',NULL,'active'),('EID Sample Code Prefix','eid_sample_code_prefix','EID',NULL,'eid','no','2025-11-18 13:16:51',NULL,'active'),('Show Participant Name in Manifest','eid_show_participant_name_in_manifest','yes',NULL,'EID','no','2025-11-18 13:16:51',NULL,'active'),('Enable Duplicate Detection','enable_duplicate_detection','yes',NULL,'general',NULL,NULL,NULL,'active'),('Enable QR Code Mechanism','enable_qr_mechanism','no',NULL,'general','no','2025-11-18 13:16:51',NULL,'inactive'),('Copy Request On Save and Next Form','generic_copy_request_save_and_next','no',NULL,'generic-tests','yes','2025-11-18 13:16:51',NULL,'active'),('Minimum Patient ID Length','generic_min_patient_id_length',NULL,NULL,'generic','no','2025-11-18 13:16:51',NULL,'active'),('Generic Sample Code Format','generic_sample_code','MMYY',NULL,'generic-tests','yes','2025-11-18 13:16:51',NULL,'active'),('Show Participant Name in Custom tests Manifest','generic_show_participant_name_in_manifest',NULL,NULL,'generic-tests','yes','2025-11-18 13:16:51',NULL,'active'),('Other Tests Table in Results Pdf','generic_tests_table_in_results_pdf','no',NULL,'generic-tests','yes','2025-11-18 13:16:51',NULL,'active'),('Date Format','gui_date_format','d-M-Y',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Result PDF High Viral Load Message','h_vl_msg','',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Header','header','MINISTRY OF HEALTH',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Copy Request On Save and Next Form','hepatitis_copy_request_save_and_next','no',NULL,'hepatitis','yes','2025-11-18 13:16:51',NULL,'active'),('Minimum Patient ID Length','hepatitis_min_patient_id_length',NULL,NULL,'hepatitis','no','2025-11-18 13:16:51',NULL,'active'),('Hepatitis Report QR Code','hepatitis_report_qr_code','yes',NULL,NULL,NULL,'2025-11-18 13:16:51',NULL,'active'),('Hepatitis Sample Code Format','hepatitis_sample_code','MMYY',NULL,'hepatitis','no','2025-11-18 13:16:51',NULL,'active'),('Hepatitis Sample Code Prefix','hepatitis_sample_code_prefix','HEP',NULL,'hepatitis','no','2025-11-18 13:16:51',NULL,'active'),('Show Participant Name in Manifest','hepatitis_show_participant_name_in_manifest','yes',NULL,'HEPATITIS','no','2025-11-18 13:16:51',NULL,'active'),('Import Non matching Sample Results from Machine generated file','import_non_matching_sample','no',NULL,'general','yes','2026-08-26 18:07:38',NULL,'active'),('Instance Type ','instance_type','Both',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Interface API Enabled','interface_api_enabled','no',NULL,'interfacing','no',NULL,NULL,'active'),('Key','key',NULL,NULL,'general','yes','2025-11-18 13:16:51',NULL,'active'),('Result PDF Low Viral Load Message','l_vl_msg','',NULL,'vl','yes','2025-11-18 13:16:51',NULL,'active'),('Lock Approved Covid-19 Samples','lock_approved_covid19_samples','no',NULL,'covid19','no','2025-11-18 13:16:51',NULL,'active'),('Lock Approved EID Samples','lock_approved_eid_samples','no',NULL,'eid','no','2025-11-18 13:16:51',NULL,'active'),('Lock Approved TB Samples','lock_approved_tb_samples','no',NULL,'tb','no','2025-11-18 13:16:51',NULL,'active'),('Lock approved VL Samples','lock_approved_vl_samples','no',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Logo','logo',NULL,NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Low Viral Load (text results)','low_vl_text_results','Target Not Detected, TND, < 20, < 40',NULL,'vl','yes','2025-11-18 13:16:51',NULL,'active'),('Manager Email','manager_email','',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Maximum Length','max_length','',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Maximum Length of Phone Number','max_phone_length',NULL,NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Minimum Length','min_length','',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Minimum Length of Phone Number','min_phone_length',NULL,NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Patient Name in Result PDF','patient_name_pdf','flname',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Result PDF Mandatory Fields','r_mandatory_fields',NULL,NULL,'vl','yes','2025-11-18 13:16:51',NULL,'active'),('Remote Commands Enabled','remote_commands_enabled','yes',NULL,'general','yes','2026-08-26 18:07:36',NULL,'active'),('Result PDF Report Format','report_format',NULL,NULL,'general','yes','2025-11-18 13:16:51',NULL,'active'),('Sample Code','sample_code','MMYY',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Sample Code Prefix','sample_code_prefix','VL',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Sample Expiry After Days','sample_expiry_after_days','365',NULL,NULL,'no','2025-11-18 13:16:51',NULL,'active'),('Sample Lock After Days','sample_lock_after_days','14',NULL,NULL,'no','2025-11-18 13:16:51',NULL,'active'),('Sample Type','sample_type','enabled',NULL,NULL,'no','2025-11-18 13:16:51',NULL,'active'),('Patient ART No. Date','show_date','no',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Do you want to show emoticons on the result pdf?','show_smiley','yes',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Smart Connect Enrollment Key','smart_connect_enrollment_key','',NULL,'general','yes','2026-08-26 18:07:38',NULL,'active'),('Support Email','support_email','',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('TB Auto Approve API Results','tb_auto_approve_api_results','no',NULL,'tb','no','2025-11-18 13:16:51',NULL,'active'),('Copy Request On Save and Next Form','tb_copy_request_save_and_next','no',NULL,'tb','yes','2025-11-18 13:16:51',NULL,'active'),('Minimum Patient ID Length','tb_min_patient_id_length',NULL,NULL,'tb','no','2025-11-18 13:16:51',NULL,'active'),('TB Sample Code Format','tb_sample_code','MMYY',NULL,'tb','no','2025-11-18 13:16:51',NULL,'active'),('TB Sample Code Prefix','tb_sample_code_prefix','TB',NULL,'tb','no','2025-11-18 13:16:51',NULL,'active'),('Show Participant Name in Manifest','tb_show_participant_name_in_manifest','yes',NULL,'TB','no','2025-11-18 13:16:51',NULL,'active'),('Testing Status','testing_status','enabled',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Training Mode','training_mode','no',NULL,'common','no','2025-11-18 13:16:51',NULL,'active'),('Training Mode Text','training_mode_text','TRAINING SERVER',NULL,'common','no','2025-11-18 13:16:51',NULL,'active'),('Same user can Review and Approve','user_review_approve','yes',NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Viral Load Threshold Limit','viral_load_threshold_limit','1000',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('VL Auto Approve API Results','vl_auto_approve_api_results','no',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Copy Request On Save and Next Form','vl_copy_request_save_and_next','no',NULL,'vl','yes','2025-11-18 13:16:51',NULL,'active'),('Display VL Log Result','vl_display_log_result','yes',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Display VL Log Result','vl_display_page_no_in_footer','yes',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Display VL Log Result','vl_display_signature_table','yes',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Viral Load Export Format','vl_excel_export_format','default',NULL,'VL','no','2025-11-18 13:16:51',NULL,'active'),('Viral Load Form','vl_form',NULL,NULL,'general','no','2025-11-18 13:16:51',NULL,'active'),('Interpret and Convert VL Results','vl_interpret_and_convert_results','no',NULL,'VL','yes','2025-11-18 13:16:51',NULL,'active'),('VL Lab','vl_lab_id','',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Minimum Patient ID Length','vl_min_patient_id_length',NULL,NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('VL Monthly Target','vl_monthly_target','no',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('VL Report QR Code','vl_report_qr_code','yes',NULL,'vl','no','2025-11-18 13:16:51',NULL,'active'),('Show Participant Name in Manifest','vl_show_participant_name_in_manifest','yes',NULL,'VL','no','2025-11-18 13:16:51',NULL,'active'),('Vldashboard Url','vldashboard_url',NULL,NULL,'general','yes','2025-11-18 13:16:51',NULL,'active');
...
--
-- Table structure for table `instrument_activity_log`
--

DROP TABLE IF EXISTS `instrument_activity_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `instrument_activity_log` (
  ...
  `installation_id` char(36) DEFAULT NULL COMMENT 'Identity this server assigned at activation, not the tool own source identifier; null when the installation is unknown here',
  `received_via` varchar(16) NOT NULL DEFAULT 'api' COMMENT 'api, importer or relay',
  ...
  UNIQUE KEY `uniq_instrument_activity_lab_event` (`lab_id`,`event_uid`),
...
--
-- Dumping data for table `instrument_activity_log`
--

LOCK TABLES `instrument_activity_log` WRITE;
/*!40000 ALTER TABLE `instrument_activity_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `instrument_activity_log` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `instrument_usage_statistics_daily`
--

DROP TABLE IF EXISTS `instrument_usage_statistics_daily`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `instrument_usage_statistics_daily` (
  ...
  `first_test_at` datetime DEFAULT NULL,
...
--
-- Dumping data for table `instrument_usage_statistics_daily`
--

LOCK TABLES `instrument_usage_statistics_daily` WRITE;
/*!40000 ALTER TABLE `instrument_usage_statistics_daily` DISABLE KEYS */;
/*!40000 ALTER TABLE `instrument_usage_statistics_daily` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `interface_activation_codes`
--

DROP TABLE IF EXISTS `interface_activation_codes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `interface_activation_codes` (
  `activation_code_id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `code_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin NOT NULL,
  `facility_id` int NOT NULL,
  `purpose` varchar(16) NOT NULL DEFAULT 'new',
  `target_installation_id` char(36) DEFAULT NULL,
  `expires_at` datetime NOT NULL,
  `used_at` datetime DEFAULT NULL,
  `used_by_installation_id` char(36) DEFAULT NULL,
...
--
-- Dumping data for table `interface_activation_codes`
--

LOCK TABLES `interface_activation_codes` WRITE;
/*!40000 ALTER TABLE `interface_activation_codes` DISABLE KEYS */;
/*!40000 ALTER TABLE `interface_activation_codes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `interface_installations`
--

DROP TABLE IF EXISTS `interface_installations`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `interface_installations` (
  `installation_id` char(36) NOT NULL,
  `source_installation_id` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `facility_id` int NOT NULL,
  `display_name` varchar(150) NOT NULL,
  `credential_hash` char(64) CHARACTER SET ascii COLLATE ascii_bin DEFAULT NULL,
  `credential_scopes` json DEFAULT NULL,
...
--
-- Dumping data for table `interface_installations`
--

LOCK TABLES `interface_installations` WRITE;
/*!40000 ALTER TABLE `interface_installations` DISABLE KEYS */;
/*!40000 ALTER TABLE `interface_installations` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `lab_storage_history`
--

LOCK TABLES `lab_storage_history` WRITE;
/*!40000 ALTER TABLE `lab_storage_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `lab_storage_history` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `queue_sample_code_generation`
--

LOCK TABLES `queue_sample_code_generation` WRITE;
/*!40000 ALTER TABLE `queue_sample_code_generation` DISABLE KEYS */;
/*!40000 ALTER TABLE `queue_sample_code_generation` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `r_covid19_sample_rejection_reasons` VALUES (1,'Poorly labelled specimen','general','active','Gen_PLSP','2022-02-18 16:25:07',0,NULL),(2,'Mismatched sample and form labeling','general','active','Gen_MMSP','2022-02-18 16:25:07',0,NULL),(3,'Missing labels on container or tracking form','general','active','Gen_MLTS','2022-02-18 16:25:07',0,NULL),(4,'Sample without request forms/Tracking forms','general','active','Gen_SMRT','2022-02-18 16:25:07',0,NULL),(5,'Name/Information of requester is missing','general','active','Gen_NIRM','2022-02-18 16:25:07',0,NULL),(6,'Missing information on request form - Age','general','active','Gen_MIRA','2022-02-18 16:25:07',0,NULL),(7,'Missing information on request form - Sex','general','active','Gen_MIRS','2022-02-18 16:25:07',0,NULL),(8,'Missing information on request form - Sample Collection Date','general','active','Gen_MIRD','2022-02-18 16:25:07',0,NULL),(9,'Missing information on request form - ART No','general','active','Gen_MIAN','2022-02-18 16:25:07',0,NULL),(10,'Inappropriate specimen packing','general','active','Gen_ISPK','2022-02-18 16:25:07',0,NULL),(11,'Inappropriate specimen for test request','general','active','Gen_ISTR','2022-02-18 16:25:07',0,NULL),(12,'Form received without Sample','general','active','Gen_NoSample','2022-02-18 16:25:07',0,NULL),(13,'VL Machine Flag','testing','active','FLG_','2022-02-18 16:25:07',0,NULL),(14,'CNTRL_FAIL','testing','active','FLG_AL00','2022-02-18 16:25:07',0,NULL),(15,'SYS_ERROR','testing','active','FLG_TM00','2022-02-18 16:25:07',0,NULL),(16,'A/D_ABORT','testing','active','FLG_TM17','2022-02-18 16:25:07',0,NULL),(17,'KIT_EXPIRY','testing','active','FLG_TMAP','2022-02-18 16:25:07',0,NULL),(18,'RUN_EXPIRY','testing','active','FLG_TM19','2022-02-18 16:25:07',0,NULL),(19,'DATA_ERROR','testing','active','FLG_TM20','2022-02-18 16:25:07',0,NULL),(20,'NC_INVALID','testing','active','FLG_TM24','2022-02-18 16:25:07',0,NULL),(21,'LPCINVALID','testing','active','FLG_TM25','2022-02-18 16:25:07',0,NULL),(22,'MPCINVALID','testing','active','FLG_TM26','2022-02-18 16:25:07',0,NULL),(23,'HPCINVALID','testing','active','FLG_TM27','2022-02-18 16:25:07',0,NULL),(24,'S_INVALID','testing','active','FLG_TM29','2022-02-18 16:25:07',0,NULL),(25,'MATH_ERROR','testing','active','FLG_TM31','2022-02-18 16:25:07',0,NULL),(26,'PRECHECK','testing','active','FLG_TM44 ','2022-02-18 16:25:07',0,NULL),(27,'QS_INVALID','testing','active','FLG_TM50','2022-02-18 16:25:07',0,NULL),(28,'POSTCHECK','testing','active','FLG_TM51','2022-02-18 16:25:07',0,NULL),(29,'REAG_ERROR','testing','active','FLG_AP02 ','2022-02-18 16:25:07',0,NULL),(30,'NO_SAMPLE','testing','active','FLG_AP12','2022-02-18 16:25:07',0,NULL),(31,'DISP_ERROR','testing','active','FLG_AP13 ','2022-02-18 16:25:07',0,NULL),(32,'TEMP_RANGE','testing','active','FLG_AP19 ','2022-02-18 16:25:07',0,NULL),(33,'PREP_ABORT','testing','active','FLG_AP24','2022-02-18 16:25:07',0,NULL),(34,'SAMPLECLOT','testing','active','FLG_AP25','2022-02-18 16:25:07',0,NULL);
...
INSERT INTO `r_eid_sample_rejection_reasons` VALUES (1,'Poorly labelled specimen','general','active','Gen_PLSP','2022-02-18 16:25:07',0,NULL),(2,'Mismatched sample and form labeling','general','active','Gen_MMSP','2022-02-18 16:25:07',0,NULL),(3,'Missing labels on container or tracking form','general','active','Gen_MLTS','2022-02-18 16:25:07',0,NULL),(4,'Sample without request forms/Tracking forms','general','active','Gen_SMRT','2022-02-18 16:25:07',0,NULL),(5,'Name/Information of requester is missing','general','active','Gen_NIRM','2022-02-18 16:25:07',0,NULL),(6,'Missing information on request form - Age','general','active','Gen_MIRA','2022-02-18 16:25:07',0,NULL),(7,'Missing information on request form - Sex','general','active','Gen_MIRS','2022-02-18 16:25:07',0,NULL),(8,'Missing information on request form - Sample Collection Date','general','active','Gen_MIRD','2022-02-18 16:25:07',0,NULL),(9,'Missing information on request form - ART No','general','active','Gen_MIAN','2022-02-18 16:25:07',0,NULL),(10,'Inappropriate specimen packing','general','active','Gen_ISPK','2022-02-18 16:25:07',0,NULL),(11,'Inappropriate specimen for test request','general','active','Gen_ISTR','2022-02-18 16:25:07',0,NULL),(12,'Wrong container/anticoagulant used','whole blood','active','BLD_WCAU','2022-02-18 16:25:07',0,NULL),(13,'EDTA tube specimens that arrived hemolyzed','whole blood','active','BLD_HMLY','2022-02-18 16:25:07',0,NULL),(14,'ETDA tube that arrives more than 24 hours after specimen collection','whole blood','active','BLD_AASC','2022-02-18 16:25:07',0,NULL),(15,'Plasma that arrives at a temperature above 8 C','plasma','active','PLS_AATA','2022-02-18 16:25:07',0,NULL),(16,'Plasma tube contain less than 1.5 mL','plasma','active','PSL_TCLT','2022-02-18 16:25:07',0,NULL),(17,'DBS cards with insufficient blood spots','dbs','active','DBS_IFBS','2022-02-18 16:25:07',0,NULL),(18,'DBS card with clotting present in spots','dbs','active','DBS_CPIS','2022-02-18 16:25:07',0,NULL),(19,'DBS cards that have serum rings indicating contamination around spots','dbs','active','DBS_SRIC','2022-02-18 16:25:07',0,NULL),(20,'VL Machine Flag','testing','active','FLG_','2022-02-18 16:25:07',0,NULL),(21,'CNTRL_FAIL','testing','active','FLG_AL00','2022-02-18 16:25:07',0,NULL),(22,'SYS_ERROR','testing','active','FLG_TM00','2022-02-18 16:25:07',0,NULL),(23,'A/D_ABORT','testing','active','FLG_TM17','2022-02-18 16:25:07',0,NULL),(24,'KIT_EXPIRY','testing','active','FLG_TMAP','2022-02-18 16:25:07',0,NULL),(25,'RUN_EXPIRY','testing','active','FLG_TM19','2022-02-18 16:25:07',0,NULL),(26,'DATA_ERROR','testing','active','FLG_TM20','2022-02-18 16:25:07',0,NULL),(27,'NC_INVALID','testing','active','FLG_TM24','2022-02-18 16:25:07',0,NULL),(28,'LPCINVALID','testing','active','FLG_TM25','2022-02-18 16:25:07',0,NULL),(29,'MPCINVALID','testing','active','FLG_TM26','2022-02-18 16:25:07',0,NULL),(30,'HPCINVALID','testing','active','FLG_TM27','2022-02-18 16:25:07',0,NULL),(31,'S_INVALID','testing','active','FLG_TM29','2022-02-18 16:25:07',0,NULL),(32,'MATH_ERROR','testing','active','FLG_TM31','2022-02-18 16:25:07',0,NULL),(33,'PRECHECK','testing','active','FLG_TM44 ','2022-02-18 16:25:07',0,NULL),(34,'QS_INVALID','testing','active','FLG_TM50','2022-02-18 16:25:07',0,NULL),(35,'POSTCHECK','testing','active','FLG_TM51','2022-02-18 16:25:07',0,NULL),(36,'REAG_ERROR','testing','active','FLG_AP02 ','2022-02-18 16:25:07',0,NULL),(37,'NO_SAMPLE','testing','active','FLG_AP12','2022-02-18 16:25:07',0,NULL),(38,'DISP_ERROR','testing','active','FLG_AP13 ','2022-02-18 16:25:07',0,NULL),(39,'TEMP_RANGE','testing','active','FLG_AP19 ','2022-02-18 16:25:07',0,NULL),(40,'PREP_ABORT','testing','active','FLG_AP24','2022-02-18 16:25:07',0,NULL),(41,'SAMPLECLOT','testing','active','FLG_AP25','2022-02-18 16:25:07',0,NULL),(42,'Form received without Sample','general','active','Gen_NoSample','2022-02-18 16:25:07',0,NULL);
...
INSERT INTO `r_hepatitis_results` VALUES (1,'Indeterminate','active','2021-02-18 00:00:00',0),(2,'Negative','active','2021-02-18 00:00:00',0),(3,'Positive','active','2021-02-18 00:00:00',0);
...
INSERT INTO `r_hepatitis_sample_rejection_reasons` VALUES (1,'Poorly labelled specimen','general','active','Gen_PLSP','2021-02-22 15:27:49',0,NULL),(2,'Mismatched sample and form labeling','general','active','Gen_MMSP','2021-02-22 15:27:49',0,NULL),(3,'Missing labels on container or tracking form','general','active','Gen_MLTS','2021-02-22 15:27:49',0,NULL),(4,'Sample without request forms/Tracking forms','general','active','Gen_SMRT','2021-02-22 15:27:49',0,NULL),(5,'Name/Information of requester is missing','general','active','Gen_NIRM','2021-02-22 15:27:49',0,NULL),(6,'Missing information on request form - Age','general','active','Gen_MIRA','2021-02-22 15:27:49',0,NULL),(7,'Missing information on request form - Sex','general','active','Gen_MIRS','2021-02-22 15:27:49',0,NULL),(8,'Missing information on request form - Sample Collection Date','general','active','Gen_MIRD','2021-02-22 15:27:49',0,NULL),(9,'Missing information on request form - ART No','general','active','Gen_MIAN','2021-02-22 15:27:49',0,NULL),(10,'Inappropriate specimen packing','general','active','Gen_ISPK','2021-02-22 15:27:49',0,NULL),(11,'Inappropriate specimen for test request','general','active','Gen_ISTR','2021-02-22 15:27:49',0,NULL),(42,'Form received without Sample','general','active','Gen_NoSample','2021-02-22 15:27:49',0,NULL);
...
--
-- Dumping data for table `r_reasons_for_sample_removal`
--

LOCK TABLES `r_reasons_for_sample_removal` WRITE;
/*!40000 ALTER TABLE `r_reasons_for_sample_removal` DISABLE KEYS */;
/*!40000 ALTER TABLE `r_reasons_for_sample_removal` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `r_tb_results` VALUES (1,'Positive',NULL,'active','2021-11-16 15:23:42',0),(2,'Negative',NULL,'active','2021-11-16 15:23:42',0),(3,'Negative','lam','active','2021-11-16 15:25:26',0),(4,'Positive','lam','active','2021-11-16 15:25:26',0),(5,'Invalid','lam','active','2021-11-16 15:25:26',0),(6,'N (MTB not detected)','x-pert','active','2021-11-16 15:25:26',0),(7,'T (MTB detected rifampicin resistance not detected)','x-pert','active','2021-11-16 15:25:26',0),(8,'TI (MTB detected rifampicin resistance indeterminate)','x-pert','active','2021-11-16 15:25:26',0),(9,'RR (MTB detected rifampicin resistance detected)','lam','active','2021-11-16 15:25:26',0),(10,'TT (MTB detected (Trace) rifampicin resistance indeterminate)','x-pert','active','2021-11-16 15:25:26',0),(11,'I (Invalid/Error/No result)','x-pert','active','2021-11-16 15:25:26',0),(12,'No growth after 6 weeks','culture','active','2025-08-18 15:26:35',0),(13,'Positive for AFB','culture','active','2025-08-18 15:26:35',0),(14,'Contaminated','culture','active','2025-08-18 15:26:35',0),(15,'MTBC','identification','active','2025-08-18 15:26:35',0),(16,'NTM','identification','active','2025-08-18 15:26:35',0),(17,'Streptomycin','drugMGIT','active','2025-08-18 15:26:35',0),(18,'Isonaizid','drugMGIT','active','2025-08-18 15:26:35',0),(19,'Rifampicin','drugMGIT','active','2025-08-18 15:26:35',0),(20,'Ethambutol','drugMGIT','active','2025-08-18 15:26:35',0),(21,'PZA','drugMGIT','active','2025-08-18 15:26:35',0),(22,'RIF(rpoB)','drugLPA','active','2025-08-18 15:26:35',0),(23,'INH(katG)','drugLPA','active','2025-08-18 15:26:35',0),(24,'INH(inhA)','drugLPA','active','2025-08-18 15:26:35',0),(25,'FLQ(gyrA)','drugLPA','active','2025-08-18 15:26:35',0),(26,'FLQ(gyrB)','drugLPA','active','2025-08-18 15:26:35',0),(27,'AG/CP(rrs)','drugLPA','active','2025-08-18 15:26:35',0),(28,'LL Kana(eis)','drugLPA','active','2025-08-18 15:26:35',0);
...
INSERT INTO `r_tb_sample_rejection_reasons` VALUES (1,'Sample damaged','general','active',NULL,'2021-11-16 15:23:42',0,NULL);
...
--
-- Table structure for table `r_test_failure_reasons`
--

DROP TABLE IF EXISTS `r_test_failure_reasons`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `r_test_failure_reasons` (
...
--
-- Dumping data for table `r_test_failure_reasons`
--

LOCK TABLES `r_test_failure_reasons` WRITE;
/*!40000 ALTER TABLE `r_test_failure_reasons` DISABLE KEYS */;
INSERT INTO `r_test_failure_reasons` VALUES (1,'instrument-error','Instrument error',NULL,'active','2026-08-26 18:07:38',0),(2,'invalid-control','Control failed / out of range',NULL,'active','2026-08-26 18:07:38',0),(3,'insufficient-volume','Insufficient sample volume',NULL,'active','2026-08-26 18:07:38',0),(4,'sample-quality','Poor sample quality',NULL,'active','2026-08-26 18:07:38',0),(5,'reagent-kit-issue','Reagent or kit issue',NULL,'active','2026-08-26 18:07:38',0),(6,'expired-reagent','Expired reagent or kit',NULL,'active','2026-08-26 18:07:38',0),(7,'power-interruption','Power interruption during run',NULL,'active','2026-08-26 18:07:38',0),(8,'operator-error','Operator error',NULL,'active','2026-08-26 18:07:38',0),(9,'contamination','Suspected contamination',NULL,'active','2026-08-26 18:07:38',0),(10,'no-amplification','No amplification',NULL,'active','2026-08-26 18:07:38',0),(11,'indeterminate-result','Indeterminate or inconclusive result',NULL,'active','2026-08-26 18:07:38',0),(12,'sample-mix-up','Sample mix-up or labelling error',NULL,'active','2026-08-26 18:07:38',0),(13,'other','Other',NULL,'active','2026-08-26 18:07:38',0);
/*!40000 ALTER TABLE `r_test_failure_reasons` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `r_test_types` (
  ...
  `test_type_uuid` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  ...
  UNIQUE KEY `idx_r_test_types_uuid` (`test_type_uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_vl_art_regimen` VALUES (1,'1a = TDF+3TC+DTG',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(2,'1b = TDF+3TC+EFV',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(3,'1c = ABC+3TC+EFV',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(4,'1d = ABC+3TC+NVP',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(5,'1e = TDF+3TC+NVP',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(6,'1f = ABC+3TC+DTG',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(7,'1g = AZT+3TC+EFV',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(8,'1h = AZT+3TC+NVP',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(9,'2a = AZT+3TC+ATV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(10,'2b = AZT+3TC+LPV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(11,'2c = AZT+3TC+DTG',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(12,'2d = TDF+3TC+ATV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(13,'2e = TDF+3TC+LPV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(14,'2f = ABC+3TC+ATV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(15,'2g = ABC+3TC+LPV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(16,'3a = RAL+ETV+DRV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(17,'4a = ABC+3TC+LPV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(18,'4b = ABC+3TC+EFV',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(19,'4c = AZT+3TC+LPV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(20,'4d = AZT+3TC+EFV',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(21,'4e = TDF+3TC+EFV',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(22,'4f = ABC+3TC+NVP',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(23,'4g = AZT+3TC+NVP',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(24,'5a = AZT+3TC+RAL',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(25,'5b = ABC+3TC+RAL',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(26,'5c = AZT+3TC+LPV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(27,'5d = ABC+3TC+LPV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0),(28,'5e = AZT + 3TC+ ATV/r',0,NULL,'active',NULL,'2025-11-18 13:19:25',0);
/*!40000 ALTER TABLE `r_vl_art_regimen` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `r_vl_art_regimen_alias`
--

DROP TABLE IF EXISTS `r_vl_art_regimen_alias`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `r_vl_art_regimen_alias` (
  ...
  `mapped_by` varchar(50) DEFAULT NULL,
  `updated_datetime` datetime DEFAULT NULL,
...
--
-- Dumping data for table `r_vl_art_regimen_alias`
--

LOCK TABLES `r_vl_art_regimen_alias` WRITE;
/*!40000 ALTER TABLE `r_vl_art_regimen_alias` DISABLE KEYS */;
/*!40000 ALTER TABLE `r_vl_art_regimen_alias` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `r_vl_sample_rejection_reasons` VALUES (1,'Poorly labelled specimen','general','active','Gen_PLSP','2022-02-18 16:25:07',1,NULL),(2,'Mismatched sample and form labeling','general','active','Gen_MMSP','2022-02-18 16:25:07',1,NULL),(3,'Missing labels on container or tracking form','general','active','Gen_MLTS','2022-02-18 16:25:07',1,NULL),(4,'Sample without request forms/Tracking forms','general','active','Gen_SMRT','2022-02-18 16:25:07',1,NULL),(5,'Name/Information of requester is missing','general','active','Gen_NIRM','2022-02-18 16:25:07',1,NULL),(6,'Missing information on request form - Age','general','active','Gen_MIRA','2022-02-18 16:25:07',1,NULL),(7,'Missing information on request form - Sex','general','active','Gen_MIRS','2022-02-18 16:25:07',1,NULL),(8,'Missing information on request form - Sample Collection Date','general','active','Gen_MIRD','2022-02-18 16:25:07',1,NULL),(9,'Missing information on request form - ART No','general','active','Gen_MIAN','2022-02-18 16:25:07',1,NULL),(10,'Inappropriate specimen packing','general','active','Gen_ISPK','2022-02-18 16:25:07',1,NULL),(11,'Inappropriate specimen for test request','general','active','Gen_ISTR','2022-02-18 16:25:07',1,NULL),(12,'Wrong container/anticoagulant used','whole blood','active','BLD_WCAU','2022-02-18 16:25:07',1,NULL),(13,'EDTA tube specimens that arrived hemolyzed','whole blood','active','BLD_HMLY','2022-02-18 16:25:07',1,NULL),(14,'ETDA tube that arrives more than 24 hours after specimen collection','whole blood','active','BLD_AASC','2022-02-18 16:25:07',1,NULL),(15,'Plasma that arrives at a temperature above 8 C','plasma','active','PLS_AATA','2022-02-18 16:25:07',1,NULL),(16,'Plasma tube contain less than 1.5 mL','plasma','active','PSL_TCLT','2022-02-18 16:25:07',1,NULL),(17,'DBS cards with insufficient blood spots','dbs','active','DBS_IFBS','2022-02-18 16:25:07',1,NULL),(18,'DBS card with clotting present in spots','dbs','active','DBS_CPIS','2022-02-18 16:25:07',1,NULL),(19,'DBS cards that have serum rings indicating contamination around spots','dbs','active','DBS_SRIC','2022-02-18 16:25:07',1,NULL),(20,'VL Machine Flag','testing','active','FLG_','2022-02-18 16:25:07',1,NULL),(21,'CNTRL_FAIL','testing','active','FLG_AL00','2022-02-18 16:25:07',1,NULL),(22,'SYS_ERROR','testing','active','FLG_TM00','2022-02-18 16:25:07',1,NULL),(23,'A/D_ABORT','testing','active','FLG_TM17','2022-02-18 16:25:07',1,NULL),(24,'KIT_EXPIRY','testing','active','FLG_TMAP','2022-02-18 16:25:07',1,NULL),(25,'RUN_EXPIRY','testing','active','FLG_TM19','2022-02-18 16:25:07',1,NULL),(26,'DATA_ERROR','testing','active','FLG_TM20','2022-02-18 16:25:07',1,NULL),(27,'NC_INVALID','testing','active','FLG_TM24','2022-02-18 16:25:07',1,NULL),(28,'LPCINVALID','testing','active','FLG_TM25','2022-02-18 16:25:07',1,NULL),(29,'MPCINVALID','testing','active','FLG_TM26','2022-02-18 16:25:07',1,NULL),(30,'HPCINVALID','testing','active','FLG_TM27','2022-02-18 16:25:07',1,NULL),(31,'S_INVALID','testing','active','FLG_TM29','2022-02-18 16:25:07',1,NULL),(32,'MATH_ERROR','testing','active','FLG_TM31','2022-02-18 16:25:07',1,NULL),(33,'PRECHECK','testing','active','FLG_TM44 ','2022-02-18 16:25:07',1,NULL),(34,'QS_INVALID','testing','active','FLG_TM50','2022-02-18 16:25:07',1,NULL),(35,'POSTCHECK','testing','active','FLG_TM51','2022-02-18 16:25:07',1,NULL),(36,'REAG_ERROR','testing','active','FLG_AP02 ','2022-02-18 16:25:07',1,NULL),(37,'NO_SAMPLE','testing','active','FLG_AP12','2022-02-18 16:25:07',1,NULL),(38,'DISP_ERROR','testing','active','FLG_AP13 ','2022-02-18 16:25:07',1,NULL),(39,'TEMP_RANGE','testing','active','FLG_AP19 ','2022-02-18 16:25:07',1,NULL),(40,'PREP_ABORT','testing','active','FLG_AP24','2022-02-18 16:25:07',1,NULL),(41,'SAMPLECLOT','testing','active','FLG_AP25','2022-02-18 16:25:07',1,NULL),(42,'Form received without Sample','general','active','Gen_NoSample','2022-02-18 16:25:07',0,NULL);
...
INSERT INTO `r_vl_test_reasons` VALUES (1,'Routine',0,'active','2025-11-18 13:15:40',0),(2,'Confirmation Of Treatment Failure(repeat VL at 3M)',0,'active','2025-11-18 13:15:40',0),(3,'Failure',0,'active','2025-11-18 13:15:40',0),(4,'Immunological failure',0,'active','2025-11-18 13:15:40',0),(5,'Single drug substitution',0,'active','2025-11-18 13:15:40',0),(6,'Pregnant Mother',0,'active','2025-11-18 13:15:40',0),(7,'Lactating Mother',0,'active','2025-11-18 13:15:40',0),(8,'Baseline VL',0,'active','2025-11-18 13:15:40',0),(9999,'recency',0,'active','2025-11-18 13:15:40',0);
...
INSERT INTO `roles` VALUES (1,'Admin','AD','active','testing-lab','/dashboard/index.php'),(2,'Remote Order','REMOTEORDER','active','collection-site','/dashboard/index.php'),(3,'Lab Technician','LABTECH','active','testing-lab','/dashboard/index.php'),(4,'API User','API','active','testing-lab','/dashboard/index.php');
...
INSERT INTO `roles_privileges_map` VALUES (5288,1,183),(5289,1,184),(5290,1,185),(5292,1,208),(5293,1,219),(5294,1,220),(5295,1,224),(5296,1,226),(5297,1,347),(5298,1,348),(5299,1,349),(5300,1,350),(5301,1,351),(5302,1,352),(5303,1,353),(5304,1,354),(5305,1,355),(5306,1,123),(5307,1,124),(5308,1,125),(5309,1,126),(5310,1,127),(5311,1,128),(5312,1,129),(5313,1,131),(5314,1,167),(5315,1,4),(5316,1,5),(5317,1,6),(5323,1,8),(5324,1,9),(5325,1,10),(5326,1,11),(5327,1,25),(5328,1,26),(5329,1,39),(5330,1,28),(5331,1,43),(5332,1,48),(5333,1,49),(5334,1,230),(5335,1,231),(5336,1,232),(5337,1,1),(5338,1,2),(5339,1,3),(5340,1,300),(5341,1,301),(5342,1,130),(5343,1,225),(5344,1,24),(5345,1,191),(5346,1,192),(5347,1,111),(5348,1,112),(5349,1,113),(5350,1,114),(5351,1,100),(5352,1,101),(5353,1,102),(5354,1,105),(5355,1,106),(5356,1,107),(5357,1,122),(5358,1,145),(5359,1,108),(5360,1,109),(5361,1,110),(5362,1,181),(5363,1,182),(5364,1,97),(5365,1,95),(5366,1,96),(5367,1,211),(5368,1,142),(5369,1,180),(5370,1,319),(5371,1,98),(5372,1,99),(5373,1,103),(5374,1,221),(5375,1,222),(5376,1,223),(5377,1,77),(5378,1,78),(5379,1,79),(5380,1,86),(5381,1,87),(5382,1,88),(5383,1,121),(5384,1,144),(5385,1,76),(5386,1,74),(5387,1,75),(5388,1,210),(5389,1,141),(5390,1,91),(5391,1,318),(5392,1,80),(5393,1,84),(5394,1,85),(5395,1,16),(5396,1,17),(5397,1,18),(5398,1,22),(5399,1,23),(5400,1,33),(5401,1,34),(5402,1,40),(5403,1,56),(5404,1,57),(5405,1,59),(5406,1,63),(5407,1,70),(5408,1,143),(5409,1,168),(5410,1,12),(5411,1,13),(5412,1,14),(5413,1,209),(5414,1,140),(5415,1,89),(5416,1,20),(5417,1,21),(5418,1,31),(5419,1,317),(5420,3,4),(5421,3,28),(5422,3,43),(5423,3,48),(5424,3,24),(5425,3,108),(5426,3,181),(5427,3,182),(5428,3,97),(5429,3,95),(5430,3,96),(5431,3,211),(5432,3,180),(5433,3,319),(5434,3,99),(5435,3,77),(5436,3,78),(5437,3,79),(5438,3,76),(5439,3,74),(5440,3,75),(5441,3,210),(5442,3,91),(5443,3,318),(5444,3,80),(5445,3,84),(5446,3,85),(5447,3,16),(5448,3,17),(5449,3,18),(5450,3,22),(5451,3,23),(5452,3,33),(5453,3,34),(5454,3,40),(5455,3,56),(5456,3,57),(5457,3,59),(5458,3,70),(5459,3,12),(5460,3,13),(5461,3,14),(5462,3,209),(5463,3,89),(5464,3,20),(5465,3,21),(5466,3,31),(5467,3,317),(5468,2,24),(5469,2,86),(5470,2,87),(5471,2,88),(5472,2,121),(5473,2,144),(5474,2,76),(5475,2,74),(5476,2,75),(5477,2,210),(5478,2,141),(5479,2,91),(5480,2,80),(5481,2,84),(5482,2,85),(5483,2,22),(5484,2,23),(5485,2,33),(5486,2,34),(5487,2,40),(5488,2,56),(5489,2,57),(5490,2,59),(5491,2,70),(5492,2,12),(5493,2,13),(5494,2,14),(5495,2,209),(5496,2,89),(5497,2,20),(5498,1,436),(5499,1,435),(5500,1,437),(5501,1,441),(5502,1,442),(5503,1,443),(5504,1,444),(5505,1,445),(5506,1,447),(5507,1,446),(5508,1,427),(5509,1,428),(5510,1,430),(5511,1,431),(5512,1,432),(5513,1,433),(5514,1,434),(5515,1,476),(5516,1,429),(5517,1,468),(5518,1,438),(5519,1,439),(5520,1,440),(5521,1,208),(5522,1,224),(5524,1,226),(5525,1,520),(5526,1,184),(5527,1,448),(5528,1,185),(5529,1,449),(5530,1,183),(5531,1,219),(5532,1,493),(5533,1,220),(5534,1,519),(5535,1,236),(5536,1,238),(5537,1,237),(5538,1,243),(5539,1,244),(5540,1,242),(5541,1,241),(5542,1,240),(5543,1,239),(5544,1,101),(5545,1,100),(5546,1,102),(5547,1,112),(5548,1,111),(5549,1,114),(5550,1,113),(5551,1,122),(5552,1,105),(5553,1,106),(5554,1,107),(5555,1,145),(5556,1,125),(5557,1,128),(5558,1,124),(5559,1,127),(5560,1,123),(5561,1,126),(5562,1,129),(5563,1,180),(5564,1,109),(5565,1,95),(5566,1,181),(5567,1,96),(5568,1,97),(5569,1,182),(5570,1,142),(5571,1,211),(5572,1,108),(5573,1,110),(5574,1,331),(5575,1,337),(5576,1,325),(5577,1,319),(5578,1,222),(5579,1,103),(5580,1,99),(5581,1,221),(5582,1,98),(5583,1,223),(5584,1,78),(5585,1,77),(5586,1,79),(5587,1,121),(5588,1,86),(5589,1,87),(5590,1,88),(5591,1,144),(5592,1,131),(5593,1,91),(5594,1,141),(5595,1,74),(5596,1,75),(5597,1,76),(5598,1,210),(5599,1,330),(5600,1,336),(5601,1,324),(5602,1,80),(5603,1,85),(5604,1,84),(5605,1,421),(5606,1,318),(5607,1,5),(5608,1,6),(5609,1,4),(5612,1,281),(5613,1,284),(5614,1,280),(5615,1,283),(5616,1,282),(5617,1,426),(5618,1,246),(5619,1,247),(5620,1,416),(5621,1,420),(5622,1,252),(5623,1,245),(5624,1,334),(5625,1,340),(5626,1,328),(5627,1,424),(5628,1,278),(5629,1,279),(5630,1,277),(5631,1,322),(5632,1,357),(5633,1,356),(5634,1,358),(5635,1,351),(5636,1,348),(5637,1,350),(5638,1,355),(5639,1,352),(5640,1,354),(5641,1,353),(5642,1,347),(5643,1,349),(5644,1,413),(5645,1,414),(5646,1,8),(5647,1,170),(5648,1,169),(5649,1,171),(5650,1,176),(5651,1,188),(5652,1,178),(5653,1,179),(5654,1,177),(5655,1,167),(5656,1,174),(5657,1,411),(5658,1,212),(5659,1,153),(5660,1,186),(5661,1,154),(5662,1,152),(5663,1,332),(5664,1,338),(5665,1,326),(5666,1,422),(5667,1,164),(5668,1,165),(5669,1,166),(5670,1,320),(5671,1,24),(5672,1,10),(5673,1,11),(5674,1,9),(5675,1,191),(5676,1,192),(5677,1,418),(5678,1,419),(5679,1,417),(5680,1,39),(5681,1,26),(5682,1,25),(5683,1,200),(5684,1,199),(5685,1,201),(5686,1,207),(5687,1,198),(5688,1,206),(5689,1,205),(5690,1,197),(5691,1,333),(5692,1,339),(5693,1,327),(5694,1,204),(5695,1,412),(5696,1,213),(5697,1,190),(5698,1,193),(5699,1,189),(5700,1,321),(5701,1,423),(5702,1,194),(5703,1,195),(5704,1,196),(5705,1,43),(5706,1,28),(5707,1,49),(5708,1,48),(5709,1,231),(5710,1,232),(5711,1,230),(5712,1,2),(5713,1,3),(5714,1,1),(5715,1,17),(5716,1,16),(5717,1,18),(5718,1,300),(5719,1,301),(5720,1,130),(5721,1,225),(5722,1,34),(5723,1,33),(5724,1,492),(5725,1,57),(5726,1,23),(5727,1,22),(5728,1,63),(5729,1,59),(5730,1,143),(5731,1,70),(5732,1,168),(5733,1,40),(5734,1,56),(5735,1,329),(5736,1,335),(5737,1,323),(5738,1,89),(5739,1,13),(5740,1,140),(5741,1,14),(5742,1,209),(5743,1,12),(5744,1,317),(5745,1,20),(5746,1,31),(5747,1,21),(5753,1,436),(5754,1,435),(5755,1,437),(5756,1,441),(5757,1,442),(5758,1,443),(5759,1,444),(5760,1,445),(5761,1,447),(5762,1,446),(5763,1,427),(5764,1,428),(5765,1,430),(5766,1,431),(5767,1,432),(5768,1,433),(5769,1,434),(5770,1,476),(5771,1,429),(5772,1,468),(5773,1,438),(5774,1,439),(5775,1,440),(5776,1,208),(5777,1,224),(5779,1,226),(5780,1,520),(5781,1,184),(5782,1,448),(5783,1,185),(5784,1,449),(5785,1,183),(5786,1,219),(5787,1,493),(5788,1,220),(5789,1,519),(5790,1,236),(5791,1,238),(5792,1,237),(5793,1,243),(5794,1,244),(5795,1,242),(5796,1,241),(5797,1,240),(5798,1,239),(5799,1,101),(5800,1,100),(5801,1,102),(5802,1,112),(5803,1,111),(5804,1,114),(5805,1,113),(5806,1,122),(5807,1,105),(5808,1,106),(5809,1,107),(5810,1,145),(5811,1,125),(5812,1,128),(5813,1,124),(5814,1,127),(5815,1,123),(5816,1,126),(5817,1,129),(5818,1,180),(5819,1,109),(5820,1,95),(5821,1,181),(5822,1,96),(5823,1,97),(5824,1,182),(5825,1,142),(5826,1,211),(5827,1,108),(5828,1,110),(5829,1,331),(5830,1,337),(5831,1,325),(5832,1,319),(5833,1,222),(5834,1,103),(5835,1,99),(5836,1,221),(5837,1,98),(5838,1,223),(5839,1,78),(5840,1,77),(5841,1,79),(5842,1,121),(5843,1,86),(5844,1,87),(5845,1,88),(5846,1,144),(5847,1,131),(5848,1,91),(5849,1,141),(5850,1,74),(5851,1,75),(5852,1,76),(5853,1,210),(5854,1,330),(5855,1,336),(5856,1,324),(5857,1,80),(5858,1,85),(5859,1,84),(5860,1,421),(5861,1,318),(5862,1,5),(5863,1,6),(5864,1,4),(5867,1,281),(5868,1,284),(5869,1,280),(5870,1,283),(5871,1,282),(5872,1,426),(5873,1,246),(5874,1,247),(5875,1,416),(5876,1,420),(5877,1,252),(5878,1,245),(5879,1,334),(5880,1,340),(5881,1,328),(5882,1,424),(5883,1,278),(5884,1,279),(5885,1,277),(5886,1,322),(5887,1,357),(5888,1,356),(5889,1,358),(5890,1,351),(5891,1,348),(5892,1,350),(5893,1,355),(5894,1,352),(5895,1,354),(5896,1,353),(5897,1,347),(5898,1,349),(5899,1,413),(5900,1,414),(5901,1,8),(5902,1,170),(5903,1,169),(5904,1,171),(5905,1,176),(5906,1,188),(5907,1,178),(5908,1,179),(5909,1,177),(5910,1,167),(5911,1,174),(5912,1,411),(5913,1,212),(5914,1,153),(5915,1,186),(5916,1,154),(5917,1,152),(5918,1,332),(5919,1,338),(5920,1,326),(5921,1,422),(5922,1,164),(5923,1,165),(5924,1,166),(5925,1,320),(5926,1,24),(5927,1,10),(5928,1,11),(5929,1,9),(5930,1,191),(5931,1,192),(5932,1,418),(5933,1,419),(5934,1,417),(5935,1,39),(5936,1,26),(5937,1,25),(5938,1,200),(5939,1,199),(5940,1,201),(5941,1,207),(5942,1,198),(5943,1,206),(5944,1,205),(5945,1,197),(5946,1,333),(5947,1,339),(5948,1,327),(5949,1,204),(5950,1,412),(5951,1,213),(5952,1,190),(5953,1,193),(5954,1,189),(5955,1,321),(5956,1,423),(5957,1,194),(5958,1,195),(5959,1,196),(5960,1,43),(5961,1,28),(5962,1,49),(5963,1,48),(5964,1,231),(5965,1,232),(5966,1,230),(5967,1,2),(5968,1,3),(5969,1,1),(5970,1,17),(5971,1,16),(5972,1,18),(5973,1,300),(5974,1,301),(5975,1,130),(5976,1,225),(5977,1,34),(5978,1,33),(5979,1,492),(5980,1,57),(5981,1,23),(5982,1,22),(5983,1,63),(5984,1,59),(5985,1,143),(5986,1,70),(5987,1,168),(5988,1,40),(5989,1,56),(5990,1,329),(5991,1,335),(5992,1,323),(5993,1,89),(5994,1,13),(5995,1,140),(5996,1,14),(5997,1,209),(5998,1,12),(5999,1,317),(6000,1,20),(6001,1,31),(6002,1,21),(6008,1,536),(6009,1,536),(6010,2,536),(6011,1,536),(6015,1,537),(6016,1,537),(6018,1,538),(6019,1,538),(6020,1,538),(6021,1,542),(6022,1,542),(6023,1,542),(6024,1,543),(6025,1,543),(6026,1,543);
...
CREATE TABLE `s_app_menu` (
  ...
  UNIQUE KEY `parent_id` (`parent_id`,`link`),
  UNIQUE KEY `parent_id_2` (`parent_id`,`link`)
...
INSERT INTO `s_available_country_forms` VALUES (1,'South Sudan ','ssudan'),(2,'Sierra Leone','sierra-leone'),(3,'Democratic Republic of the Congo','drc'),(4,'Republic of Cameroon','cameroon'),(5,'Papua New Guinea','png'),(6,'WHO ','who'),(7,'Rwanda ','rwanda'),(8,'Burkina Faso','burkina-faso');
/*!40000 ALTER TABLE `s_available_country_forms` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `s_data_issues`
--

DROP TABLE IF EXISTS `s_data_issues`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_data_issues` (
  ...
  KEY `idx_facility` (`test_type`,`facility_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `s_data_issues`
--

LOCK TABLES `s_data_issues` WRITE;
/*!40000 ALTER TABLE `s_data_issues` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_data_issues` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `s_data_issues_scan`
--

DROP TABLE IF EXISTS `s_data_issues_scan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_data_issues_scan` (
  `test_type` varchar(64) NOT NULL,
...
--
-- Dumping data for table `s_data_issues_scan`
--

LOCK TABLES `s_data_issues_scan` WRITE;
/*!40000 ALTER TABLE `s_data_issues_scan` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_data_issues_scan` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `s_lab_rejection_reason_map`
--

DROP TABLE IF EXISTS `s_lab_rejection_reason_map`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_lab_rejection_reason_map` (
...
--
-- Dumping data for table `s_lab_rejection_reason_map`
--

LOCK TABLES `s_lab_rejection_reason_map` WRITE;
/*!40000 ALTER TABLE `s_lab_rejection_reason_map` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_lab_rejection_reason_map` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `s_lis_backup_key_recovery`
--

DROP TABLE IF EXISTS `s_lis_backup_key_recovery`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_lis_backup_key_recovery` (
  `id` int NOT NULL AUTO_INCREMENT,
  `facility_id` int NOT NULL,
  `vlsm_instance_id` varchar(64) DEFAULT NULL,
  `key_version` int NOT NULL DEFAULT '1',
  `encrypted_key` text NOT NULL,
  `fingerprint` char(64) NOT NULL,
  `release_status` enum('stored','release_approved','released') NOT NULL DEFAULT 'stored',
  `saved_at` datetime DEFAULT NULL,
  `updated_datetime` datetime DEFAULT NULL,
  `release_token_hash` char(64) DEFAULT NULL,
  `release_token_expires` datetime DEFAULT NULL,
  `released_at` datetime DEFAULT NULL,
  `release_note` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--
-- Dumping data for table `s_lis_backup_key_recovery`
--

LOCK TABLES `s_lis_backup_key_recovery` WRITE;
/*!40000 ALTER TABLE `s_lis_backup_key_recovery` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_lis_backup_key_recovery` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `s_lis_remote_commands`
--

DROP TABLE IF EXISTS `s_lis_remote_commands`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `s_lis_remote_commands` (
  `command_id` char(36) NOT NULL,
  `lab_id` int NOT NULL,
  `command` varchar(32) NOT NULL,
  `params` json DEFAULT NULL,
  `status` enum('pending','picked','running','preparing','prepared','applying','completed','failed','expired','cancelled') NOT NULL DEFAULT 'pending',
  `requested_by` varchar(50) DEFAULT NULL,
  `requested_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `picked_at` datetime DEFAULT NULL,
  `picked_by_instance` varchar(64) DEFAULT NULL,
  `completed_at` datetime DEFAULT NULL,
  `not_before` datetime DEFAULT NULL,
  `expires_at` datetime DEFAULT NULL,
  `depends_on` char(36) DEFAULT NULL,
...
--
-- Dumping data for table `s_lis_remote_commands`
--

LOCK TABLES `s_lis_remote_commands` WRITE;
/*!40000 ALTER TABLE `s_lis_remote_commands` DISABLE KEYS */;
/*!40000 ALTER TABLE `s_lis_remote_commands` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `s_vlsm_instance` (
  ...
  `sts_token` varchar(64) DEFAULT NULL,
  `sc_api_token` varchar(64) DEFAULT NULL,
  ...
  `last_instrument_activity_sync` datetime DEFAULT NULL,
  `last_instrument_usage_sync` datetime DEFAULT NULL,
  `backup_key_saved_at` datetime DEFAULT NULL,
  `backup_key_recovery_ready` tinyint(1) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `specimen_manifests`
--

DROP TABLE IF EXISTS `specimen_manifests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `specimen_manifests` (
  `manifest_id` int NOT NULL AUTO_INCREMENT,
  `manifest_code` varchar(255) DEFAULT NULL,
  `added_by` varchar(255) NOT NULL,
  `manifest_status` varchar(255) DEFAULT NULL,
  `module` varchar(255) DEFAULT NULL,
  `manifest_type` enum('collection','referral') DEFAULT 'collection',
  `lab_id` int DEFAULT NULL,
...
--
-- Dumping data for table `specimen_manifests`
--

LOCK TABLES `specimen_manifests` WRITE;
/*!40000 ALTER TABLE `specimen_manifests` DISABLE KEYS */;
/*!40000 ALTER TABLE `specimen_manifests` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `system_config` VALUES ('Testing Lab ID','sc_testing_lab_id',''),('User Type','sc_user_type','vluser'),('Version','sc_version','5.7.45'),('Email Id','sup_email',NULL),('Password','sup_password',NULL);
/*!40000 ALTER TABLE `system_config` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tb_referral_history`
--

DROP TABLE IF EXISTS `tb_referral_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `tb_referral_history`
--

LOCK TABLES `tb_referral_history` WRITE;
/*!40000 ALTER TABLE `tb_referral_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `tb_referral_history` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tb_tests` (
  ...
  `specimen_type` varchar(255) DEFAULT NULL,
  `sample_received_at_lab_datetime` datetime DEFAULT NULL,
  `is_sample_rejected` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `reason_for_sample_rejection` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `rejection_on` datetime DEFAULT NULL,
  ...
  `revised_by` varchar(255) DEFAULT NULL,
  `revised_on` datetime DEFAULT NULL,
  `reason_for_result_change` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `comments` mediumtext,
  `updated_datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `data_sync` int NOT NULL DEFAULT '0',
...
--
-- Table structure for table `test_result_attempts`
--

DROP TABLE IF EXISTS `test_result_attempts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `test_result_attempts` (
  ...
  `reason_for_failure` varchar(256) DEFAULT NULL,
  `sample_tested_datetime` datetime DEFAULT NULL,
  `tested_by` varchar(256) DEFAULT NULL,
  `test_platform` varchar(256) DEFAULT NULL,
  `instrument_id` varchar(256) DEFAULT NULL,
  `lot_number` varchar(256) DEFAULT NULL,
  `lot_expiration_date` date DEFAULT NULL,
  `sample_reordered` varchar(3) DEFAULT NULL,
...
--
-- Dumping data for table `test_result_attempts`
--

LOCK TABLES `test_result_attempts` WRITE;
/*!40000 ALTER TABLE `test_result_attempts` DISABLE KEYS */;
/*!40000 ALTER TABLE `test_result_attempts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `user_details` (
  ...
  `testing_lab_id` int DEFAULT NULL,
  ...
  PRIMARY KEY (`user_id`),
  KEY `role_id` (`role_id`),
  KEY `idx_user_details_testing_lab` (`testing_lab_id`),
...
--
-- Dumping routines for database 'vlsm'
--
...
-- Dump completed on 2026-08-26 18:12:53
